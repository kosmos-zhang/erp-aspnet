...
namespace XBase.Business.Office.HumanManager
{
    ...
    /// </summary>
    ///
    public class EmplApplyNotifyBus
    {
        ...
        public static DataTable GetApplyInfo(bool isSearch)
        {
            ...
            //执行查询
            return EmplApplyNotifyDBHelper.GetApplyInfo(companyCD, isSearch);
        }
        #endregion
        #region 获取申请单信息
        /// <summary>
        ...
        /// <returns></returns>
        public static DataTable GetEmplApplyNotifyInfoByID(string EmplApplyNotifyID)
        {
            return EmplApplyNotifyDBHelper.GetEmplApplyNotifyInfoByID(EmplApplyNotifyID);
        }
        #endregion
        ...
        private static LogInfoModel InitLogInfo(string no)
        {
            ...
            //设置模块ID
            logModel.ModuleID = ConstUtil.MODULE_ID_HUMAN_EMPLOYEE_SHIFT_EDIT;
            //设置操作日志类型 修改
            logModel.ObjectName = ConstUtil.CODING_RULE_TABLE_SHIFT;//操作对象
            //
