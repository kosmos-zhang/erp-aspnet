...
{
    public class InputCompanyRoyaltyBus
    {
        #region 查询：公司提成录入信息
        /// <summary>
        /// 查询公司提成录入信息
        ...
        public static bool Update(InputCompanyRoyaltyModel Model)
        {
            ...
            try
            {
                isSucc = InputCompanyRoyaltyDBHelper.Update(Model);
            }
            catch (Exception ex)
            {
        ...
        public static bool DoDelete(string StrID)
        {
            ...
            try
            {
                isSucc = InputCompanyRoyaltyDBHelper.DoDelete(StrID, userInfo.CompanyCD);
            }
            catch (Exception ex)
            {
