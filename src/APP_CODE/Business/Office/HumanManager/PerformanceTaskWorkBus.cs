...
{
   public class PerformanceTaskWorkBus
    {
       ...
       /// </summary>
       /// <returns>DataTable</returns>
       public static DataTable GetTemplatebyNO(string templateNo,string employeeID)
       {
           //获取登陆用户信息
           UserInfoUtil userInfo = (UserInfoUtil)SessionUtil.Session["UserInfo"];
           //获取公司代码
           string CompanyCD = userInfo.CompanyCD;
           //执行查询
           return PerformanceTaskDBHelper.GetTemplatebyNO (templateNo,employeeID, CompanyCD);
       }
       /// <summary>
       /// 初始化日志
       /// </summary>
       ...
       public static DataTable SearchTaskInfo(PerformanceTaskModel  model)
       {
           ...
           model.CompanyCD = userInfo.CompanyCD;  
           //执行查询
           return PerformanceTaskDBHelper.SearchTaskInfo(model);
       ...
       public static DataTable SearchTaskInfoByTaskNO(string taskNo )
       {
         ...
         string companyCD = userInfo.CompanyCD;
           //执行查询
         return PerformanceTaskDBHelper.SearchTaskInfoByTaskNO(companyCD ,taskNo );

       }
       public static DataTable SearchTaskForDetails(string taskNo)
       {
           //获取登陆用户信息
           UserInfoUtil userInfo = (UserInfoUtil)SessionUtil.Session["UserInfo"];
           //获取公司代码
           string companyCD = userInfo.CompanyCD;
           //执行查询
           return PerformanceTaskDBHelper.SearchTaskForDetails (companyCD, taskNo);
       ...
       public static bool IsExist(string TaskNo)
       {
           ...
           string companyCD = userInfo.CompanyCD;
           //执行删除操作
           bool isSucc = PerformanceTaskDBHelper.IsExist(TaskNo, companyCD);
       ...
       public static bool DeletePerTypeInfo(string elemID)
       {
           ...
           string companyCD = userInfo.CompanyCD;
           //执行删除操作
           bool isSucc = PerformanceTaskDBHelper.DeletePerTypeInfo(elemID, companyCD);
           //定义变量
           string remark;
           //成功时
           if (isSucc)
