...
namespace XBase.Business.Office.HumanManager
{
    ...
    /// 最后修改时候：2009/4/20
    /// </summary>
 public  class PerformanceTypeBus
    {
        ...
        {
            return PerformanceTypeDBhelper.GetCheckElemInfoWithID(elemID);
        ...
        private static LogInfoModel InitLogInfo(string no)
        {
            ...
            //设置操作日志类型 修改
            logModel.ObjectName = ConstUtil.CODING_RULE_TABLE_PERFORMANCETYPE;
            //操作单据编号
        ...
        #endregion
        public static bool IsTemplateUsed(string elemID)
        {
            UserInfoUtil userInfo = (UserInfoUtil)SessionUtil.Session["UserInfo"];
            //获取公司代码
          string   companyCD = userInfo.CompanyCD;
            //执行删除操作
          bool isSucc = PerformanceTypeDBhelper.IsTemplateUsed(elemID, companyCD);
        ...
        public static bool DeletePerTypeInfo(string elemID)
        {
            ...
            string companyCD = userInfo.CompanyCD;
            //执行删除操作
            bool isSucc = PerformanceTypeDBhelper.DeletePerTypeInfo(elemID, companyCD);
            //定义变量
            string remark;
            //成功时
            if (isSucc)
