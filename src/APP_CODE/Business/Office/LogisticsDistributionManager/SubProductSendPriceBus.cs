...
{
    public class SubProductSendPriceBus
    {
        #region 读取分店列表
        ...
        public static string AddSubProductSendPrice(Model.Office.LogisticsDistributionManager.SubProductSendPrice model)
        {
            ...
            {
                //执行操作
                res = XBase.Data.Office.LogisticsDistributionManager.SubProductSendPriceDBHelper.AddSubProductSendPrice(model);
            }
            catch (Exception ex)
            {
                //输出日志
        ...
        {
            return XBase.Data.Office.LogisticsDistributionManager.SubProductSendPriceDBHelper.GetSubProductSendPriceList(htPara, isProduct, ref TotalCount);
        }
        /*不分页*/
        public static DataTable GetSubProductSendPriceList(Hashtable htPara)
        {
            return XBase.Data.Office.LogisticsDistributionManager.SubProductSendPriceDBHelper.GetSubProductSendPriceList(htPara);
        }
        #endregion
        ...
        public static string UpdateSubProductSendPrice(Model.Office.LogisticsDistributionManager.SubProductSendPrice model)
        {
            ...
            {
                //执行操作
                res = XBase.Data.Office.LogisticsDistributionManager.SubProductSendPriceDBHelper.UpdateSubProductSendPrice(model);
            }
            catch (Exception ex)
            {
                //输出日志
        ...
        public static bool DelSubProductSendPrice(int[] IDList)
        {
            ...
            {
                //执行操作
                res = XBase.Data.Office.LogisticsDistributionManager.SubProductSendPriceDBHelper.DelSubProductSendPrice(IDList);
            }
            catch (Exception ex)
            {
                //输出日志
        ...
        private static void WriteSystemLog(UserInfoUtil userInfo, Exception ex)
        {
            ...
            //设定模块ID
            logSys.ModuleID = ConstUtil.MODULE_ID_SUBPRODUCTSENDPRICESETTING;
            //描述
        ...
        private static LogInfoModel InitLogInfo(string InNo)
        {
            ...
            logModel.ModuleID = ConstUtil.MODULE_ID_SUBPRODUCTSENDPRICESETTING;
            //设置操作日志类型 修改
        ...
        {
            return SubProductSendPriceDBHelper.ExisitSendPrice(CompanyCD, DeptName, ProdNo);
        }
        ...
        {
            return SubProductSendPriceDBHelper.ExisitDeptName(CompanyCD, DeptName);
        }
        ...
        {
            return SubProductSendPriceDBHelper.ExisitProdNo(CompanyCD, ProdNo);
        }
        ...
        {
            return SubProductSendPriceDBHelper.ImportData(dt, userInfo);
        }
