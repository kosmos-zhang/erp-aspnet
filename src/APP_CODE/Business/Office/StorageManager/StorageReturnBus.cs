...
namespace XBase.Business.Office.StorageManager
{
    public class StorageReturnBus
    {
        ...
        {
            return XBase.Data.Office.StorageManager.StorageReturnDBHelper.GetStorageReturnList(EFIndex,EFDesc,htPara, CompanyCD,PageSize,PageIndex,OrderBy,ref TotalCount);
        }

        /*不分页*/
        public static DataTable GetStorageReturnList(Hashtable htPara, string CompanyCD, string OrderBy)
        {
            return XBase.Data.Office.StorageManager.StorageReturnDBHelper.GetStorageReturnList(htPara, CompanyCD,  OrderBy);
        }
        #endregion
