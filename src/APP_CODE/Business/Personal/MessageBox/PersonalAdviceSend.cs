...
{
	/// <summary>
	/// 业务逻辑类PersonalAdviceSend 的摘要说明。
	/// </summary>
	public class PersonalAdviceSend
	{
		private readonly XBase.Data.Personal.MessageBox.PersonalAdviceSend dal=new XBase.Data.Personal.MessageBox.PersonalAdviceSend();
