<%@ WebHandler Language="C#" Class="PurchaseDetail" %>
...
public class PurchaseDetail : IHttpHandler ,IRequiresSessionState{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        if (context.Request.RequestType == "POST")
        {
            ...
            DataTable dt = null;
            if (request.Params["dataSource"] == "Arrive")
            {
                dt = PurchaseArriveBus.PurchaseArriveCollectList(pageIndex, pageCount, orderBy, ref TotalCount, ProviderID, ProductID, StartConfirmDate, EndConfirmDate, CompanyCD);

            }
            else {

                dt = PurchaseArriveBus.PurchaseOrderCollectList(pageIndex, pageCount, orderBy, ref TotalCount, ProviderID, ProductID, StartConfirmDate, EndConfirmDate, CompanyCD);
            }
