...
public class PurchaseOrderSelect : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context)
    {
        ...
        {
            //设置行为参数
            string orderString = (context.Request.Form["orderbyPurchaseOrder"].ToString());//排序
            ...
            DataTable dt = PurchaseArriveBus.GetPurchaseOrderDetail(ProductNo, ProductName, FromBillNo, CompanyCD, Provider00ID, CurrencyTypeID, Rate, PurchaseArriveEFIndex, PurchaseArriveEFDesc);
            ...
            var dsLinq =
                ...
                (from x in dsXML.Descendants("Data")
                 ...
                 select new DataSourceModel()
                 {
                     ...
                     ProductOrder = x.Element("ProductOrder") == null ? "" : x.Element("ProductOrder").Value,
                     RequireDate = x.Element("RequireDate") == null ? "" : x.Element("RequireDate").Value,
                     ...
                     TotalFee = x.Element("TotalFee") == null ? "" : x.Element("TotalFee").Value,
                     TotalTax = x.Element("TotalTax") == null ? "" : x.Element("TotalTax").Value,
                     ...
                     ArrivedCount = x.Element("ArrivedCount") == null ? "" : x.Element("ArrivedCount").Value,
                     ...
                     Purchaser = x.Element("Purchaser") == null ? "" : x.Element("Purchaser").Value,
                     PurchaserName = x.Element("PurchaserName") == null ? "" : x.Element("PurchaserName").Value,
                 })
                          :
                (from x in dsXML.Descendants("Data")
    ...
    public class DataSourceModel
    {
        ...
        public string ArrivedCount { get; set; }
