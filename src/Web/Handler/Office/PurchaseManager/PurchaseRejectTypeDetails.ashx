<%@ WebHandler Language="C#" Class="PurchaseRejectTypeDetails" %>
...
public class PurchaseRejectTypeDetails : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private DataTable GetDataTable(HttpContext context, int pageIndex, int pageCount, string ord,int pageindex,int pagesize, ref int TotalCount)
    {
        ...
        dt = PurchaseRejectBus.GetPurchaseRejectTypeDetails(companyCD, billStatus, FromType, Convert.ToInt32(shState), Convert.ToInt32(typeID), BeginDate, EndDate, ord, pageindex, pageCount, ref TotalCount);
        return dt;
    }    
