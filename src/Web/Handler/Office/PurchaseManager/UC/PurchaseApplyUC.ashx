<%@ WebHandler Language="C#" Class="PurchaseApplyUC" %>
...
public class PurchaseApplyUC : IHttpHandler, IRequiresSessionState
{ 
    public void ProcessRequest (HttpContext context) 
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            string PurchaseArriveEFDesc = "";
            string PurchaseArriveEFIndex = "";
            string CompanyCD = ((UserInfoUtil)SessionUtil.Session["UserInfo"]).CompanyCD;
            int totalCount = 0;

            DataTable dtdata = PurchasePlanBus.GetPurchaseApply(CompanyCD, ProductNo, ProductName, StartDate, EndDate, pageIndex, pageCount, OrderBy, OrderByType, ref totalCount, PurchaseArriveEFIndex, PurchaseArriveEFDesc);
