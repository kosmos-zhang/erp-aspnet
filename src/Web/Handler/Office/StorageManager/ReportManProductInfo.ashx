<%@ WebHandler Language="C#" Class="ReportManProductInfo" %>
...
public class ReportManProductInfo : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            string ProductNo = context.Request.Form["TheProductNo"].ToString();
            string ReportStr = ProductNo + "?" + ProductName;
            XElement dsXML = ConvertDataTableToXML(CheckReportBus.GetManDetail(ApplyNo,CompanyCD,ReportStr));
    ...
    (from x in dsXML.Descendants("Data")
     ...
     select new DataSourceModel()
     {
         ...
         ProductedCount = x.Element("ProductedCount").Value,
         CheckedCount = x.Element("CheckedCount").Value,
         CheckCount = x.Element("CheckCount").Value,
    ...
    public class DataSourceModel
    {
        ...
        public string ProductedCount { get; set; }
        public string CheckedCount { get; set; }
        public string CheckCount { get; set; }//报检数量
        public string ApplyCheckCount { get; set; }//已报检数量
