<%@ WebHandler Language="C#" Class="ReportManufacture" %>
...
public class ReportManufacture : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        if (context.Request.RequestType == "POST")
        {
            ...
            XElement dsXML = ConvertDataTableToXML(CheckReportBus.GetMan(method,ReportStr));
