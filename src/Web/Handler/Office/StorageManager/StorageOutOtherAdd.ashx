        ...
        else
        {
            ...
            if (context.Request.Params["Act"].ToString().Trim() == "Confirm")
            {
                if (ID > 0)
                {
                    ...
                    else if (StorageOutOtherBus.ISBigUseCountWhenCant(model) != string.Empty)//StorageOutOtherBus.ISBigUseCountWhenCant(model) != "" || 
                    {
            ...
            else
            {
                if (ID > 0)
                {
                    ...
                    if (StorageOutOtherBus.UpdateStorageOutOther(model,ht, modellist))
                    {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        //获取扩展属性
                        Hashtable ht = GetExtAttr(context);
                        if (StorageOutOtherBus.InsertStorageOutOther(model,ht, modellist,out IndexIDentity))
                        {
