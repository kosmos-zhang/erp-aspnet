<%@ WebHandler Language="C#" Class="StorageList" %>
...
public class StorageList : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        if (context.Request.RequestType == "POST")
        {
            ...
            string StorageID = context.Request.Form["StorageID"];
            ...
            DataTable dt = SubStorageBus.SelectStorageProduct(pageIndex, pageCount, orderBy, ref TotalCount, StorageID, ProductID, ProductName, BatchNo);
    ...
    public class DataSourceModel
    {
        ...
        public string CanUseCount { get; set; }
