<%@ WebHandler Language="C#" Class="SubSellBackEdit" %>
...
public class SubSellBackEdit : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            DataTable dtp = SubSellBackBus.SubSellBack(ID);
            DataTable dt2 = SubSellBackBus.Details(ID);
