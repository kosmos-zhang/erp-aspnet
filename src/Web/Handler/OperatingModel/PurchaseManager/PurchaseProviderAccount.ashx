<%@ WebHandler Language="C#" Class="PurchaseProviderAccount" %>
...
public class PurchaseProviderAccount : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        if (context.Request.RequestType == "POST")
        {
            ...
            DataTable dt = ProviderInfoBus.PurchaseProviderAccount(pageIndex, pageCount, orderBy, ref TotalCount, ProviderID, ProviderName, StartConfirmDate, EndConfirmDate, CompanyCD);
