<%@ WebHandler Language="C#" Class="PurchaseProviderPayment" %>
...
public class PurchaseProviderPayment : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        if (context.Request.RequestType == "POST")
        {
            ...
            EndConfirmDate = Convert.ToDateTime(EndConfirmDate).AddDays(1).ToString("yyyy-MM-dd");
            int TotalCount = 0;
            ...
            DataTable dt = ProviderInfoBus.PurchaseProviderPayment(pageIndex, pageCount, orderBy, ref TotalCount, ProviderID, ProviderName, StartConfirmDate, EndConfirmDate, CompanyCD);
