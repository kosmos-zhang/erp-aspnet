<%@ WebHandler Language="C#" Class="PurchaseRejectProduct" %>
using System;
using System.Web;
using System.Data;
using System.Text;
...
public class PurchaseRejectProduct : BaseHandler
{
    ...
    private void DeptAndPerson()
    {
        ...
        dataList=XBase.Business.Office.PurchaseManager.PurchaseRejectBus.GetPurchaseRejectProductDetail(ProviderId, DeptId, StartDate, EndDate, DateType, DateValue, ProductId, Convert.ToInt32(pageIndex), Convert.ToInt32(pageSize), orderExp, ref recCount);
