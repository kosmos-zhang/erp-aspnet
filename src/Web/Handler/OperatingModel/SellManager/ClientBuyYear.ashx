<%@ WebHandler Language="C#" Class="ClientBuyYear" %>
...
public class ClientBuyYear : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            DataTable dt = SellProductReportBus.GetCustBuyYear("0",pageIndex,pageCount,myOrder,CompanyCD,Cust,OrderDate,CurrencyType,ref TotalNowMonth,ref TotalNowYear,ref TotalLastMonth,ref TotalLastYear,ref TotalPrice,ref TotalCount);
