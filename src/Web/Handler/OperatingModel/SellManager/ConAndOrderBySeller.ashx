<%@ WebHandler Language="C#" Class="ConAndOrderBySeller" %>
...
public class ConAndOrderBySeller : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private void GetLsit(HttpContext context)
    {
        ...
        dt = SellContractBus.GetTotalBySeller(startDate, endDate, isCon, isOrd, SellerID, CurrencyType,pageIndex, pageCount, ord, ref totalCount);
