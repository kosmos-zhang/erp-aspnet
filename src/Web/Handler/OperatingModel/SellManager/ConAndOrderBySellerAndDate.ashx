<%@ WebHandler Language="C#" Class="ConAndOrderBySellerAndDate" %>
...
public class ConAndOrderBySellerAndDate : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private void GetLsit(HttpContext context)
    {
        ...
        dt = SellContractBus.GetTotalBySellerAndDate(strstartDate, strendDate, isCon, isOrd, SellerID, CurrencyType, pageIndex, pageCount, ord, ref totalCount);
