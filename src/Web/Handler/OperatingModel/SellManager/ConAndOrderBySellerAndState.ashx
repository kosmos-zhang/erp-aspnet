<%@ WebHandler Language="C#" Class="ConAndOrderBySellerAndState" %>
...
public class ConAndOrderBySellerAndState : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private void GetLsit(HttpContext context)
    {
        ...
        dt = SellContractBus.GetTotalBySellerAndState(startDate, endDate, isCon, isOrd, SellerID,CurrencyType, pageIndex, pageCount, ord, ref totalCount);
