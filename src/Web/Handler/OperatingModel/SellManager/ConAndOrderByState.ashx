<%@ WebHandler Language="C#" Class="ConAndOrderByState" %>
...
public class ConAndOrderByState : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private void GetLsit(HttpContext context)
    {
        ...
        dt = SellContractBus.GetTotalByState(startDate, endDate, isCon, isOrd, CurrencyType, pageIndex, pageCount, ord, ref totalCount);
