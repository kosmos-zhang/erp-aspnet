<%@ WebHandler Language="C#" Class="GetCustSell" %>
...
public class GetCustSell : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            int TotalCount=0;
            DataTable dt=SellProductReportBus.GetCustSell(CustNo,CustName,BeginDate,EndDate,pageIndex,pageCount,myOrderby,ref TotalCount);
