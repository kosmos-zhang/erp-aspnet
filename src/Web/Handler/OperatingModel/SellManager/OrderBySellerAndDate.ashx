<%@ WebHandler Language="C#" Class="OrderBySellerAndDate" %>
...
public class OrderBySellerAndDate : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private void GetLsit(HttpContext context)
    {
        ...
        dt = SellContractBus.GetTotal(strstartDate, strendDate, SellerID,CurrencyType, pageIndex, pageCount, ord, ref totalCount);
