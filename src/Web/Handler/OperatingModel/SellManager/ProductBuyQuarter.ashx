<%@ WebHandler Language="C#" Class="ProductBuyQuarter" %>
...
public class ProductBuyQuarter : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            DataTable dt = SellProductReportBus.GetProductBuyQuarter("0", pageIndex, pageCount, myOrder, ProductID, OrderDate, ref TotalPrice, ref TotalPrice1, ref TotalPrice2, ref TotalPrice3, ref TotalPrice4, ref TotalCount);
