<%@ WebHandler Language="C#" Class="ReportByDeptAndMonth" %>
...
public class ReportByDeptAndMonth : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private void GetLsit(HttpContext context)
    {
        ...
        dt = SellOrderBus.ReportByDeptAndMonth(SellDeptId, strOrderDate, CurrencyType, pageIndex, pageCount, ord, ref totalCount);
