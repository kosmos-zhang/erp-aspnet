<%@ WebHandler Language="C#" Class="ReportByDeptAndWeek" %>
...
public class ReportByDeptAndWeek : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private void GetLsit(HttpContext context)
    {
        ...
        string strOrderDate = context.Request.Params["OrderDate"].ToString().Trim();
        ...
        dt = SellOrderBus.ReportByDeptAndWeek(SellDeptId, strOrderDate, CurrencyType, pageIndex, pageCount, ord, ref totalCount);
