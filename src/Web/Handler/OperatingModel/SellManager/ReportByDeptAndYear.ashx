<%@ WebHandler Language="C#" Class="ReportByDeptAndYear" %>
...
public class ReportByDeptAndYear : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private void GetLsit(HttpContext context)
    {
        ...
        dt = SellOrderBus.ReportByDeptAndYear(SellDeptId, strOrderDate, CurrencyType, pageIndex, pageCount, ord, ref totalCount);
