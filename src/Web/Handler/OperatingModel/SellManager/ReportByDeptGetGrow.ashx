<%@ WebHandler Language="C#" Class="ReportByDeptGetGrow" %>
...
public class ReportByDeptGetGrow : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private void GetLsit(HttpContext context)
     { //设置行为参数
         ...
         dt = SellOrderBus.ReportByDeptGetGrow(SellDeptId, iCount, CurrencyType, EndYear, "2", pageIndex, pageCount, ord, ref  totalCount);
