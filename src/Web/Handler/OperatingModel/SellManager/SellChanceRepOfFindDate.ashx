<%@ WebHandler Language="C#" Class="SellChanceRepOfFindDate" %>
...
public class SellChanceRepOfFindDate : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private void GetLsit(HttpContext context)
    {
        ...
        string total = context.Request.Params["total"].ToString().Trim();
        ...
        dt = SellChanceBus.GetChance(FindDate, FindDate1, total, pageIndex, pageCount, ord, ref totalCount);
