<%@ WebHandler Language="C#" Class="SellChanceRepOfHapSource" %>
...
public class SellChanceRepOfHapSource : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private void GetLsit(HttpContext context)
    {
        ...
        int? HapSource = seller.Length == 0 ? null : (int?)Convert.ToInt32(seller);
        dt = SellChanceBus.GetChanceByHapSource(FindDate, FindDate1, HapSource, pageIndex, pageCount, ord, ref totalCount);
