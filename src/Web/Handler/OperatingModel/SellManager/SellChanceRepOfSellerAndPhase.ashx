<%@ WebHandler Language="C#" Class="SellChanceRepOfSellerAndPhase" %>
...
public class SellChanceRepOfSellerAndPhase : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private void GetLsit(HttpContext context)
    {
        ...
        dt = SellChanceBus.GetChanceBySellerAndPhase(FindDate, FindDate1, SellerID, Phase, pageIndex, pageCount, ord, ref totalCount);
