<%@ WebHandler Language="C#" Class="SellChanceRepOfSellerAndState" %>
...
public class SellChanceRepOfSellerAndState : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private void GetLsit(HttpContext context)
    {
        ...
        dt = SellChanceBus.GetChanceOfState(FindDate, FindDate1, SellerID, Phase, pageIndex, pageCount, ord, ref totalCount);
