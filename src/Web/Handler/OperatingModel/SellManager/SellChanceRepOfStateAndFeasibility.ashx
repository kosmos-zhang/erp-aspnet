<%@ WebHandler Language="C#" Class="SellChanceRepOfStateAndFeasibility" %>
...
public class SellChanceRepOfStateAndFeasibility : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private void GetLsit(HttpContext context)
    {
        ...
        dt = SellChanceBus.GetChanceOfStateAndFeasibility(FindDate, FindDate1, FeasibilityID, State, pageIndex, pageCount, ord, ref totalCount);
