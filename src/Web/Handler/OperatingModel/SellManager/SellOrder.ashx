...
public class SellContract :BaseHandler
{
    ...
    private void DeptAndPerson()
    {
        ...
        dataList = XBase.Business.Office.SellManager.SellOrderBus.GetSellOrderDetail(GroupType, DeptOrEmployeeId, DateType, DateValue, Status, Type, StartDate, EndDate, AreaId, Convert.ToInt32(pageIndex), Convert.ToInt32(pageSize), orderExp, ref recCount);
