<%@ WebHandler Language="C#" Class="GetNoPassDetail" %>
...
public class GetNoPassDetail : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            string HiddenProcessWay = context.Request.Form["HiddenProcessWay"].ToString().Trim();
            DataTable dt =PurchaseApplyNoPassBus.GetNoPassDetail(BeginDate, EndDate,ProductID,HiddenProcessWay,pageIndex,pageCount,myOrder,ref TotalCount);
