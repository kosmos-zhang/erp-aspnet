<%@ WebHandler Language="C#" Class="ManufactureNoPass" %>
...
public class ManufactureNoPass : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            string DeptID = context.Request.QueryString["DeptID"].ToString();
            string TotalProductCount="0";
            string TotalNotPassCount="0";
            int TotalCount=0;
            DataTable dt =PurchaseApplyNoPassBus.SearchManNoPass("0",BeginDate, EndDate, DeptID,myOrder,pageIndex,pageCount, ref TotalProductCount, ref TotalNotPassCount,ref TotalCount);
