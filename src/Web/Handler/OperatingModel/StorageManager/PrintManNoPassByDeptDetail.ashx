<%@ WebHandler Language="C#" Class="PrintManNoPassByDeptDetail" %>
...
public class PrintManNoPassByDeptDetail : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            DataTable dt = PurchaseApplyNoPassBus.GetManNoPassByDeptList(BeginDate,EndDate,ProductID,DeptID,myOrder, pageIndex, pageCount, ref TotalCount);
