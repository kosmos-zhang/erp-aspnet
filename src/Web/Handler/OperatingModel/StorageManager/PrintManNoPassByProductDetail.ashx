<%@ WebHandler Language="C#" Class="PrintManNoPassByProductDetail" %>
...
public class PrintManNoPassByProductDetail : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            DataTable dt = PurchaseApplyNoPassBus.GetManNoPassByProductList(BeginDate, EndDate, ProductID, DeptID, myOrder, pageIndex, pageCount, ref TotalCount);
