<%@ WebHandler Language="C#" Class="PrintNoPassByProviderDetail" %>
...
public class PrintNoPassByProviderDetail : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            DataTable dt = PurchaseApplyNoPassBus.GetNoPassByProviderList(BeginDate, EndDate, ProductID, ProviderID, myOrder, pageIndex, pageCount, ref TotalCount);
