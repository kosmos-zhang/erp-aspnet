<%@ WebHandler Language="C#" Class="PrintNoPassPurTendencyDetail" %>
...
public class PrintNoPassPurTendencyDetail : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            string ProviderID = context.Request.Form["ProviderID"].ToString().Trim();
            string Method = context.Request.Form["Method"].ToString();
            string XValue=context.Request.Form["XValue"].ToString();
            DataTable dt = PurchaseApplyNoPassBus.GetNoPassTendencyList(Method,BeginDate, EndDate, ProductID, ProviderID,XValue,myOrder, pageIndex, pageCount, ref TotalCount);
