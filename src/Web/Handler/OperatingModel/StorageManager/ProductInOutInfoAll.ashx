<%@ WebHandler Language="C#" Class="ProductInOutInfoAll" %>
...
public class ProductInOutInfoAll : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            int TotalCount = 1;
            DataTable dt = StockAccountBus.GetProductInOutInfo(model);
