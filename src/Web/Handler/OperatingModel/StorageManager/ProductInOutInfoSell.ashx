<%@ WebHandler Language="C#" Class="ProductInOutInfoSell" %>
...
public class ProductInOutInfoSell : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            int TotalCount = 0;
            DataTable dt = StockAccountBus.GetInfoByOutSell(model, pageIndex, pageCount, ord, ref TotalCount, true);
