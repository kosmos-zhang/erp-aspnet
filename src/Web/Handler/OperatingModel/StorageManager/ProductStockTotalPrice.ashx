<%@ WebHandler Language="C#" Class="ProductStockTotalPrice" %>
...
public class ProductStockTotalPrice : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private void GetList(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            model.StorageID = context.Request.Form["ddlStorageID"].Trim();
            string ord = orderBy + " " + order;
            int TotalCount = 0;
            DataTable dt = StockAccountBus.GetProductStockTotalPrice(model, pageIndex, pageCount, ord, ref TotalCount, true);
