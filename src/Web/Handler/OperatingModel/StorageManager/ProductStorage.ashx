<%@ WebHandler Language="C#" Class="ProductStorage" %>
using System;
using System.Web;
using System.Data;
using System.Text;
...
public class ProductStorage : BaseHandler
{
    ...
    private void EquipInfo()
    {
        ...
        dataList = StorageBus.GetProductStorageDetails(Convert.ToInt32(ProductID), Convert.ToInt32(pageIndex), Convert.ToInt32(pageSize), ref recCount);
