<%@ WebHandler Language="C#" Class="StorageOutCompareDetails" %>
...
public class StorageOutCompareDetails : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private DataTable GetDataTable(HttpContext context, int pageIndex, int pageCount, string ord,int pageindex,int pagesize, ref int TotalCount)
    {
        ...
        dt = StorageBus.GetStorageCompareDetails(Convert.ToInt32(storageid), Convert.ToInt32(productid), begintime, endtime,ByTimeType,ord, pageindex, pageCount, ref TotalCount);
        return dt;
    }    
