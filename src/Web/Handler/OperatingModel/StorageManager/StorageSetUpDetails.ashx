<%@ WebHandler Language="C#" Class="StorageSetUpDetails" %>
...
public class StorageSetUpDetails : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private DataTable GetDataTable(HttpContext context, int pageIndex, int pageCount, string ord,int pageindex,int pagesize, ref int TotalCount)
    {
        ...
        dt = StorageBus.GetStorageSetUpDetails(Convert.ToInt32(storageid), Convert.ToInt32(productid), begintime, endtime, ord, pageindex, pageCount,Convert.ToInt32(timeType),ByTimeType, timestr, ref TotalCount);
        return dt;
    }    
