<%@ WebHandler Language="C#" Class="GetSubSellCompareList" %>
...
public class GetSubSellCompareList : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            DataTable dt =SubStorageBus.GetSubSellDetail(CompanyCD,BeginDate, EndDate,DeptID,myOrder,pageIndex,pageCount,ref TotalCount);
