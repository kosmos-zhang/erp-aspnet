...
public class ProductSellDetail : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private void GetSellProductLsit(HttpContext context)
    {
        ...
        dt = SubStorageBus.GetProductSellDetailInfo(SellDate, sellEndDate, DeptID, ProductID, pageIndex, pageCount, ord, ref totalCount);
