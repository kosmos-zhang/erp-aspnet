<%@ WebHandler Language="C#" Class="ProductSellTotal" %>
...
public class ProductSellTotal : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private void GetSellProductLsit(HttpContext context)
    {
        ...
        dt = SubStorageBus.GetProductTotalInfo(SellDate, sellEndDate, DeptID, ProductID, pageIndex, pageCount, ord, ref totalCount);
