<%@ WebHandler Language="C#" Class="SellerBusDetail" %>
...
public class SellerBusDetail : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private void GetSellProductLsit(HttpContext context)
    {
        ...
        dt = SubStorageBus.GetSellerBusDetail(SellDate, sellEndDate, DeptID, UserSellerName, pageIndex, pageCount, ord, ref totalCount);
