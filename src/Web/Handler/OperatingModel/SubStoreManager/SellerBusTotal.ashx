<%@ WebHandler Language="C#" Class="SellerBusTotal" %>
...
public class SellerBusTotal : IHttpHandler,System.Web.SessionState.IRequiresSessionState {
    ...
    private void GetSellProductLsit(HttpContext context)
    {
        ...
        dt = SubStorageBus.GetSellerBusTotal(SellDate, sellEndDate, DeptID, UserSellerName,pageIndex, pageCount, ord, ref totalCount);
