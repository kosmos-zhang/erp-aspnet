<%@ WebHandler Language="C#" Class="SubSellCountByDeptDetail" %>
...
public class SubSellCountByDeptDetail : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            DataTable dt = SubStorageBus.GetSubSellDetailByDept(CompanyCD, BeginDate, EndDate, ProductID,DeptID, myOrder, pageIndex, pageCount, ref TotalCount);
