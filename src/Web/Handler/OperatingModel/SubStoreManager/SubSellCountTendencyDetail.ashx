<%@ WebHandler Language="C#" Class="SubSellCountTendencyDetail" %>
...
public class SubSellCountTendencyDetail : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            string orderBy = (!string.IsNullOrEmpty(orderString)) ? orderString.Substring(0, orderString.Length - 2) : "TotalCount";//要排序的字段，如果为空，默认为"ID"
            ...
            DataTable dt = SubStorageBus.GetSubSellCountTenDetail(CompanyCD, Method, BeginDate, EndDate, DeptID, myOrder, XValue, pageIndex, pageCount, ref TotalCount);
