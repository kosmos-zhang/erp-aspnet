<%@ WebHandler Language="C#" Class="SubSellerDetail" %>
...
public class SubSellerDetail : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private void GetSellProductLsit(HttpContext context)
    {
        ...
        dt = SubStorageBus.GetSubSellDetaileInfoBySeller(SellDate, sellEndDate, DeptID, UserSellerName, pageIndex, pageCount, ord, ref totalCount);
