<%@ WebHandler Language="C#" Class="SubSellerTotal" %>
...
public class SubSellerTotal : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private void GetSellProductLsit(HttpContext context)
    {
        ...
        string orderBy = (!string.IsNullOrEmpty(orderString)) ? orderString.Substring(0, orderString.Length - 2) : "Seller";//要排序的字段，如果为空，默认为"ID"
        ...
        string UserSellerName = context.Request.Params["UserSellerName"].ToString().Trim();
        ...
        dt = SubStorageBus.GetSubProductSellInfoByDept(SellDate, sellEndDate, DeptID, UserSellerName, pageIndex, pageCount, ord, ref totalCount);
