<%@ WebHandler Language="C#" Class="SubStorageSellTendencyDetail" %>
...
public class SubStorageSellTendencyDetail : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        if (context.Request.RequestType == "POST")
        {
            ...
            DataTable dt =SubStorageBus.GetSubStorageSellTenDetail(CompanyCD,Method,BeginDate, EndDate,DeptID,myOrder,XValue,pageIndex,pageCount,ref TotalCount);
