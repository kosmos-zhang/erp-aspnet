<%@ WebHandler Language="C#" Class="SubStoreSellDetail" %>
...
public class SubStoreSellDetail : IHttpHandler, System.Web.SessionState.IRequiresSessionState {
    ...
    private void GetSellProductLsit(HttpContext context)
    {
        ...
        dt = SubStorageBus.GetSubSellDetaileInfoByDept(SellDate, sellEndDate, DeptID, pageIndex, pageCount, ord, ref totalCount);
