<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustInfo_Export.aspx.cs" Inherits="Pages_Office_CustManager_CustInfo_Export" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>客户档案批量导入</title>
                            ...
                            <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC" class="table">
                                ...
                                <tr class="table-item">
                                    ...
                                    <td colspan="3" style="width:88%; height:30px; background-color:#FFFFFF; padding-left:5px" align="left">
                                        <asp:LinkButton ID="setup1"  Enabled="false" runat="server" 
                                            onclick="setup1_Click">Excel空值校验</asp:LinkButton>---->
                                        <asp:LinkButton ID="setup2"  Enabled="false" runat="server" 
                                            onclick="setup2_Click">Excel内部重复数据校验</asp:LinkButton>---->
                                            <asp:LinkButton ID="setup6" Enabled="false" runat="server" 
                                            onclick="setup6_Click">特殊字符校验</asp:LinkButton>----&gt;                                        
                                        <asp:LinkButton ID="setup3"  Enabled="false" runat="server" 
                                            onclick="setup3_Click">客户编号,名称是否已存在</asp:LinkButton>----&gt;                                        
                                        <asp:LinkButton ID="setup4"  Enabled="false" runat="server" 
                                            onclick="setup4_Click">日期时间格式校验</asp:LinkButton>---->                                        
                                        <asp:LinkButton ID="setup5"  Enabled="false" runat="server" 
                                            onclick="setup5_Click">分管业务员与其编号匹配校验</asp:LinkButton>----&gt;
                                        <asp:LinkButton ID="setup7" Enabled="false" runat="server" 
                                            onclick="setup7_Click">数字格式校验</asp:LinkButton>----&gt;
                                        <asp:LinkButton ID="setup8" OnClick="setup8_Click" Enabled="false" runat="server">单位性质校验</asp:LinkButton>----&gt;
                                        <asp:LinkButton ID="setup9" onclick="setup9_Click" Enabled="false" runat="server" 
                                            >区域校验</asp:LinkButton>
