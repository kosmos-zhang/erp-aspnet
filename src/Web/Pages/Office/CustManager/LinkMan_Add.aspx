<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LinkMan_Add.aspx.cs" Inherits="Pages_Office_CustManager_LinkMan_Add" %>
...
<head runat="server">
    ...
    <script src="../../../js/office/CustManager/LinkManAdd.js" type="text/javascript"></script>
                                ...
                                <tr>
                                    <td>
                                        <img src="../../../Images/Button/Bottom_btn_save.jpg" alt="保存" id="btn_save" style="cursor: hand"
                                            onclick="AddLinkManData2();" visible="false" runat="server" />
            ...
            <td colspan="2" valign="top">
                ...
                <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                    ...
                    <tr>
                        ...
                        <td height="20" bgcolor="#FFFFFF" style="width: 23%">
                            <input name="txtLinkManName" id="txtLinkManName" type="text" class="tdinput" specialworkcheck="联系人姓名"
                                maxlength="10" onchange="GetSomeLinkInfoByID();" />
                        </td>
                        <td height="20" align="right" bgcolor="#E6E6E6" style="width: 10%">
                    ...
                    <tr>
                        ...
                        <td height="20" align="left" bgcolor="#FFFFFF">
                            <input name="txtAge" id="txtAge" type="text" class="tdinput" size="15" maxlength="3" />
                        </td>
                    </tr>
                    <tr>
                        <td height="20" align="right" bgcolor="#E6E6E6">
                        ...
                        <td height="20" bgcolor="#FFFFFF" colspan="3">
                            <input name="txtOperation" id="txtOperation" type="text" class="tdinput" maxlength="25"
                                style="width: 95%" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="20" bgcolor="#FFFFFF">
                            <input name="txtCompany" id="txtCompany" type="text" class="tdinput" style="width: 95%"
                                maxlength="25" />
                        </td>
                        <td height="20" align="right" bgcolor="#E6E6E6">
                            职务
                        ...
                        <td height="20" bgcolor="#FFFFFF">
                            <input name="txtPosition" id="txtPosition" type="text" class="tdinput" size="15"
                                maxlength="10" />
                        </td>
                        <td height="20" align="right" bgcolor="#E6E6E6">
                            部门
                        ...
                        <td height="20" align="left" bgcolor="#FFFFFF">
                            <input name="txtDepartment" id="txtDepartment" type="text" maxlength="10" class="tdinput" size="15" />
                        </td>
                    </tr>
                </table>
                <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999">
                ...
                <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                    ...
                    <tr>
                        ...
                        <td height="20" align="left" bgcolor="#FFFFFF" style="width: 23%">
                            <input name="txtWorkTel" id="txtWorkTel" maxlength="25" type="text" class="tdinput" />
                        </td>
                        <td height="20" align="right" bgcolor="#E6E6E6" style="width: 10%">
                            手机号
                        </td>
                        <td height="20" align="left" bgcolor="#FFFFFF" style="width: 23%">
                            <input id="txtHandset" type="text" class="tdinput" maxlength="11" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td height="20" align="left" bgcolor="#FFFFFF" style="width: 23%">
                            <input id="txtFax" type="text" maxlength="200" class="tdinput"  style="width: 95%" />
                        </td>
                        <td height="20" align="right" bgcolor="#E6E6E6" style="width: 10%">
                            家庭电话
                        </td>
                        <td height="20" align="left" bgcolor="#FFFFFF" style="width: 23%">
                            <input name="txtHomeTel" id="txtHomeTel" maxlength="200" type="text" style="width: 95%"  class="tdinput" />
                        </td>
                    </tr>
                    <tr>
                        <td height="20" align="right" bgcolor="#E6E6E6">
                        ...
                        <td height="20" align="left" bgcolor="#FFFFFF">
                            <input id="txtMailAddress" type="text" maxlength="30" class="tdinput" style="width: 95%" />
                        </td>
                        <td height="20" align="right" bgcolor="#E6E6E6">
                            邮编
                        </td>
                        <td height="20" align="left" bgcolor="#FFFFFF">
                            <input name="txtPost" id="txtPost" maxlength="20" type="text" class="tdinput" size="15" />
                        </td>
                    </tr>
                    <tr>
                        <td height="20" align="right" bgcolor="#E6E6E6">
                        ...
                        <td height="20" align="left" bgcolor="#FFFFFF">
                            <input name="txtMSN" id="txtMSN" maxlength="30" type="text" class="tdinput" size="15" />
                        </td>
                        <td height="20" align="right" bgcolor="#E6E6E6">
                            QQ
                        </td>
                        <td height="20" align="left" bgcolor="#FFFFFF">
                            <input name="txtQQ" id="txtQQ" maxlength="20" type="text" class="tdinput" size="15" />
                        </td>
                    </tr>
                    <tr>
                        <td height="20" align="right" bgcolor="#E6E6E6">
                        ...
                        <td height="20" align="left" bgcolor="#FFFFFF">
                            <input name="txtPaperType" maxlength="25" id="txtPaperType" type="text" class="tdinput" size="15" />
                        </td>
                        <td height="20" align="right" bgcolor="#E6E6E6">
                            证件号
                        </td>
                        <td height="20" align="left" bgcolor="#FFFFFF">
                            <input name="txtPaperNum" maxlength="25" id="txtPaperNum" type="text" class="tdinput" style="width: 95%" />
                        </td>
                    </tr>
                    <tr>
                        <td height="20" align="right" bgcolor="#E6E6E6">
                        ...
                        <td height="20" align="left" bgcolor="#FFFFFF" colspan="3">
                            <input name="txtHomeAddress" id="txtHomeAddress" maxlength="100" type="text" class="tdinput" size="60" />
                        </td>
                    </tr>
                </table>
                <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999">
                        ...
                        <td height="11" bgcolor="#F4F0ED" class="Blue">
                            <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                <tr>
                                    ...
                                    <td align="right">
                                        <div id='searchClick4'>
                                            <img src="../../../images/Main/Open.jpg" style="cursor: pointer" onclick="oprItem('Tb_04','searchClick4')" /></div>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td height="11" bgcolor="#F4F0ED" class="Blue">
                            <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                <tr>
                                    ...
                                    <td align="right">
                                        <div id='search7'>
                                            <img src="../../../images/Main/Open.jpg" style="cursor: pointer" onclick="oprItem('Tb_07','search7')" /></div>
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                    ...
                    <tr>
                        ...
                        <td height="20" bgcolor="#FFFFFF" style="width: 23%">
                            <input name="txtCreator" id="txtCreator" type="text" class="tdinput" size="15" runat="server"
                                disabled="disabled" />
                        </td>
                        <td height="20" align="right" bgcolor="#E6E6E6" style="width: 10%">
                            建档日期
                    ...
                    <tr>
                        ...
                        <td height="20" bgcolor="#FFFFFF" colspan="5">
                            <textarea name="txtRemark" id="txtRemark" style="width:99%; height:40px rows="3" class="tdinput" cols="80"></textarea>
                        </td>
                    </tr>
                </table>
                <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999">
                        ...
                        <td height="11" bgcolor="#F4F0ED" class="Blue">
                            <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                <tr>
                                    ...
                                    <td align="right">
                                        <div id='search6'>
                                            <img src="../../../images/Main/Open.jpg" style="cursor: pointer" onclick="oprItem('Tb_06','search6')" /></div>
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                    ...
                    <tr>
                        ...
                        <td height="20" bgcolor="#FFFFFF">
                            <textarea id="txtCanUserName" class="tdinput" rows="3" readonly cols="80" style="width: 99%; height:40px" onclick="alertdiv('txtCanUserName,txtCanUserID,2');"
                                name="S1"></textarea><input type="hidden" id="txtCanUserID" />
                        </td>
                    </tr>
                </table>
                <br />
