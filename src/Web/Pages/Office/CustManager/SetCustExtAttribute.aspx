<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SetCustExtAttribute.aspx.cs"
    Inherits="Pages_Office_CustManager_SetCustExtAttribute" %>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td align="right" style="padding: 5px; width: 30%; border-top: solid #9C9A9C 1px;
                    ...
                    客户特性描述<span class="redbold">*</span>
                </td>
            ...
            <tr>
                <td align="right" style="padding: 5px; width: 30%; border-top: solid #9C9A9C 1px;
                    border-right: solid #9C9A9C 1px; border-left: solid #9C9A9C 1px;" bgcolor="#E7E7E7">
                    客户特性类型<span class="redbold">*</span>
                </td>
                <td style="border-top: solid #9C9A9C 1px; border-right: solid #9C9A9C 1px; padding: 5px;">
            ...
            <tr>
                <td align="right" style="border: solid #9C9A9C 1px">
                    <img alt="保存" src="../../../Images/Button/Bottom_btn_save.jpg" onclick="Insert();"  visible="false"
                            ...
                            <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC"
                                ...
                                <tr class="table-item">
                                    ...
                                    <td width="20%" bgcolor="#FFFFFF">
                                        <input id="EFDesc" class="tdinput" type="text" style="width: 95%" maxlength="10" />
                                    </td>
                                    <td width="10%" height="20" bgcolor="#E7E7E7" align="right">
                                        客户特性类型
                                    </td>
                                ...
                                <tr>
                                    <td colspan="6" align="center" bgcolor="#FFFFFF">
                                        <img alt="检索" src="../../../images/Button/Bottom_btn_search.jpg" style='cursor: hand;'
                                            visible="false" onclick='TurnToPage(1)' id="btnQuery" runat="server" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
                    <tr>
                        <td height="28" bgcolor="#FFFFFF">
                            ...
                            <img alt="删除" src="../../../Images/Button/Main_btn_delete.jpg" onclick="fnDel();"
                                runat="server" visible="false" id="btnDel" />
                        </td>
                    </tr>
                </table>
            </td>
                        ...
                        <tr>
                            ...
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF"
                                ...
                                <div class="orderClick" onclick="OrderBy('EFDesc','oGroup');return false;">
                                    客户特性描述<span id="oGroup" class="orderTip"></span></div>
                            </th>
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF"
                                style="width: 150px">
                                <div class="orderClick" onclick="OrderBy('EFType','oC1');return false;">
                                    客户特性类型<span id="oC1" class="orderTip"></span></div>
                            </th>
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
...
<script src="../../../js/office/CustManager/TableExtFieldsInfo.js" type="text/javascript"></script>
