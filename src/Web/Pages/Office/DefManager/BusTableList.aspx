<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BusTableList.aspx.cs" Inherits="Pages_Office_DefManager_BusTableList" %>
...
<head>
    ...
    <script src="../../../js/office/DefManager/BusTableList.js" type="text/javascript"></script>
...
<body>
    ...
    <input id="isreturn" value="" type="hidden" runat="server" />
    <input id="hidSearchCondition" value="" type="hidden" runat="server" />
                            ...
                            <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC"
                                ...
                                <tr class="table-item">
                                    ...
                                    <td class="tdColInput" width="23%">
                                        <input name="txtAliasTableName" id="txtAliasTableName" class="tdinput" type="text"
                                            style="width: 99%" specialworkcheck="表单别名" runat="server" />
                                    </td>
                                    <td height="20" class="tdColTitle" width="10%">
                                    </td>
                                    <td class="tdColInput" width="23%">
                    ...
                    <tr>
                        <td height="28" bgcolor="#FFFFFF">
                            <a href="#" onclick="AddNew();">
                                <img runat="server" id="btnAdd" src="../../../images/Button/Bottom_btn_new.jpg" alt="新建表单"
                    ...
                    <tbody>
                        <tr>
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF" style="width:25%">
                                <div class="orderClick" onclick="OrderBy('AliasTableName','oAliasTableName');return false;">
                                    表单别名<span id="oAliasTableName" class="orderTip"></span></div>
                            </th>
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF" style="width:25%">
                                <div class="orderClick" onclick="OrderBy('CustomTableName','oCustomTableName');return false;">
                                    表单名<span id="oCustomTableName" class="orderTip"></span></div>
                            </th>
