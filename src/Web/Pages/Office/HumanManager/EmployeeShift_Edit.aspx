    ...
    <tr>
        <td  colspan="2">
            ...
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999" id="tblBaseInfo" style="display:block">
                <tr>
                    <td height="20" class="tdColTitle" width="10%">调职单编号<span class="redbold">*</span></td>
                    ...
                    <td height="20" class="tdColTitle" width="10%">调职单主题<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput" width="23%">
                ...
                <tr>
                    <td height="20" class="tdColTitle">原部门</td>
                    <td height="20" class="tdColInput">
                    ...
                    <td height="20" class="tdColTitle">原岗位</td>
                    <td height="20" class="tdColInput">
                    ...
                    <td height="20" class="tdColTitle">原岗位职等</td>
                    <td height="20" class="tdColInput">
                ...
                <tr>
                    <td height="20" class="tdColTitle">调入部门<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput">
                    ...
                    <td height="20" class="tdColTitle">调入岗位<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput">
                        <asp:DropDownList ID="ddlNewQuarter" runat="server"></asp:DropDownList>
                    </td>
                    <td height="20" class="tdColTitle">调入岗位职等<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput">
                        <uc1:CodeType ID="ctNewQuaterAdmin" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td height="20" class="tdColTitle">调出时间<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput">
                    ...
                    <td height="20" class="tdColTitle">调入时间<span class="redbold">*</span></td>
                    <td height="20" class="tdColInput">
