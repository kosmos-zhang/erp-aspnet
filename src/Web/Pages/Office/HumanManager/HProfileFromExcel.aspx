                                    ...
                                    <td>
                                        <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="table">
                                            ...
                                            <tr class="table-item" id="tr_dept" runat="server">
                                                ...
                                                <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                                                <tr>
                                                    <td background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">部门编号</td>
                                                    <td background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">上级部门</td>
                                                    <td background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">当前部门名称</td>
                                                </tr>
                                            ...
                                            <tr class="table-item" id="tr_quqrter" runat="server">
                                                ...
                                                <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                                                <tr>
                                                    <td background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">岗位编号</td>
                                                    <td background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">上级岗位</td>
                                                    <td background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">当前岗位名称</td>
                                                    <td background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">所在部门</td>
                                                </tr>
