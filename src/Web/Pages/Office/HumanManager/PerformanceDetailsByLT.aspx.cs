...
public partial class Pages_Office_HumanManager_PerformanceDetailsByLT : BasePage
{
    ...
    protected void Type1_CheckedChanged(object sender, EventArgs e)
    {
            //chkType2.Checked = false;
            //chkType3.Checked = false;
     
        btnQuery_Click1(this, null);
    }
