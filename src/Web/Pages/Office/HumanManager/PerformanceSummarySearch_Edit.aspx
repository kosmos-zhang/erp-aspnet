                           ...
                           <asp:TextBox ID="txtStartDate" runat="server" MaxLength="10" CssClass="tdinput" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',el:$dp.$('txtStartDate')})"></asp:TextBox>
                                   ...
                                   <tr>
                                    ...
                                    <td class="tdColInput" width="23%" >
                                     ...
                                     <td class="tdColTitle" width="10%">任务状态</td>
                                    <td class="tdColInput" width="23%">
                ...
                <table width="99%" border="0" align="center" cellpadding="0" id="Table1"  cellspacing="0" bgcolor="#CCCCCC">
                    <tr>
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                                <tr>
                                    <td height="20" class="tdColTitle" width="10%">考核总得分</td>
                                    <td class="tdColInput" width="23%">
                ...
                <table width="99%" border="0" align="center" cellpadding="0" id="Table3"  cellspacing="0" bgcolor="#CCCCCC">
                    <tr>
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0"  cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
                                <tr>
                                    <td height="20" class="tdColTitle" width="10%">累计扣分<span style="color:Red ">*</span></td>
                                    <td class="tdColInput" width="23%">
                                    ...
                                    <td class="tdColTitle" width="10%">累计加分<span style="color:Red ">*</span></td>
                                    <td class="tdColInput" width="23%">
                                   ...
                                   <tr>
                                    ...
                                    <td height="20" class="tdColTitle" width="10%">建议事项<span style="color:Red ">*</span></td>
                                    <td class="tdColInput" width="23%">
                                   ...
                                   <tr>
                                    ...
                                    <td class="tdColInput" width="23%">
                                     ...
                                     <td class="tdColTitle" width="10%">考核等级<span style="color:Red ">*</span></td>
                                    <td class="tdColInput" width="23%">
