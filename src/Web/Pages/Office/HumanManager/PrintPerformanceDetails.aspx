<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintPerformanceDetails.aspx.cs" Inherits="Pages_Office_HumanManager_PrintPerformanceDetails" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>绩效明细报表页面</title>
 <style type="text/css">
        @media print
        {
            .onlyShow
