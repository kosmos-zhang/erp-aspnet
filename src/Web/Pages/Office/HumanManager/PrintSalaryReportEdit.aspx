<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintSalaryReportEdit.aspx.cs" Inherits="Pages_Office_HumanManager_PrintSalaryReportEdit" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>工资报表打印页面</title>
     <style type="text/css">
        @media print
        {
            .onlyShow
 ...
 <object classid="CLSID:8856F961-340A-11D0-A96B-00C04FD705A2" height="0" id="WB" width="0"></object>
    ...
    <div>
     <span class="noprint2"  style="text-align:center; margin-right:50px; margin-top:4px; width:100%;">
      <input id="linesPerPage" type="hidden"  value="40" runat="server" />
      ...
      <%-- <asp:ImageButton  ID="btnOutWord" runat="server"  ImageUrl="~/Images/Button/Main_btn_out.jpg"  OnClick="btnOutWord_Click"/>--%>
     </span>
