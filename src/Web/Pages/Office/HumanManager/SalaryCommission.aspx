<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalaryCommission.aspx.cs" Inherits="Pages_Office_HumanManager_SalaryCommission" %>
<%@ Register src="../../../UserControl/Message.ascx" tagname="Message" tagprefix="uc1" %>
<%@ Register src="../../../UserControl/Human/ProdcutStorageChec.ascx" tagname="Product" tagprefix="uc1" %>
...
<head runat="server">
    ...
    <script src="../../../js/office/HumanManager/SalaryCommission.js" type="text/javascript"></script>
        <style  type="text/css">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"  class="tblMain" >
    <tr>
    ...
    <tr>
        <td height="30" align="center" colspan="2" class="Title" bgcolor="#f0f0f0">产品单品提成设置</td>
    </tr>
    <tr bgcolor="#f0f0f0">
  ...
  <div  style="overflow-y:auto;width:100%; line-height:14pt;letter-spacing:0.2em;height:400px;  overflow-x:auto; vertical-align :top"> 
    <table width="100%" border="0" cellpadding="0" cellspacing="0" id="tblmain" style="height :500px; vertical-align:top">
        ...
        <tr><td colspan="2" height="10"><input type="hidden" runat="server" id="txtIsHaveSell" />
                            <uc1:Product ID="ProductInfoControl" runat="server" /></td></tr>
    </table>
  </div>
