...
public partial class Pages_Office_HumanManager_SalaryCommission : BasePage
{
    ...
    private string CreateSalaryListTable()
    {
        ...
        table.AppendLine("		</td>                                                             ");
        table.AppendLine("		<td class='ListTitle' style='width:32%'>项目编号</td>             ");
        table.AppendLine("		<td class='ListTitle' style='width:32%'>项目名称</td>             ");
        table.AppendLine("		<td class='ListTitle' style='width:22%'><span style=\"color:Red\">*</span>提成率(%)</td>               ");
