<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalaryInsuSocial.aspx.cs" Inherits="Pages_Office_HumanManager_SalaryInsuSocial" %>
...
<head runat="server">
    ...
    <script src="../../../js/office/HumanManager/SalaryInsuSocial.js" type="text/javascript"></script>
    <style type="text/css">
        #tblMain
        {
            margin-top:0px;
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="maintable" id="tblMain">
    ...
    <tr>
        <td height="30" align="center" colspan="2" class="Title">社会保险设置</td>
    </tr>
    <tr>
