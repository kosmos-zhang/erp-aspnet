<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalaryTime.aspx.cs" Inherits="Pages_Office_HumanManager_SalaryTime" %>
...
<head runat="server">
    ...
    <script src="../../../js/office/HumanManager/SalaryTime.js" type="text/javascript"></script>
    <style type="text/css">
        #tblMain
        {
            margin-top:0px;
...
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" class="maintable" id="tblMain">
    ...
    <tr>
        <td height="30" align="center" colspan="2" class="Title">计时工资设置</td>
    </tr>
    <tr>
