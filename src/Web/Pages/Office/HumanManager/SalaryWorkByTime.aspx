<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalaryWorkByTime.aspx.cs" Inherits="Pages_Office_HumanManager_SalaryWorkByTime" %>
                                ...
                                <tr>
                                    <td colspan="6" align="center" bgcolor="#FFFFFF">
                                        ...
                                        <asp:ImageButton ID="imgSearch" runat="server"  
                                            ...
                                            onclick="imgSearch_Click"  Visible="false"/>
                                    </td>
                                </tr>
                            </table>
                        </td>
        ...
        <tr>
            <td colspan="2">
                ...
                <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" id="tblDetailList" >
                    ...
                    <tr>
                        <td height="30" colspan="2" align="center" valign="top" class="Title">计时工资分析报表</td>
                    </tr>
