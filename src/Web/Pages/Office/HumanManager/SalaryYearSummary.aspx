<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalaryYearSummary.aspx.cs" Inherits="Pages_Office_HumanManager_SalaryYearSummary" %>
...
<head id="Head1" runat="server">
  ...
  <script src="../../../js/office/HumanManager/SalaryYearSummary.js" type="text/javascript"></script>
        ...
        <tr>
            <td colspan="2"  >
             ...
             <tr>
                    ...
                    <tr>
                        <td height="20" colspan="2" align="center" valign="top" class="Title">年度工资分析表</td>
                    </tr>
                              <tr>
                            ...
                            <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999">
                                <tr>
                                    <td height="28" bgcolor="#FFFFFF">
                                     <img src="../../../images/Button/Main_btn_dyyl.jpg" alt="打印" id="btnPrint" runat="server"    onclick="PrintRecibal();" visible="false" />
                ...
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" id="tblDetailInfo" bgcolor="#999999">
                                ...
                                <tr>
                                         ...
                                         <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                          ...
                                          <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF" colspan="2">
                                                1月
                                        </th> 
                                                <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF" colspan="2">
                                                2月
                                    ...
                                    <tr>
                                         ...
                                         <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            ...
                                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('MonthCount1','oC1');return false;">
                                                人数<span id="oC1" class="orderTip"></span>
                                            </div>
                                        </th> 
                                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('MonthMoney1','oC2');return false;">
                                               金额<span id="oC2" class="orderTip"></span>
                                            </div>
                                        </th> 
                                          
                                           <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('MonthCount2','oC3');return false;">
                                                人数<span id="oC3" class="orderTip"></span>
                                            </div>
                                        </th> 
                                        <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('MonthMoney2','oC4');return false;">
                                                金额<span id="oC4" class="orderTip"></span>
                                            </div>
                                        </th>
                                         <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('MonthCount3','oC5');return false;">
                                                人数<span id="oC5" class="orderTip"></span>
                                            </div>
                                        </th>
                                        <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('MonthMoney3','oC6');return false;">
                                               金额<span id="oC6" class="orderTip"></span>
                                            </div>
                                        </th>
                                             <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('MonthCount4','oC7');return false;">
                                               人数<span id="oC7" class="orderTip"></span>
                                            </div>
                                        </th>
                                             <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('MonthMoney4','oC8');return false;">
                                                金额<span id="oC8" class="orderTip"></span>
                                            </div>
                                        </th>
                                             <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('MonthCount5','oC9');return false;">
                                                人数<span id="oC9" class="orderTip"></span>
                                            </div>
                                        </th> 
                                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('MonthMoney5','oC10');return false;">
                                               金额<span id="oC10" class="orderTip"></span>
                                            </div>
                                        </th> 
                                          
                                           <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('MonthCount6','oC11');return false;">
                                                人数<span id="oC11" class="orderTip"></span>
                                            </div>
                                        </th> 
                                        <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('MonthMoney6','oC12');return false;">
                                                金额<span id="oC12" class="orderTip"></span>
                                            </div>
                                        </th>
                                         <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('MonthCount7','oC13');return false;">
                                                人数<span id="oC13" class="orderTip"></span>
                                            </div>
                                        </th>
                                        <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('MonthMoney7','oC14');return false;">
                                               金额<span id="oC14" class="orderTip"></span>
                                            </div>
                                        </th>
                                             <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('MonthCount8','oC15');return false;">
                                               人数<span id="oC15" class="orderTip"></span>
                                            </div>
                                        </th>
                                             <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('MonthMoney8','oC16');return false;">
                                                金额<span id="oC16" class="orderTip"></span>
                                            </div>
                                        </th>
                                             <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('MonthCount9','oC17');return false;">
                                                人数<span id="oC17" class="orderTip"></span>
                                            </div>
                                        </th>
                                        <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('MonthMoney9','oC18');return false;">
                                               金额<span id="oC18" class="orderTip"></span>
                                            </div>
                                        </th>
                                             <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('MonthCount10','oC19');return false;">
                                               人数<span id="oC19" class="orderTip"></span>
                                            </div>
                                        </th>
                                             <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('MonthMoney10','oC20');return false;">
                                                金额<span id="oC20" class="orderTip"></span>
                                            </div>
                                        </th>
                                             <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('MonthCount11','oC21');return false;">
                                                人数<span id="oC21" class="orderTip"></span>
                                            </div>
                                        </th>
                                        <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('MonthMoney11','oC22');return false;">
                                               金额<span id="oC22" class="orderTip"></span>
                                            </div>
                                        </th>
                                             <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('MonthCount12','oC23');return false;">
                                               人数<span id="oC23" class="orderTip"></span>
                                            </div>
                                        </th>
                                             <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('MonthMoney12','oC24');return false;">
                                                金额<span id="oC24" class="orderTip"></span>
                                            </div>
                                        </th>
                                          <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                            <div class="orderClick" onclick="OrderBy('summary','oC25');return false;">
                                                月平均金额<span id="oC25" class="orderTip"></span>
                                            </div>
                                        </th>
                                    </tr>
                                </tbody>
