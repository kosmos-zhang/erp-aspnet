<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseArriveInfo.aspx.cs"
    Inherits="Pages_Office_PurchaseManager_PurchaseArriveInfo" %>
...
<head>
    ...
    <script src="../../../js/office/PurchaseManager/PurchaseArriveInfo.js" type="text/javascript"></script>
                    ...
                    <tr>
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC"
                                ...
                                <tr id="TROtherConditon" style="display: none">
                                    <td width="10%" height="20" bgcolor="#E7E7E7" align="right">
                                ...
                                <tr>
                                    <td colspan="6" align="center" bgcolor="#FFFFFF">
                                        ...
                                        <img id="btnQuery" alt="检索" src="../../../images/Button/Bottom_btn_search.jpg" style='cursor: hand;'
                                            onclick='SearchArriveData()' runat="server" visible="false" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
                    <tr>
                        <td height="28" bgcolor="#FFFFFF">
                            ...
                            <img id="btn_create" src="../../../images/Button/Bottom_btn_new.jpg" alt="新建" style="cursor: hand;"
                                onclick="CreatePurchaseArrive()" runat="server" visible="false" />
                            <img id="btn_del" src="../../../Images/Button/Main_btn_delete.jpg" alt="删除" style="cursor: hand;"
                                onclick="DelArrive()" runat="server" visible="false" />
                            <%--<img id="btnImport" src="../../../images/Button/Main_btn_out.jpg" alt="导出Excel" />--%>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                <div class="orderClick" onclick="OrderBy('ArriveNo','oArriveNo');return false;">
                                    单据编号<span id="oArriveNo" class="orderTip"></span></div>
                            </th>
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                            ...
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                <div class="orderClick" onclick="OrderBy('OrderNo','oOrderNo');return false;">
                                    采购订单编号<span id="oOrderNo" class="orderTip"></span></div>
                            </th>
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                <div class="orderClick" onclick="OrderBy('OrderTitle','OrderTitle');return false;">
                                    采购订单名称<span id="OrderTitle" class="orderTip"></span></div>
                            </th>
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                <div class="orderClick" onclick="OrderBy('TotalMoney','oTotalMoney');return false;">
                                    总金额<span id="oTotalMoney" class="orderTip"></span></div>
                            </th>
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
