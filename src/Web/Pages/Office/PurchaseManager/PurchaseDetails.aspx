<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseDetails.aspx.cs" Inherits="Pages_Office_PurchaseManager_PurchaseDetails" %>
...
<head>
    ...
    <script src="../../../js/office/PurchaseManager/PurchaseDetails.js" type="text/javascript"></script>
                        ...
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC"
                                ...
                                <tr class="table-item">
                                    ...
                                    <td bgcolor="#FFFFFF" width="15%">
                                       <input type="radio" id="radArrive"      name="sk" checked="checked"/>采购到货单  &nbsp; <input type="radio" id="rdDingdan"   name="sk"/>采购订单
                                    </td>
                                    <td bgcolor="#E7E7E7" align="right" width="10%">
                                ...
                                <tr>
                                    ...
                                    <input type="hidden" id="hidSearchCondition" name="hidSearchCondition" />
                                        <img id="btnQuery" alt="检索" src="../../../images/Button/Bottom_btn_search.jpg" style='cursor: hand;'
                                            onclick='SearchPurchaseArriveCollect()'   runat="server" visible="false"/>
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" id="pageDataList1"
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF"><div class="orderClick" onclick="OrderBy('ProductName','oSendAddress');return false;">品名<span id="oSendAddress" class="orderTip"></span></div></th>
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF"><div class="orderClick" onclick="OrderBy('Specification','oReceiveOverAddress');return false;">规格<span id="oReceiveOverAddress" class="orderTip"></span></div></th>
                               <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF"><div class="orderClick" onclick="OrderBy('ColorName','oColorName');return false;">颜色<span id="oColorName" class="orderTip"></span></div></th>
                             <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF"><div class="orderClick" onclick="OrderBy('ConfirmDate','oConfirmDate');return false;">日期<span id="oConfirmDate" class="orderTip"></span></div></th>
                     ...
                     <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF"><div class="orderClick" onclick="OrderBy('ProviderName','oArriveNo');return false;">供应商<span id="oArriveNo" class="orderTip"></span></div></th>
                 <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF"><div class="orderClick" onclick="OrderBy('PurchaseName','oPurchaseName');return false;">采购员<span id="oPurchaseName" class="orderTip"></span></div></th>
           <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF"><div class="orderClick" onclick="OrderBy('PurchaseName','oPurchaseName');return false;">单据编号<span id="Span1" class="orderTip"></span></div></th>
