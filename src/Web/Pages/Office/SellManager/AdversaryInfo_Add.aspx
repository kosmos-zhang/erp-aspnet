<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdversaryInfo_Add.aspx.cs"
    Inherits="Pages_Office_SellManager_AdversaryInfo_Add" %>
...
<head runat="server">
  ...
  <link rel="stylesheet" type="text/css" href="../../../css/default.css" />
   <meta http-equiv="Content-Type" content="text/html; charset=gb2312" />
    ...
    <script src="../../../js/office/SellManager/AdversaryInfoAdd.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        function AlertCustClassMsg() {
            ...
            maskObj.setAttribute('id', 'CustType');
        ...
        function hideUserList() {
            ...
            document.body.removeChild(CustType);
...
<body>
                                ...
                                <tr>
                                    <td height="28" bgcolor="#FFFFFF" style="padding-top: 5px; padding-left: 5px;">
                                        <img runat="server" visible="false" src="../../../images/Button/Bottom_btn_save.jpg"
                                            alt="保存" id="btn_save" style="cursor: hand" onclick="checkonly();" />
            ...
            <td colspan="2" valign="top">
                ...
                <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                    ...
                    <tr>
                        ...
                        <td height="20" class="tdColInput" width="23%">
                            <input id="CustName" style="width: 95%;" specialworkcheck="对手名称" class="tdinput" onblur="LoadPYShort();"
                        ...
                        <td height="20" class="tdColInput" width="23%">
                            <input id="ShortNam" style="width: 95%;" class="tdinput" specialworkcheck="对手简称"  maxlength="25" type="text" />
                        </td>
                        <td height="20" align="right" class="tdColTitle" width="10%">
                            对手拼音代码
                        </td>
                        <td height="20" class="tdColInput" width="23%">
                            <input id="PYShort" style="width: 95%;" specialworkcheck="对手拼音代码"   class="tdinput" type="text" />
                        </td>
                    </tr>
                    <tr>
                ...
                <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                    ...
                    <tr>
                        ...
                        <td height="20" class="tdColInput" width="23%">
                            <input type="text" style="width: 95%;"  specialworkcheck="法人代表"   class="tdinput" maxlength="10" id="ArtiPerson" />
                        </td>
                        <td height="20" align="right" class="tdColTitle" width="10%">
                    ...
                    <tr>
                        ...
                        <td class="tdColInput" width="23%">
                            <input id="SetupMoney"  onchange="Number_round(this,2)" maxlength="10"  style="width: 95%;" class="tdinput" type="text" />
                        </td>
                        <td align="right" class="tdColTitle" width="10%">
                            注册地址
                        </td>
                        <td class="tdColInput" width="23%">
                            <input id="SetupAddress" maxlength="50" specialworkcheck="注册地址" style="width: 95%;" class="tdinput" type="text" />
                        </td>
                    </tr>
                    <tr>
                        <td height="20" align="right" class="tdColTitle" width="10%">
                        ...
                        <td height="20" class="tdColInput" width="23%">
                            <input id="website" maxlength="50"  specialworkcheck="公司网址"  style="width: 95%;" class="tdinput" type="text" />
                        </td>
                        <td height="20" align="right" class="tdColTitle" width="10%">
                            资产规模(万元)
                        </td>
                        <td height="20" class="tdColInput" width="23%">
                            <input id="CapitalScale" onchange="Number_round(this,2)" maxlength="10" style="width: 95%;" class="tdinput" type="text" />
                        </td>
                        <td height="20" align="right" class="tdColTitle" width="10%">
                            经营范围
                        </td>
                        <td height="20" class="tdColInput" width="23%">
                            <input id="SellArea" maxlength="100"  specialworkcheck="经营范围"  style="width: 95%;" class="tdinput" type="text" />
                        </td>
                    </tr>
                    <tr>
                        <td height="20" align="right" class="tdColTitle" width="10%">
                        ...
                        <td height="20" class="tdColInput" width="23%">
                            <input id="SaleroomY" onchange="Number_round(this,2)" maxlength="10" style="width: 95%;" class="tdinput" type="text" />
                        </td>
                        <td height="20" align="right" class="tdColTitle" width="10%">
                            年利润额(万元)
                        </td>
                        <td height="20" class="tdColInput" width="23%">
                            <input id="ProfitY" onchange="Number_round(this,2)" maxlength="10" style="width: 95%;" class="tdinput" type="text" />
                        </td>
                        <td height="20" align="right" class="tdColTitle" width="10%">
                            税务登记号
                        </td>
                        <td height="20" class="tdColInput" width="23%">
                            <input id="TaxCD" maxlength="30"   specialworkcheck="税务登记号"  style="width: 95%;" class="tdinput" type="text" />
                        </td>
                    </tr>
                    <tr>
                        <td height="20" align="right" class="tdColTitle" width="10%">
                        ...
                        <td height="20" class="tdColInput" width="23%">
                            <input id="BusiNumber" maxlength="30"  specialworkcheck="营业执照号"  style="width: 95%;" class="tdinput" type="text" />
                        </td>
                        <td height="20" align="right" class="tdColTitle" width="10%">
                        ...
                        <td height="20" class="tdColInput" width="23%">
                            <input id="Address" maxlength="50" specialworkcheck="地址" style="width: 95%;" class="tdinput" type="text" />
                        </td>
                    </tr>
                    <tr>
                        <td align="right" class="tdColTitle" width="10%">
                        ...
                        <td class="tdColInput" width="23%">
                            <input id="Post" maxlength="10"  specialworkcheck="邮编"  style="width: 95%;" class="tdinput" type="text" />
                        </td>
                        <td align="right" class="tdColTitle" width="10%">
                            联系人
                        </td>
                        <td class="tdColInput" width="23%">
                            <input id="ContactName" maxlength="25"  specialworkcheck="联系人"  style="width: 95%;" class="tdinput" type="text" />
                        </td>
                        <td align="right" class="tdColTitle" width="10%">
                            电话
                        </td>
                        <td class="tdColInput" width="23%">
                            <input id="Tel" maxlength="25"  specialworkcheck="电话"  style="width: 95%;" class="tdinput" type="text" />
                        </td>
                    </tr>
                    <tr>
                        <td align="right" class="tdColTitle" width="10%">
                        ...
                        <td class="tdColInput" width="23%">
                            <input id="Mobile" maxlength="25"  specialworkcheck="手机"  style="width: 95%;" class="tdinput" type="text" />
                        </td>
                        <td align="right" class="tdColTitle" width="10%">
                            邮件
                        </td>
                        <td class="tdColInput" width="23%">
                            <input id="email" maxlength="25"  specialworkcheck="邮件" class="tdinput" style="width: 95%;" type="text" />
                        </td>
                        <td align="right" class="tdColTitle" width="10%">
                        </td>
                        <td class="tdColInput" width="23%">
                ...
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999"
                    ...
                    <tr>
                        ...
                        <td height="20" align="left" bgcolor="#FFFFFF" style="width: 23%;">
                            <select id="UsedStatus" style="width: 120px;margin-top:2px;margin-left:2px;" >
                            ...
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
                                <tr>
                                    <td height="28" bgcolor="#FFFFFF" colspan="11" style="padding-top: 5px; padding-left: 5px;">
                                        <img src="../../../images/Button/Show_add.jpg"  id="imgAdd"
                                            style="cursor: hand; " onclick="AddSignRow();"   runat="server"  visible="false" />
                                        <img src="../../../images/Button/Show_del.jpg"  id="imgDel"
                                            style="cursor: hand" onclick="fnDelOneRow()"   runat="server"  visible="false" />
                                    </td>
                                </tr>
                            </table>
    ...
    <div id="userList" class="userListCss11111" style="overflow-x: hidden; left: 200px; z-index: 110;
        overflow-y: scroll">
