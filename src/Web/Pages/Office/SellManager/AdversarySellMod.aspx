<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdversarySellMod.aspx.cs" Inherits="Pages_Office_SellManager_AdversarySellMod" %>
...
<head id="Head1" runat="server">
 ...
 <meta http-equiv="Content-Type" content="text/html; charset=gb2312" />
    ...
    <script src="../../../js/office/SellManager/AdversarySellMod.js" type="text/javascript"></script>
                            ...
                            <table width="100%">
                                <tr>
                                    <td height="28" bgcolor="#FFFFFF" style="padding-top: 5px; padding-left: 5px;">
                                        ...
                                        <img src="../../../Images/Button/Bottom_btn_back.jpg" style="display: inline;cursor: hand" alt="返回"
                                    ...
                                    <td  align="right" bgcolor="#FFFFFF" style="padding-top: 5px; width: 70px;">
                                        <img id="btnPrint" src="../../../images/Button/Main_btn_print.jpg" style="cursor: pointer"
                                            title="打印" alt="打印"  onclick="fnPrintOrder()"  />
                                    </td>
                                </tr>
                            </table>
                        </td>
