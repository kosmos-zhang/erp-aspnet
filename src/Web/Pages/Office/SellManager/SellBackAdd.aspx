<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SellBackAdd.aspx.cs" Inherits="Pages_Office_SellManager_SellBackAdd" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../../js/office/SellManager/SellBackAdd.js" type="text/javascript"></script>
...
<body onload="formatNumLen()">
    ...
    var FlowJs_BillNo ='SellBackUC_txtCode';          //当前单据编码名称
                ...
                <td colspan="2" valign="top">
                    ...
                    <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                        ...
                        <tr>
                            ...
                            <td bgcolor="#FFFFFF" style="width: 23%">
                                <uc3:CodingRuleControl ID="SellBackUC" runat="server" />
                            </td>
                            <td align="right" bgcolor="#E6E6E6" style="width: 10%">
                                主题
                            </td>
                            <td bgcolor="#FFFFFF" style="width: 23%">
                                <input id="BackCargoTheme" specialworkcheck="主题" type="text" style="width: 95%;" class="tdinput" maxlength="50" />
                            </td>
                            <td align="right" bgcolor="#E6E6E6" style="width: 10%">
                        ...
                        <tr>
                            ...
                            <td height="20" align="left" bgcolor="#FFFFFF">
                                <input id="CustTel" class="tdinput" specialworkcheck="客户电话"  type="text" style="width: 95%;" maxlength="50" />
                            </td>
                        </tr>
                        <tr>
                            <td height="20" align="right" bgcolor="#E6E6E6">
                        ...
                        <tr>
                            ...
                            <td height="20" align="left" bgcolor="#FFFFFF">
                                <input id="SendAddress" specialworkcheck="发货地址" class="tdinput" type="text" style="width: 95%;" maxlength="100" />
                            </td>
                        </tr>
                        <tr>
                            <td height="20" align="right" bgcolor="#E6E6E6">
                            ...
                            <td height="20" align="left" bgcolor="#FFFFFF">
                                <input id="ReceiveAddress"  specialworkcheck="收货地址"  class="tdinput" type="text" style="width: 95%;" maxlength="100" />
                            </td>
                            <td height="20" align="right" bgcolor="#E6E6E6">
                                退货日期<span class="redbold">*</span>
                            </td>
                            <td height="20" align="left" bgcolor="#FFFFFF">
                    ...
                    <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                        ...
                        <tr>
                            ...
                            <td height="20" bgcolor="#FFFFFF">
                                <input id="Discount" onchange="Number_round(this,<%=SelPoint %>)"  value="100.00" onblur="fnTotalInfo()" style="width: 120px;"
                                    class="tdinput" type="text" size="15" />
                            </td>
                            <td height="20" align="right" bgcolor="#E6E6E6">
                                折扣金额
                            </td>
                        ...
                        <tr>
                            ...
                            <td height="20" bgcolor="#FFFFFF">
                                <input id="NotPayTotal" onchange="Number_round(this,<%=SelPoint %>)"  style="width: 95%;" onblur="fnTotalInfo()" class="tdinput"
                    ...
                    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999"
                        ...
                        <tr>
                            ...
                            <td height="20" colspan="5" align="left" bgcolor="#FFFFFF">
                                <input id="Remark"   specialworkcheck="备注"  class="tdinput" style="width: 98%" type="text" maxlength="100" />
                            </td>
                        </tr>
                    </table>
                    <br />
                                ...
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
                                    <tr>
                                        <td height="28" bgcolor="#FFFFFF" colspan="11" style="padding-top: 5px; padding-left: 5px;">
                                            <img runat="server" visible="false"  alt="添加" src="../../../images/Button/Show_add.jpg" id="imgAdd" style="cursor: hand"
                                                onclick="AddSignRows();" />
                                            <img runat="server" visible="false"  alt="删除" src="../../../images/Button/Show_del.jpg" id="imgDel" style="cursor: hand"
                                                onclick="fnDelOneRow()" />
                                            <img runat="server" visible="false"  alt="添加" src="../../../Images/Button/UnClick_tj.jpg" style="display: none;"
                                                id="imgUnAdd" />
                                            <img  runat="server" visible="false" alt="删除" src="../../../Images/Button/UnClick_del.jpg" style="display: none;"
                                                id="imgUnDel" />
                                            ...
                                            <img  runat="server" visible="false"  alt="选择明细" src="../../../Images/Button/Unclick_From.jpg" id="btnUnFromBill"
                                                style="display: none;" />
                                            <img id="btnSubSnapshot" src="../../../images/Button/btn_kckz.jpg" style="cursor: hand"
                                                onclick="ShowSnapshot();" alt="库存快照" />
                                                
                                                <img alt="条码扫描" src="../../../Images/Button/btn_tmsm.jpg" id="GetGoods"  style="cursor: pointer" onclick="fnGetProInfoByBarCode()" runat="server"  visible="false"   />
                                           <img alt="条码扫描" src="../../../Images/Button/btn_tmsmu.jpg"  id="UnGetGoods"  style=" display:none"  visible="false" runat="server" />
