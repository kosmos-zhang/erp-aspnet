...
public partial class Pages_Office_SellManager_SellBackAdd : BasePage
{
    //小数精度
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            UserSeller.Text = ((UserInfoUtil)SessionUtil.Session["UserInfo"]).EmployeeName.ToString();
            BackDate.Text = DateTime.Now.ToString("yyyy-MM-dd");
            ...
            SellBackUC.CodingType = ConstUtil.CODING_RULE_SELL;//销售退货单编号
            SellBackUC.ItemTypeID = ConstUtil.CODING_RULE_SELLBACK_NO;//销售退货单编号
