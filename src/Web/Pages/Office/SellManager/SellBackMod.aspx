                ...
                <td colspan="2" valign="top">
                    ...
                    <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                        ...
                        <tr>
                            ...
                            <td bgcolor="#FFFFFF" style="width: 23%">
                                <input id="BackCargoTheme" specialworkcheck="主题" type="text" style="width: 95%;"
                        ...
                        <tr>
                            ...
                            <td height="20" align="left" bgcolor="#FFFFFF">
                                <input id="SendAddress" specialworkcheck="发货地址" class="tdinput" type="text" style="width: 95%;"
                                    maxlength="100" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td height="20" align="left" bgcolor="#FFFFFF">
                                <input id="ReceiveAddress" specialworkcheck="收货地址" class="tdinput" type="text" style="width: 95%;"
                                    maxlength="100" />
                            </td>
                            <td height="20" align="right" bgcolor="#E6E6E6">
                    ...
                    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999"
                        ...
                        <tr>
                            ...
                            <td height="20" colspan="5" align="left" bgcolor="#FFFFFF">
                                <input id="Remark" specialworkcheck="备注" class="tdinput" style="width: 98%" type="text"
                                    maxlength="100" />
                            </td>
                        </tr>
                    </table>
                                ...
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
                                    <tr>
                                        <td height="28" bgcolor="#FFFFFF" colspan="11" style="padding-top: 5px; padding-left: 5px;">
                                            <img runat="server" visible="false" alt="添加" src="../../../images/Button/Show_add.jpg"
                                            ...
                                            <img runat="server" visible="false" alt="添加" src="../../../Images/Button/UnClick_tj.jpg"
                                            ...
                                            <img runat="server" visible="false" alt="选择明细" src="../../../Images/Button/Unclick_From.jpg"
