<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SellChance_Add.aspx.cs" Inherits="Pages_Office_SellManager_SellChance_Add" %>
...
<head runat="server">
    ...
    <script src="../../../js/office/SellManager/SellChance_Add.js" type="text/javascript"></script>
...
<body>
    ...
    <div id="treeDiv1"  style="display:none;width:300px;margin:0;height:400px;overflow:auto;background:#f1f1f1;border:solid 1px #999999;"></div>
    <div id="popupContent">
    </div>
                ...
                <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                    ...
                    <tr>
                        ...
                        <td height="20" bgcolor="#FFFFFF" style="width: 22%;">
                            <uc3:CodingRuleControl ID="SellChanceUC" runat="server" />
                        </td>
                        <td height="20" align="right" bgcolor="#E6E6E6" style="width: 11%;">
                            机会主题
                        </td>
                        <td height="20" bgcolor="#FFFFFF" style="width: 22%;">
                            <input id="Title"  specialworkcheck="机会主题"  type="text" class="tdinput" style="width: 99%;" maxlength="50" />
                        </td>
                        <td height="20" align="right" bgcolor="#E6E6E6" style="width: 11%;">
                            机会类型
                        </td>
                    ...
                    <tr>
                        ...
                        <td height="20" bgcolor="#FFFFFF">
                            <input id="CustTel" class="tdinput" type="text" style="width: 99%" maxlength="50" />
                        </td>
                        <td height="20" align="right" bgcolor="#E6E6E6">
                            客户类型
                        </td>
                    ...
                    <tr>
                        ...
                        <td height="20" align="left" bgcolor="#FFFFFF">
                            <input id="UserSeller" class="tdinput" onclick="alertdiv('UserSeller,hiddSeller');"
                                readonly="readonly" style="width: 99%" type="text"  runat="server"/>
                        </td>
                    </tr>
                    <tr>
                        <td height="20" align="right" bgcolor="#E6E6E6">
                        ...
                        <td height="20" align="left" bgcolor="#FFFFFF">
                            <input id="ProvideMan" specialworkcheck="提供人"  class="tdinput" type="text" maxlength="25" style="width: 99%" />
                        </td>
                        <td height="20" align="right" bgcolor="#E6E6E6">
                    ...
                    <tr>
                        ...
                        <td height="20" align="left" bgcolor="#FFFFFF" colspan="5" style="width: 89%">
                            <textarea id="Requires" specialworkcheck="需求描述"   rows="3" cols="100" style="width: 95%"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td height="20" align="right" bgcolor="#E6E6E6" style="width: 10%">
                            可查看该机会人员</td>
                        <td height="20" align="left" bgcolor="#FFFFFF" colspan="5" style="width: 89%">
                            <textarea id="CanViewUserName"   readonly="readonly"  onclick="treeview1.show()"   rows="3" cols="100" style="width: 95%"></textarea>
                ...
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999"
                    ...
                    <tr>
                        ...
                        <td height="20" align="left" bgcolor="#FFFFFF" style="width: 22%;">
                            <input id="IntendMoney" onchange="Number_round(this,<%=SelPoint %>)"  class="tdinput" type="text" style="width: 99%" maxlength="8"
                                value="" />
                        </td>
                        <td height="20" align="right" bgcolor="#E6E6E6" style="width: 11%;">
            ...
            <td colspan="2">
                ...
                <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                    ...
                    <tr>
                        ...
                        <td height="20" align="left" bgcolor="#FFFFFF" colspan="5" style="width: 89%;">
                            <textarea  specialworkcheck="销售机会推进备注"   id="Remark1" rows="3" cols="100" style="width: 95%"></textarea>
                        </td>
                    </tr>
                </table>
            </td>
