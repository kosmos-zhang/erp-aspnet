<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SellChannelSttlAdd.aspx.cs"
    Inherits="Pages_Office_SellManager_SellChannelSttlAdd" %>
...
<head runat="server">
    ...
    <script src="../../../js/office/SellManager/SellChannelSttlAdd.js" type="text/javascript"></script>
...
<body onload="formatNumLen()">
    ...
    var FlowJs_BillNo ='SellChannelSttlUC_txtCode';          //当前单据编码名称
            ...
            <td colspan="2" valign="top">
                ...
                <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                    ...
                    <tr>
                        ...
                        <td bgcolor="#FFFFFF" style="width: 23%;">
                            <uc3:CodingRuleControl ID="SellChannelSttlUC" runat="server" />
                        </td>
                        <td align="right" bgcolor="#E6E6E6" style="width: 10%;">
                            主题
                        </td>
                ...
                <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                    ...
                    <tr>
                        ...
                        <td height="20" bgcolor="#FFFFFF">
                            <input id="PushMoneyPercent" onchange="Number_round(this,<%=SelPoint %>)" value="100.00" onblur="fnCheckPer(this)"
                                style="width: 95%;" class="tdinput" type="text" maxlength="7" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td height="20" bgcolor="#FFFFFF" style="width: 22%;">
                            <input id="HandFeeTotal" onchange="Number_round(this,<%=SelPoint %>)" onblur="fnCheck(this,'手续费合计')"
