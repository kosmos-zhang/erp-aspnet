<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SellContractAdd.aspx.cs"
    Inherits="Pages_Office_SellManager_SellContractAdd" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../../js/office/SellManager/SellContractAdd.js" type="text/javascript"></script>
...
<body onload="formatNumLen()">
    ...
    <uc11:StorageSnapshot ID="StorageSnapshot1" runat="server" /><!--库存快照-->
                        ...
                        <tr>
                            ...
                            <td height="20" align="left" bgcolor="#FFFFFF">
                                <input id="UserSeller" class="tdinput" onclick="fnSelectSeller()" style="width: 95%;"
                                    readonly="readonly" type="text" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td height="20" align="right" bgcolor="#E6E6E6">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
                                    <tr>
                                        <td height="28" bgcolor="#FFFFFF" colspan="11" style="padding-top: 5px; padding-left: 5px;">
                                            ...
                                            <img runat="server" src="../../../Images/Button/btn_tmsm.jpg" alt="条码扫描" style="cursor: hand;"
                                                 id="GetGoods" onclick="GetGoodsInfoByBarCode()"  visible="false"  />
