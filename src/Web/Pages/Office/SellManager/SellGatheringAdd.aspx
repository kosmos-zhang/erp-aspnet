<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SellGatheringAdd.aspx.cs"
    Inherits="Pages_Office_SellManager_SellGatheringAdd" %>
...
<head runat="server">
    ...
    <script src="../../../js/office/SellManager/SellGatheringAdd.js" type="text/javascript">       
                        ...
                        <tr>
                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    onclick="InsertSellOfferData();" runat="server" visible="false" />
                    ...
                    <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                        ...
                        <tr>
                            ...
                            <td bgcolor="#FFFFFF" style=" width:23%">
                                <uc3:CodingRuleControl ID="SellGathering" runat="server" />
                            </td>
                            <td align="right" bgcolor="#E6E6E6" style=" width:10%">
                                主题
                            </td>
                            <td bgcolor="#FFFFFF" style=" width:23%">
                                <input id="Title" type="text" style="width: 95%"  specialworkcheck="主题"  class="tdinput" maxlength="50" />
                            </td>
                            <td align="right" bgcolor="#E6E6E6" style=" width:10%">
                        ...
                        <tr>
                            ...
                            <td height="20" bgcolor="#FFFFFF">
                                <input id="CustID" class="tdinput" type="text" readonly="readonly" style="
                                    width: 95%" onclick="fnSelectCustInfo()" />
                            </td>
                            <td height="20" align="right" bgcolor="#E6E6E6">
                                客户类型
                            </td>
                        ...
                        <tr>
                            ...
                            <td height="20" align="left" bgcolor="#FFFFFF">
                                <input id="CustTel" class="tdinput" specialworkcheck="客户电话" disabled="disabled"  type="text" style="width: 95%" maxlength="100" />
                            </td>
                            <td height="20" align="right" bgcolor="#E6E6E6">
                        ...
                        <tr>
                            ...
                            <td height="20" align="left" bgcolor="#FFFFFF">
                                <input id="DeptId" class="tdinput" onclick="fnSelectDept()" readonly="readonly" 
                            ...
                            <td height="20" align="left" bgcolor="#FFFFFF">
                                <input id="PlanGatherDate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',el:$dp.$('PlanGatherDate')})"
                                    style="width: 95%" class="tdinput" type="text"
                                    readonly="readonly" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td height="20" align="left" bgcolor="#FFFFFF">
                                <input id="LinkBillNo" class="tdinput"  specialworkcheck="回款相关单号"  type="text" style="width: 95%" maxlength="100" />
                            </td>
                        </tr>
                        <tr>
                            <td height="20" align="right" bgcolor="#E6E6E6">
                    ...
                    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999"
                        ...
                        <tr>
                            ...
                            <td height="20" align="left" bgcolor="#FFFFFF" style=" width:22%">
                                <asp:TextBox ID="CreateDate" runat="server" Width="120px" CssClass="tdinput" 
                        ...
                        <tr>
                            ...
                            <td height="20" colspan="3" align="left" bgcolor="#FFFFFF">
                                <input id="Remark" class="tdinput"  specialworkcheck="备注"   type="text" style="width: 99%" maxlength="400" />
                            </td>
                        </tr>
                    </table>
