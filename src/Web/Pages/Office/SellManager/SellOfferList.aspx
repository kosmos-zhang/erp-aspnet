<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SellOfferList.aspx.cs" Inherits="Pages_Office_SellManager_SellOfferList" %>
...
<head>
    ...
    <script src="../../../js/office/SellManager/SellOfferList.js" type="text/javascript"></script>
                            ...
                            <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC"
                                ...
                                <tr class="table-item">
                                    ...
                                    <td width="20%" bgcolor="#FFFFFF">
                                        <input type="text" class="tdinput" specialworkcheck="报价单号"  style="width: 99%;" id="OfferNo" />
                                    ...
                                    <td width="20%" bgcolor="#FFFFFF">
                                        <input style="width: 99%;" specialworkcheck="报价单主题" id="Title" type="text" class="tdinput"
                                            size="15" />
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                <div class="orderClick" onclick="OrderBy('OfferNo','oGroup');return false;">
                                    报价单号<span id="oGroup" class="orderTip"></span></div>
                            </th>
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                <div class="orderClick" onclick="OrderBy('Title','oC1');return false;">
                                    报价单主题<span id="oC1" class="orderTip"></span></div>
                            </th>
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                            ...
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                <div class="orderClick" onclick="OrderBy('ChanceNo','oC3');return false;">
                                    销售机会<span id="oC3" class="orderTip"></span></div>
                            </th>
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                            ...
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                <div class="orderClick" onclick="OrderBy('OfferDate','oC5');return false;">
                                    报价日期<span id="oC5" class="orderTip"></span></div>
                            </th>
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                <div class="orderClick" onclick="OrderBy('QuoteTime','oC6');return false;">
                                    报价次数<span id="oC6" class="orderTip"></span></div>
                            </th>
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                                <div class="orderClick" onclick="OrderBy('TotalFee','oC7');return false;">
                                    金额<span id="oC7" class="orderTip"></span></div>
                            </th>
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
