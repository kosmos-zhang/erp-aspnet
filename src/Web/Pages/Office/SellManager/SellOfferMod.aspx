<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SellOfferMod.aspx.cs" Inherits="Pages_Office_SellManager_SellOfferMod" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../../js/office/SellManager/SellOfferMod.js" type="text/javascript"></script>
...
<body onload="formatNumLen()">
                    ...
                    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
                        <tr>
                            ...
                            <table width="100%">
                                ...
                                <img runat="server" visible="false" alt="再次报价" src="../../../Images/Button/Button_zcbj.jpg"
                                    id="btnZCBJ" onclick="fnOfferAgain()" />
                                <img runat="server" visible="false" alt="再次报价" src="../../../Images/Button/Button_Uzcbj.jpg"
                                    id="btnUnZCBJ" style="display: none" />
                                <img src="../../../Images/Button/Bottom_btn_back.jpg" style="display: inline; cursor: hand"
            ...
            <tr>
                <td colspan="2" valign="top">
                    ...
                    <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                        ...
                        <tr>
                            ...
                            <td bgcolor="#FFFFFF" style="width: 23%;">
                                <input type="text" class="tdinput" readonly="readonly" disabled="disabled" style="width: 90%"
                                    id="OfferNo" />
                            </td>
                            <td align="right" bgcolor="#E6E6E6" style="width: 10%;">
                                主题
                            ...
                            <td bgcolor="#FFFFFF" style="width: 23%;">
                                <input id="Title" type="text" specialworkcheck="主题" style="width: 90%;" class="tdinput" />
                            </td>
                            <td align="right" bgcolor="#E6E6E6" style="width: 10%;">
                                源单类型
                            </td>
                        ...
                        <tr>
                            ...
                            <td height="20" align="left" bgcolor="#FFFFFF">
                                <input id="QuoteTime" class="tdinput" name="QuoteTime" disabled="disabled" type="text"
                                    value="1" />
                            </td>
                            <td height="20" align="right" bgcolor="#E6E6E6">
                                是否增值税
                            ...
                            <td height="20" bgcolor="#F4F0ED" class="Blue" colspan="2">
                                <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                    <tr>
                                        ...
                                        <td align="right">
                                            <div id='searchClick3'>
                                                <img src="../../../images/Main/close.jpg" style="cursor: pointer" onclick="oprItem('Table3','searchClick3')" /></div>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td height="20" bgcolor="#F4F0ED" class="Blue" colspan="2">
                                <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                    <tr>
                                        <td>
                                            <span class="Blue">报价记录</span>
                                        </td>
                                        <td align="right">
                                            <div id='Div1'>
                                                <img src="../../../images/Main/close.jpg" style="cursor: pointer" onclick="oprItem('Table4','Div1')" /></div>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                    ...
                    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#999999"
                        ...
                        <tr>
                            <td>
                                <table width="100%" border="0" id="SellOfferHisReTB" style="behavior: url(../../../draggrid.htc)"
    ...
    <div id="divSellOfferHistory" style="border: solid 10px #93BCDD; background: #fff;
        padding: 10px; width: 700px; z-index: 1001; position: absolute; display: none;
        top: 60%; left: 60%; margin: 5px 0 0 -400px;">
        <table width="100%">
            <tr>
                <td>
                    <a onclick="document.getElementById('divSellOfferHistory').style.display='none';"
                        style="text-align: right; cursor: pointer">关闭</a>
                </td>
            </tr>
        </table>
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" id="hisList"
            bgcolor="#999999">
            <tbody>
                <tr>
                    <td align="center" bgcolor="#E6E6E6" class="ListTitle">
