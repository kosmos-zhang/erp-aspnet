<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SellOrderMod.aspx.cs" Inherits="Pages_Office_SellManager_SellOrderMod" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../../js/office/SellManager/SellOrderMod.js" type="text/javascript"></script>
...
<body onload="formatNumLen()">
    ...
    <input type="hidden" id="hiddStatus" value="1" />
    ...
    var FlowJs_BillNo ='OfferNo';          //当前单据编码名称
     var FlowJS_FromSellDetail = 'hiddStatus';
                    ...
                    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
                        <tr>
                            ...
                            <table width="100%">
                                ...
                                <img  runat="server" visible="false" alt="终止订单" id="btn_zzht" src="../../../Images/Button/btn_zzdd.jpg" onclick="fnEndOrder();"
                                    style="cursor: hand" />
                                    <img runat="server" visible="false"  id="btn_Unzzht" alt="终止订单" src="../../../Images/Button/btn_uzzdd.jpg"
                                        style="display: none" />
                ...
                <td colspan="2" valign="top">
                        ...
                        <tr>
                            ...
                            <td height="20" bgcolor="#FFFFFF">
                                <input id="Discount" onchange="Number_round(this,<%=SelPoint %>)"  value="100.00" onblur="fnCheckPer(this)" style="width: 95%;"
                                    class="tdinput" type="text" maxlength="8" />
                            </td>
                            <td height="20" align="right" bgcolor="#E6E6E6">
                                折后含税金额
                            </td>
                    ...
                    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999"
                        ...
                        <tr>
                            ...
                            <td height="20" align="left" bgcolor="#FFFFFF">
                                <input id="huikuan" readonly="readonly" style="width: 95%;" class="tdinput" type="text" />
                            </td>
                        </tr>
                        <tr>
                            <td height="28" align="right" bgcolor="#E6E6E6" style="width: 11%">
                                    ...
                                    <tr>
                                        <td height="28" bgcolor="#FFFFFF" colspan="11" style="padding-top: 5px; padding-left: 5px;">
                                            ...
                                            <img runat="server" visible="false"   alt="删除" src="../../../images/Button/Show_del.jpg" id="imgDel" style="cursor: hand"
                                                onclick="fnDelOneRow()" />
                                            <img runat="server" visible="false"   alt="" src="../../../Images/Button/UnClick_tj.jpg" style="display: none;" id="imgUnAdd" /><img
                                                runat="server" visible="false"   alt="" src="../../../Images/Button/UnClick_del.jpg" style="display: none;" id="imgUnDel" />
                                            <img id="btnSubSnapshot" src="../../../images/Button/btn_kckz.jpg" style="cursor: hand"
                                                onclick="ShowSnapshot();" alt="库存快照" />
                                            <img  runat="server"  visible="false"  src="../../../Images/Button/btn_tmsm.jpg" alt="条码扫描" style="cursor: pointer;" id="GetGoods" onclick="GetGoodsInfoByBarCode()"/>
                        ...
                        <tr>
                            <td>
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
                                    <tr>
                                        <td height="28" bgcolor="#FFFFFF" colspan="11" style="padding-top: 5px; padding-left: 5px;">
                                            <img  runat="server" visible="false"   src="../../../images/Button/Show_add.jpg" style="cursor: hand" id="AddFee" onclick="fnAddFeeRow();" />
                                            <img  runat="server" visible="false"   src="../../../images/Button/Show_del.jpg" style="cursor: hand" id="DelFee" onclick="fnDelOneRow2();" />
                                            <img  runat="server" visible="false"   alt="" src="../../../Images/Button/UnClick_tj.jpg" style="display: none;" id="UnAddFee" /><img
                                               runat="server" visible="false"    alt="" src="../../../Images/Button/UnClick_del.jpg" style="display: none;" id="UnDelFee" />
                                        </td>
                                    </tr>
                                </table>
