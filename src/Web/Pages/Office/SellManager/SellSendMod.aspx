<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SellSendMod.aspx.cs" Inherits="Pages_Office_SellManager_SellSendMod" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../../js/office/SellManager/SellSendMod.js" type="text/javascript"></script>
...
<body onload="formatNumLen()">
    ...
    <input type="hidden" id="hiddIsOpenbill" runat="server" value="0" /><!--是否已开票：1已开票，0未开票-->
    ...
    <table style="width: 95%;" border="0" cellpadding="0" cellspacing="0" class="maintable"
                                ...
                                <tr>
                                    <td height="28" bgcolor="#FFFFFF" style="padding-top: 5px; padding-left: 5px;">
                                         <img runat="server" visible="false" src="../../../images/Button/Bottom_btn_save.jpg"
                                            alt="保存" id="btn_save" style="cursor: hand" onclick="fnCheckProCount('update');" />&nbsp;
        ...
        <tr>
            <td colspan="2" valign="top">
                ...
                <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                    ...
                    <tr>
                        ...
                        <td bgcolor="#FFFFFF" style="width: 23%;">
                            <input type="text" class="tdinput" disabled="disabled" readonly="readonly" style="width: 90%;"
                                id="OfferNo" />
                        </td>
                        <td align="right" bgcolor="#E6E6E6" style="width: 10%;">
                            主题
                    ...
                    <tr>
                        ...
                        <td height="20" align="left" bgcolor="#FFFFFF">
                            <select style="width: 120px;margin-top:2px;margin-left:2px;" style="width: 120px;" id="BusiType">
                    ...
                    <tr>
                        ...
                        <td align="left" bgcolor="#FFFFFF">
                            <input id="isRef" class="tdinput" disabled="disabled" type="text" value="" />
                        </td>
                    </tr>
                </table>
                    <!-- 扩展属性-->
                ...
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#999999" style=" overflow:hidden;"
                    id="Table2">
                    <tr>
                        <td>
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
                                <tr>
                                    <td height="28" bgcolor="#FFFFFF"  style="padding-top: 5px; padding-left: 5px;">
                                        ...
                                        <img runat="server" visible="false" alt="删除" src="../../../Images/Button/UnClick_del.jpg"
                              ...
                              <div style="border:none; width:200%">
                                <table width="100%" border="0" id="dg_Log" style="behavior: url(../../../draggrid.htc);
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" id="BaseUnitD" runat="server" bgcolor="#E6E6E6" style="width: 3%" class="ListTitle">
                                            基本单位
                                        </td>
                                        <td align="center" id="BaseCountD" runat="server" bgcolor="#E6E6E6" style="width: 4%" class="ListTitle">
                                            基本数量
                                        </td>
                                        <td align="center" bgcolor="#E6E6E6" style="width: 3%" class="ListTitle">
                                            单位
                                        ...
                                        <td align="center" bgcolor="#E6E6E6" style="width: 2%" class="ListTitle">
                                            源单行号
                                        </td>
                                        <td align="center" bgcolor="#E6E6E6" style="width: 3%" class="ListTitle">
                                            已退货数量
