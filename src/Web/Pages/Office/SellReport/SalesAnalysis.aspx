<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalesAnalysis.aspx.cs" Inherits="Pages_Office_SellReport_SalesAnalysis" %>
...
<head>
    ...
    <script src="../../../js/office/SellReport/SalesAnalysis.js" type="text/javascript"></script>
                ...
                <table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                    ...
                    <tr>
                        ...
                        <td height="20" class="tdColInput" width="24%">
                         ...
                         <option value="byWeek">周</option>
                         <option value="byMonth">月</option>
                         <option value="byYear">年</option>
                         </select>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="6" align="center" bgcolor="#FFFFFF">
                            <img alt="检索" src="../../../images/Button/Bottom_btn_search.jpg" style="cursor: pointer;"
                                onclick="SearchData();" id="imgSearch" runat="server" visible="false" />
                        </td>
                    </tr>
                </table>
            </td>
                    ...
                    <tbody>
                        <tr>
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF" id="thByDept">
                                <div class="orderClick" onclick="CreateSort('CreateWeek');return false;">
                                    周<span id="CreateWeek" class="orderTip"></span></div>
                            </th>
                              <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF" id="thBySeller" style=" display:none ">
                                <div class="orderClick" onclick="CreateSort('CreateMonth');return false;">
                                    月<span id="CreateMonth" class="orderTip"></span></div>
                            </th>
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF" id="thByProduct" style="display:none">
                                <div class="orderClick" onclick="CreateSort('CreateYear');return false;">
                                    年<span id="Product" class="orderTip"></span></div>
                            </th>
