<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StorageFromExcel.aspx.cs" Inherits="Pages_Office_StorageManager_StorageFromExcel" %>
                            ...
                            <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC" class="table">
                                ...
                                <tr class="table-item">
                                    ...
                                    <td colspan="3" style="width:88%; height:30px; background-color:#FFFFFF; padding-left:5px" align="left">
                                        <asp:LinkButton ID="setup1" Enabled="false" OnClick="setup1_Click" runat="server">是否存在校验</asp:LinkButton>---->
                                        <asp:LinkButton ID="setup2" Enabled="false" OnClick="setup2_Click" runat="server">Excel空值校验</asp:LinkButton>---->
                                        <asp:LinkButton ID="setup3" Enabled="false" OnClick="setup3_Click" runat="server">数据格式校验</asp:LinkButton>---->
                                        <asp:LinkButton ID="setup4" Enabled="false" OnClick="setup4_Click" runat="server">记录重复校验</asp:LinkButton>
                            ...
                            <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC"
                                ...
                                <tr class="table-item">
                                    <td colspan="4" width="100%" height="30" bgcolor="#E7E7E7" align="center">
                                        <asp:Button ID="btn_input" Enabled ="false" OnClick="btn_input_Click" runat="server" Text="批量导入" />
                                    </td>
                                </tr>
                            </table>
                        </td>
