<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StorageInProcessAdd.aspx.cs"
    Inherits="Pages_Office_StorageManager_StorageInProcessAdd" %>
...
<%@ Register Src="../../../UserControl/ProductInfoControl.ascx" TagName="ProductInfoControl"
    TagPrefix="uc3" %>
<%@ Register Src="../../../UserControl/ManufactureTaskUC.ascx" TagName="ManufactureTaskUC"
    TagPrefix="uc5" %>
...
<body>
    ...
    <uc5:ManufactureTaskUC ID="ManufactureTaskUC1" runat="server" />
                                ...
                                <tr>
                                    <td>
                                        <img src="../../../images/Button/Bottom_btn_save.jpg" alt="保存" id="btn_save" runat="server"
                                            style="cursor: hand" border="0" onclick="Fun_Save_StorageInProcess();" visible="false" />
                    ...
                    <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                        ...
                        <tr>
                            <td height="20" align="right" bgcolor="#E6E6E6">
                                生产任务单<span class="redbold">*</span>
                            </td>
                            <td height="20" bgcolor="#FFFFFF">
                                <input name="txtFromBillID" id="txtFromBillID" class="tdinput" type="text" size="15"
                                    readonly="readonly" onclick="fnSelectMTInfo()" style="width: 95%" />
                            </td>
                            <td height="20" align="right" bgcolor="#E6E6E6">
                                源单类型
                            </td>
                            <td height="20" bgcolor="#FFFFFF">
                                <asp:DropDownList ID="ddlFromType" runat="server">
                                    <asp:ListItem Value="1" Text="生产任务单"></asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td height="20" align="right" bgcolor="#E6E6E6">
                                加工类别
                            ...
                            <td height="20" bgcolor="#FFFFFF">
                                &nbsp;<asp:DropDownList ID="ddlProcessType" runat="server" Enabled="false">
                                    <asp:ListItem Value="0" Text="普通"></asp:ListItem>
                                    <asp:ListItem Value="1" Text="返修"></asp:ListItem>
                                    <asp:ListItem Value="2" Text="拆件"></asp:ListItem>
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td height="20" bgcolor="#FFFFFF">
                                &nbsp;<input name="txtProcessDept" id="txtProcessDept" class="tdinput" type="text" size="15"
                            ...
                            <td height="20" bgcolor="#FFFFFF">
                                ...
                                <input name="txtProcessor" id="txtProcessor" class="tdinput" type="text" size="15"
                    ...
                    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999"
                        ...
                        <tr>
                            ...
                            <td bgcolor="#FFFFFF" width="24%">
                                ...
                                <select name="sltBillStatus" class="tdinput" id="sltBillStatus" disabled="disabled">
                        ...
                        <tr>
                            <td height="28" bgcolor="#FFFFFF">
                                <%--<img src="../../../images/Button/Show_add.jpg" width="34" height="24" style="cursor: hand"
                                    onclick="AddRow();" />&nbsp;--%>
                                <img src="../../../images/Button/Show_del.jpg" id="btnDele" runat="server" style="cursor: pointer"
                                    visible="false" onclick="DeleteSignRow();" />
...
<input name='hidZero' type='hidden' id='hidZero' runat="server" />
    ...
    <script src="../../../js/office/StorageManager/StorageInProcessAdd.js" type="text/javascript"></script>
