<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StorageInPurchaseAdd.aspx.cs"
    Inherits="Pages_Office_StorageManager_StorageInPurchaseAdd" %>

<%@ Register Src="../../../UserControl/CodingRuleControl.ascx" TagName="CodingRuleControl"
    TagPrefix="uc2" %>
<%@ Register Src="../../../UserControl/Message.ascx" TagName="Message" TagPrefix="uc1" %>
<%@ Register Src="../../../UserControl/PurchaseArriveUC.ascx" TagName="PurchaseArriveUC"
    TagPrefix="uc5" %>
...
<body>
    ...
    <uc6:ProviderInfo ID="ProviderInfo1" runat="server" />
    <uc1:Message ID="Message1" runat="server" />
    <uc3:StorageSnapshot ID="StorageSnapshot1" runat="server" />
    <uc5:PurchaseArriveUC ID="PurchaseArriveUC1" runat="server" />
        ...
        <tr style="width: 100%">
            <td height="30" colspan="2" valign="top" class="Title">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="t_Add" style="display: none">
                    <tr>
                        <td height="30" align="center" class="Title" width="100%">
                            新建采购入库单
                        </td>
                    </tr>
                </table>
                                ...
                                <tr>
                                    <td>
                                        <img src="../../../images/Button/Bottom_btn_save.jpg" alt="保存" id="btn_save" runat="server"
                                            style="cursor: hand" border="0" onclick="Fun_Save_StorageInPurchase();" visible="false" />
                ...
                <div style="overflow-y: auto;">
                    ...
                    <table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                        ...
                        <tr>
                            <td height="20" align="right" bgcolor="#E6E6E6">
                                采购到货单<span class="redbold">*</span>
                            </td>
                            <td height="20" bgcolor="#FFFFFF">
                                <input name="txtFromBillID" id="txtFromBillID" class="tdinput" type="text" size="15"
                                    readonly="readonly" onclick="fnSelectPAInfo()" style="width: 95%" />
                            </td>
                            <td height="20" align="right" bgcolor="#E6E6E6">
                            ...
                            <td height="20" bgcolor="#FFFFFF">
                                &nbsp;<asp:DropDownList ID="ddlFromType" runat="server">
                                    <asp:ListItem Value="1" Text="采购到货单"></asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td height="20" align="right" bgcolor="#E6E6E6">
                                供应商
                            ...
                            <td height="20" bgcolor="#FFFFFF">
                                &nbsp;<input name="txtProvider" id="txtProvider" class="tdinput" type="text" size="15"
                                    disabled="disabled" style="width: 95%" /></td>
                        </tr>
                        <tr>
                            <td height="20" align="right" bgcolor="#E6E6E6">
                                采购员
                            ...
                            <td height="20" bgcolor="#FFFFFF">
                                &nbsp;<input name="txtBuyer" id="txtBuyer" class="tdinput" type="text" size="15" disabled="disabled"
                                    style="width: 95%" /></td>
                            <td height="20" align="right" bgcolor="#E6E6E6">
                                采购部门
                            </td>
                            <td height="20" bgcolor="#FFFFFF">
                                ...
                                <input name="txtDep" id="txtDep" class="tdinput" type="text" size="15" disabled="disabled"
                                    style="width: 95%" /></td>
                            <td height="20" align="right" bgcolor="#E6E6E6">
                                交货人
                            </td>
                        ...
                        <tr>
                            ...
                            <td height="20" bgcolor="#FFFFFF">
                                <input name="UserAccepter" id="UserAccepter" type="text" class="tdinput" size="19"
                                    readonly="readonly" onclick="alertdiv('UserAccepter,txtAccepterID');" style="width: 95%" />
                                <input name="txtAccepterID" id="txtAccepterID" type="hidden" />
                            </td>
                            <td height="20" align="right" bgcolor="#E6E6E6">
                                入库部门</td>
                            <td height="20" bgcolor="#FFFFFF">
                            ...
                            <td bgcolor="#FFFFFF">
                                <input name="UserExecutor" id="UserExecutor" type="text" class="tdinput" size="19"
                                    ...
                                    style="width: 95%" />
                                <input name="txtExecutorID" id="txtExecutorID" type="hidden" runat="server" /></td>
                        </tr>
                        <tr>
                            <td align="right" bgcolor="#E6E6E6">
                        ...
                        <tr>
                            ...
                            <td bgcolor="#FFFFFF" width="23%">
                                <input name="txtTotalPrice" id="txtTotalPrice" value="0.00" type="text" class="tdinput"
                                    size="15" disabled="disabled" style="width: 95%; display: <%=GetIsDisplayPrice()%>" />
                            </td>
                            <td align="right" bgcolor="#E6E6E6" width="10%">
                            </td>
                            <td bgcolor="#FFFFFF" width="24%">
                    ...
                    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999"
                        ...
                        <tr>
                            ...
                            <td colspan="5" bgcolor="#FFFFFF">
                                <textarea name="txtRemark" id="txtRemark" rows="2" cols="2" style="width: 100%; height: 62px;"
                                    class="tdinput" maxlength="50"></textarea>
                            </td>
                        </tr>
                    </table>
                    <table width="99%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <table width="99%" border="0" id="dg_Log" style="behavior: url(../../../draggrid.htc)"
                        ...
                        <tr>
                            ...
                            <td align="center" bgcolor="#E6E6E6" class="ListTitle">
                                <div id="divSpan" runat="server" >基本数量</div><div id="divRedSpan" runat="server" style="display:none;">实收数量<span class="redbold">*</span></div>
                            </td>
                            <td align="center" bgcolor="#E6E6E6" class="ListTitle" id="tdShuLiang" runat="server">
                                实收数量<span class="redbold">*</span>
                            </td>
...
<script src="../../../js/office/StorageManager/StorageInPurchaseAdd.js" type="text/javascript"></script>
