<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StorageTransferIn.aspx.cs" Inherits="Pages_Office_StorageManager_StorageTransferIn" %>
...
<%@ Register Src="../../../UserControl/CodingRuleControl.ascx" TagName="CodingRuleControl"
    TagPrefix="uc6" %>
<%@ Register src="../../../UserControl/StorageTransferProduct.ascx" tagname="StorageTransferProduct" tagprefix="uc7" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../../js/office/StorageManager/StorageTransferIn.js" type="text/javascript"></script>
                ...
                <table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999">
                    <tr>
                        <td height="30" class="tdColInput" style="width: 100%">
                         <span  id="img_btn_ConfirmIN" runat="server" visible="false">
                            <img src="../../../Images/Button/Bottom_btn_confirm.jpg"  alt="确认"  onclick="Save();"  style="cursor:pointer; float:left" id="imgConfirm"/>
                            <img src="../../../Images/Button/UnClick_qr.jpg"   alt="确认"  id="imgUnConfirm" style="float:left; display:none;"/></span>
                            ...
                            <img src="../../../Images/Button/Main_btn_print.jpg"
                                    alt="打印" style="cursor: pointer; float:right; display:none;" id="imgPrint" />
                        </td>
                    </tr>
                </table>
            </td>
                            ...
                            <table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                                ...
                                <tr>
                                    ...
                                    <td height="20" class="tdColInput" width="24%">
                                        <input type="text" id="UserApplyUser"   disabled="true" class="tdinput tboxsize" />
                                ...
                                <tr>
                                    ...
                                    <td height="20" class="tdColInput">
                                        <input type="text" id="DeptOutDeptID" class="tdinput tboxsize" 
                                            disabled="true" />
                                ...
                                <tr>
                                    ...
                                    <td height="20" class="tdColInput">
                                        <input id="UsertxtOutUserID" type="text" class="tdinput tboxsize" disabled="true"  />
                                    ...
                                    <td height="20" class="tdColInput">
                                   <input id="txtOutDate" type="text" class="tdinput tboxsize" disabled="true"  />
                                    </td>
                                </tr>
 <tr>
                                    <td height="20" align="right" class="tdColTitle">
                                    ...
                                    <td height="20" class="tdColInput">
                                            <input id="UsertxtInUser" type="text" class="tdinput tboxsize" readonly onclick="alertdiv('UsertxtInUser,txtInUserID')" />
                                        <input id="txtInUserID"  type="hidden" />
                                    </td>
                                    <td height="20" align="right" class="tdColTitle">
                                       入库日期<span class="redbold">*</span>
                                    </td>
                                    <td height="20" class="tdColInput">
                                        <input id="txtInDate" type="text" class="tdinput tboxsize" readonly onclick="WdatePicker({dateFmt:'yyyy-MM-dd',el:$dp.$('txtInDate')})" />
                                ...
                                <tr>
                                    ...
                                    <td height="20" class="tdColInput" colspan="5">
                                        <asp:TextBox ID="tboxSummary" runat="server" MaxLength="250" TextMode="MultiLine" Enabled="false"
                            ...
                            <table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#999999"
                                ...
                                <tr>
                                    ...
                                    <td height="20" class="style1">
                                        <input id="txtOutCount" type="text" disabled="true" class="tdinput tboxsize" runat="server" />
                                    </td>
                                    <td height="20" align="right" class="tdColTitle" width="10%">
                                        出库金额合计
                                    </td>
                                    <td height="20" class="tdColInput" width="23%">
                                        <input id="txtOutFeeSum" type="text" disabled="true" class="tdinput tboxsize" />
                                    </td>
                                    <td height="20" align="right" class="tdColTitle" width="10%">
                                  ...
                                  <td height="20" align="right" class="tdColTitle" width="10%">
                                    ...
                                    <td height="20" class="style1">
                                    <input id="txtInCount" type="text" readonly class="tdinput tboxsize" runat="server"   disabled="true"/>
                                    </td>
                                    <td height="20" align="right" class="tdColTitle" width="10%">
                                         入库金额合计
                                    </td>
                                    <td height="20" class="tdColInput" width="23%">
                                         <input id="txtInFeeSum" type="text" readonly class="tdinput tboxsize" runat="server"  disabled="true" />
                                    </td>
                                    <td height="20" align="right" class="tdColTitle" width="10%">
