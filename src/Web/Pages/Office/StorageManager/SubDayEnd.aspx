<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubDayEnd.aspx.cs" Inherits="Pages_Office_StorageManager_SubDayEnd" %>
...
<head>
    ...
    <script src="../../../js/office/StorageManager/SubDayEnd.js" type="text/javascript"></script>
...
<body>
                                ...
                                <tr>
                                    ...
                                    <input type="hidden" id="hfTitle" name="hfTitle" />
                                        <img id="btnQuery" alt="检索" src="../../../images/Button/Bottom_btn_search.jpg" style='cursor: hand;'
                                            onclick='SearchRecord()'  runat="server"    /> 
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
                    <tr>
                        <td height="28" bgcolor="#FFFFFF"> 
                            ...
                            <img src="../../../Images/Button/btn_rj.jpg"  onclick="OperateRecord()" runat="server"   id="imgAlt"  /> 
                        ...
                        <tr>
                          <%--  <th height="20" align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF">
                            ...
                            <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF"><div class="orderClick" onclick="OrderBy('BatchNo','oProviderName');return false;">
                                ...
                                <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF"><div class="orderClick" onclick="OrderBy('DeptName','oDeptName');return false;">
                               门店<span id="oDeptName" class="orderTip"></span></div></th>
    ...
    <asp:HiddenField  runat="server" ID="hidOrderby"/>
    <asp:HiddenField  runat="server" ID="hidPageCount"/>
