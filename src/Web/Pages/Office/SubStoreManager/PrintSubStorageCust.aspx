<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintSubStorageCust.aspx.cs"
    Inherits="Pages_Office_SubStoreManager_PrintSubStorageCust" ValidateRequest="false" %>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <input type="checkbox" name="ck1CustMobile" id="ck1CustMobile" value="CustMobile" /><input
                                                                type="text" id="txtCustMobile" value="客户手机号码：" size="20" readonly />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="28%" align="left">
...
<script language="javascript">
    var intCustID = <%=intCustID %>;
    printSetObj.BillTypeFlag = '<%=XBase.Common.ConstUtil.BILL_TYPEFLAG_SUBSTORAGE %>';
    printSetObj.PrintTypeFlag = '<%=XBase.Common.ConstUtil.PRINTBILL_TYPEFLAG_SUBSTORAGECUST %>';
    /*跳转页面*/
    printSetObj.ToLocation ='PrintSubStorageCust.aspx?ID=' + intCustID;
    /*表名称*/
    printSetObj.TableName = 'officedba.'+'SubSellCustInfo';
    /*取基本信息及明细信息的字段*/
    printSetObj.ArrayDB = new Array(    
                                        [   
                                            'CustName','CustTel','CustMobile','CustAddr'
                                        ]
                                    );
