<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubStorageInitImport.aspx.cs"
    Inherits="Pages_Office_SubStoreManager_SubStorageInitImport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>分店库存期初导入</title>
    ...
    <table width="95%" height="57" border="0" cellpadding="0" cellspacing="0" class="checktable"
        ...
        <tr>
            <td colspan="2">
                ...
                <table width="99%" border="0" align="center" cellpadding="0" id="searchtable" cellspacing="0"
                    ...
                    <tr style="height: 35px">
                        <td valign="bottom" class="Blue" style="background-color: #F0F0F0; padding-left: 1px">
                            <img src="../../../images/Main/arrow_1.jpg" width="12" height="18" align="absmiddle" />&nbsp;上传Excel文件
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC"
                                ...
                                <tr class="table-item">
                                    <td width="12%" bgcolor="#E7E7E7" align="center">
                                        <a href="分店期初库存导入模板(生产版).rar">模板下载</a>
                                    </td>
                    ...
                    <tr>
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC"
                                class="table">
                                <tr class="table-item">
                                    <td style="width: 12%; background-color: #E7E7E7" align="right">
                                        Excel数据校验步骤：
                                    </td>
                                    <td colspan="3" style="width: 88%; height: 30px; background-color: #FFFFFF; padding-left: 5px"
                                        align="left">
                                ...
                                <tr id="tr_result" runat="server" visible="false">
                                    ...
                                    <td colspan="3" align="left" style="background-color: #FFFFFF; color: #FF0000">
                                        <a href="#" onclick="showError()">查看校验失败原因</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC"
                                ...
                                <tr class="table-item">
                                    <td colspan="4" width="100%" height="30" bgcolor="#E7E7E7" align="center">
                                        <asp:Button ID="btn_input" OnClick="btn_input_Click" Enabled="false" runat="server"
                                            Text="批量导入" />
                                    </td>
                                </tr>
                            </table>
                ...
                <!--批量导入结束-->
                <!--批量导入提示-->
                <table width="99%" border="0" align="center" cellpadding="0" id="tab_end" runat="server"
                    visible="false" cellspacing="0" bgcolor="#CCCCCC">
                    <tr style="height: 35px">
                        <td valign="bottom" class="Blue" style="background-color: #F0F0F0; padding-left: 1px">
                ...
                <!--批量导入提示结束-->
                <!--查看错误开始-->
                <table width="99%" border="0" align="center" cellpadding="0" id="taberror" style="display: none"
                    cellspacing="0" bgcolor="#CCCCCC">
                    <tr style="height: 35px">
                        <td valign="bottom" class="Blue" style="background-color: #F0F0F0; padding-left: 1px">
                            <img src="../../../images/Main/arrow_1.jpg" width="12" height="18" align="absmiddle" />&nbsp;Excel校验结果&nbsp;&nbsp;&nbsp;&nbsp;<a
                                href="#" onclick="hiddenError()">关闭校验失败原因</a>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#FFFFFF">
