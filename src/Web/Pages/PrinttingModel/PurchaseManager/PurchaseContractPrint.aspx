<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseContractPrint.aspx.cs" Inherits="Pages_PrinttingModel_PurchaseManager_PurchaseContractPrint" ValidateRequest="false"  %>
                                        ...
                                        <tr>
                                            <td bgcolor="#FFFFFF" align="left">
                                                <table width="100%" border="0" align="left" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td   align="left">
                                                            <input type="checkbox" name="ckContractNo" id="ckContractNo" value="ContractNo" /><input type="text"
                                                    ...
                                                    <tr>
                                                     <td   align="left">
                                                        ...
                                                        <td   align="left">
                                                        <input type="checkbox" name="ckTypeIDName" id="ckTypeIDName" value="TypeIDName" /><input
                                                    ...
                                                    <tr>
                                                     <td   align="left">
                                                                            ...
                                                                            <input type="checkbox" name="ckSignDate" id="ckSignDate" value="SignDate" /><input type="text"
                                                                id="txtApplyDate" value="签约日期：" size="20"  readonly/>
                                                             
                                                        </td>
                                                        <td   align="left">
                                                              <input type="checkbox" name="ckTheyDelegate" id="ckTheyDelegate" value="TheyDelegate" /><input type="text"
                                                                id="Text10" value="供应商签约人：" size="20"  readonly/>
                                                                
                                                           
                                                        </td>
                                                        <td>
                                                                         <input type="checkbox" name="ckOurUserName" id="ckOurUserName" value="OurUserName" /><input type="text"
                                                                id="Text8" value="我方签约人：" size="20"  readonly/>
                                                                </td>
                                                    </tr>
                                                  <tr>
                                                     <td   align="left">
                                                   ...
                                                   <tr>
                                                     <td   align="left">
                                                        ...
                                                        <td>
                                                                         <input type="checkbox" name="ckSignAddr" id="ckSignAddr" value="SignAddr" /><input type="text"
                                                                id="Text18" value="签约地点：" size="20"  readonly/>
                                                                </td>
                                                    </tr>
                                                    <tbody id="extTable">
                                                        <tr class='ext'>
                                                            ...
                                                            <table width="100%" border="0" cellspacing="1" bgcolor="#000000" id="listSetDetail">
                                                                <tr>
                                                                   ...
                                                                   <td bgcolor="#FFFFFF">
                                                                            ...
                                                                            type="text" id="txtUsed2Price" value="单价" size="12" readonly/>
                                                                    </td>
                                                                    <%}
                                                                           else
                                                                           { %>
                                                              ...
                                                              <td bgcolor="#FFFFFF" style="width:1%">
                                                                    ...
                                                                    <td bgcolor="#FFFFFF" style="width:1%">
                                                                              ...
                                                                              <input type="checkbox" name="ckdSpecification" id="ckdSpecification" value="standard" /><input
                                                                            type="text" id="Text21" value="规格" size="4" readonly/>
                                                                    </td>
...
<script language="javascript" type="text/javascript">
    ...
    {
        /*加载扩展属性名称*/
        LoadExtTableName('officedba.PurchaseContract');
        /*加载打印模板设置信息*/
    ...
    function SavePrintSetting() {
        ...
        var toLocation='PurchaseContractPrint.aspx?ID=' + intMrpID;
        var hidBillTypeFlag = document.getElementById('hidBillTypeFlag').value;
        var hidPrintTypeFlag = document.getElementById('hidPrintTypeFlag').value;
        /*主表信息*/
        ...
        if (document.getElementById('ckTypeIDName').checked) strBaseFields = strBaseFields + "TypeIDName|"; 
          ...
          if (document.getElementById('ckOurUserName').checked) strBaseFields = strBaseFields + "OurUserName|";     
    ...
    if (document.getElementById('ckPayTypeName').checked) strBaseFields = strBaseFields + "PayTypeName|";   
                        ...
                        if (document.getElementById('ckdTaxPrice').checked) strDetailFields = strDetailFields + "TaxPrice|";
                              if (document.getElementById('ckdTaxRate').checked) strDetailFields = strDetailFields + "TaxRate|";
                                 if (document.getElementById('ckdTotalPrice').checked) strDetailFields = strDetailFields + "TotalPrice|"; 
                                        if (document.getElementById('ckdsUnitName').checked) strDetailFields = strDetailFields + "UnitName|";
        ...
        if (document.getElementById('ckdSpecification').checked) strDetailFields = strDetailFields + "standard|";
