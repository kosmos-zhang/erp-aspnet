<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseOrderPrint.aspx.cs" Inherits="Pages_PrinttingModel_PurchaseManager_PurchaseOrderPrint" ValidateRequest="false"  %>
                                        ...
                                        <tr>
                                            <td bgcolor="#FFFFFF" align="left">
                                                    ...
                                                    <tr>
                                                     <td   align="left">
                                                      <input type="checkbox" name="ckPurchaserName" id="ckPurchaserName" value="PurchaserName" /><input
                                                        ...
                                                        <td> 
                                                                <input type="checkbox" name="ckTakeTypeName" id="ckTakeTypeName" value="TakeTypeName" /><input type="text"
                                                                id="Text4" value="交货方式：" size="20"  readonly/>
                                                        </td>
                                                    </tr> 
                                                           <tr>
                                                     <td   align="left"> 
                                                        ...
                                                        <input type="checkbox" name="ckOrderDate" id="ckOrderDate" value="OrderDate" /><input type="text"
                                                                id="txtApplyDate" value="签单日期：" size="20"  readonly/> 
                                                        </td>
                                                        <td> 
                                                       <input type="checkbox" name="ckCarryTypeName" id="ckCarryTypeName" value="CarryTypeName" /><input type="text"
                                                                id="Text5" value="运送方式：" size="20"  readonly/>
                                                                </td>
                                                    </tr>
                                                    <tr>
                                                     <td   align="left">
                                                <input type="checkbox" name="ckProviderName" id="ckProviderName" value="ProviderName" /><input type="text"
                                                        ...
                                                        <td   align="left"> 
                                                                  <input type="checkbox" name="ckProviderBillID" id="ckProviderBillID" value="ProviderBillID" /><input type="text"
                                                                id="Text21" value="供方订单号：" size="20"  readonly/> 
                                                        </td>
                                                        <td>
                                                        <input type="checkbox" name="ckPayTypeName" id="ckPayTypeName" value="PayTypeName" /><input type="text"
                                                                id="Text6" value="结算方式：" size="20"  readonly/> 
                                                                </td>
                                                    </tr>
                                                  <tr>
                                                     <td   align="left">
                                                   <input type="checkbox" name="ckCurrencyTypeName" id="ckCurrencyTypeName" value="CurrencyTypeName" /><input type="text"
                                                                id="Text7" value="币种：" size="20"  readonly/> 
                                                        </td>
                                                        <td   align="left">
                                                   ...
                                                   <tr>
                                                     <td   align="left">
                                                  <input type="checkbox" name="ckOurDelegateName" id="ckOurDelegateName" value="OurDelegateName" /><input type="text"
                                                                id="Text8" value="我方代表：" size="20"  readonly/> 
                                                        </td>
                                                        <td   align="left"> 
                                                                <input type="checkbox" name="ckTheyDelegate" id="ckTheyDelegate" value="TheyDelegate" /><input type="text"
                                                                id="Text10" value="对方代表：" size="20"  readonly/> 
                                                        </td>
                                                        <td>
                                                          <input type="checkbox" name="ckisAddTaxName" id="ckisAddTaxName" value="isAddTaxName" /><input type="text"
                                                                id="Text11" value="是否为增值税：" size="20"  readonly/> 
                                                                </td>
                                                    </tr>
                                                      <tr>
                                                     <td   align="left">
                                                  <input type="checkbox" name="ckProjectID" id="ckProjectID" value="ProjectName" /><input type="text"
                                                                id="Text24" value="所属项目：" size="20"  readonly/> 
                                                        </td>
                                                        <td   align="left"> 
                                                 ...
                                                 <input type="checkbox" name="ckTotalTax" id="ckTotalTax" value="TotalTax" /><input    type="text" id="Text12" value="税额合计：" size="20" readonly /> 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td   align="left">
                                                              <input type="checkbox" name="ckOtherTotal" id="ckOtherTotal" value="OtherTotal" /><input
                                                    ...
                                                    <tr>
                                                        <td colspan="4">
                                                            <table width="100%" border="0" cellspacing="1" bgcolor="#000000" id="listSetDetail">
                                                                <tr>
                                                                       <td bgcolor="#FFFFFF" >
                                                                        <input type="checkbox" name="ckdSortNo" id="ckdSortNo" value="SortNo" /><input
                                                                            type="text" id="Text19" value="序号" size="4" readonly/>
                                                                    </td>
                                                                          <td bgcolor="#FFFFFF" >
                                                                        <input type="checkbox" name="ckdProductNo" id="ckdProductNo" value="ProductNo" /><input
                                                                    ...
                                                                    <td bgcolor="#FFFFFF">
                                                                       ...
                                                                       {%>基本数量<%}else{ %>采购数量<%} %>" size="8" readonly/>
                                                                    </td>
                                                                      <td bgcolor="#FFFFFF">
                                                                         <input type="checkbox" name="ckdUnitName" id="ckdUnitName" value="UnitName" /><input
                                                                            type="text" id="Text22" value="<% if (((XBase.Common.UserInfoUtil)XBase.Common.SessionUtil.Session["UserInfo"]).IsMoreUnit.ToString()=="True")
                                                                   ...
                                                                   <td bgcolor="#FFFFFF">
                                                                            ...
                                                                            type="text" id="txtUsed2Price" value="单价" size="4" readonly/>
                                                                    </td>
                                                                    <%}
                                                                           else
                                                                           { %>
                                                                 ...
                                                                 <td bgcolor="#FFFFFF" style="width:1%">
                                                                    ...
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2UsedUnitCount" id="ck2UsedUnitCount" value="UsedUnitCount" /><input
                                                                            type="text" id="txtDUsed2UnitCount" value="采购数量" size="10" readonly />
                                                                    </td>
                                                                    <%} %>
                                                                    ...
                                                                    <td bgcolor="#FFFFFF">
                                                                      ...
                                                                      <td bgcolor="#FFFFFF" style="width:1%">
                                                                        ...
                                                                        <td bgcolor="#FFFFFF" style="width:1%">
                                                                              ...
                                                                              <input type="checkbox" name="ckdArrivedCount" id="ckdArrivedCount" value="ArrivedCount" /><input
                                                                            type="text" id="Text23" value="已到货数量" size="10" readonly/>
                                                                    </td>
                                                                      <td bgcolor="#FFFFFF" style="width:1%">
                                                                     
                                                                              <input type="checkbox" name="chkSpecification" id="chkSpecification" value="Specification" /><input
                                                                            type="text" id="Text25" value="规格" size="4" readonly/>
                                                                    </td>
...
<script language="javascript" type="text/javascript">
    ...
    {
        /*加载扩展属性名称*/
        LoadExtTableName('officedba.PurchaseOrder');
        /*加载打印模板设置信息*/
        ...
        ['ckCarryTypeName', 'CarryTypeName'],  
            ['ckPayTypeName', 'PayTypeName'],  
                ['ckCurrencyTypeName', 'CurrencyTypeName'],   
                                      ['ckRate', 'Rate'],   
                                 ['ckProviderBillID', 'ProviderBillID'],   
        ...
        var dbDetail = new Array( 
         ['ckdSortNo', 'SortNo'],
          ['ckdProductNo', 'ProductNo'],
                                 ...
                                 ['ckdTaxRate', 'TaxRate'],
                                 ['ckdArrivedCount', 'ArrivedCount'],
                                  ['chkSpecification', 'Specification'], 
    ...
    function SavePrintSetting() {
        ...
        var toLocation='PurchaseOrderPrint.aspx?ID=' + intMrpID;
        var hidBillTypeFlag = document.getElementById('hidBillTypeFlag').value;
        var hidPrintTypeFlag = document.getElementById('hidPrintTypeFlag').value;
        /*主表信息*/
        ...
        if (document.getElementById('ckTypeName').checked) strBaseFields = strBaseFields + "TypeName|";
         if (document.getElementById('ckPurchaserName').checked) strBaseFields = strBaseFields + "PurchaserName|";
          if (document.getElementById('ckDeptName').checked) strBaseFields = strBaseFields + "DeptName|";    
           ...
           if (document.getElementById('ckProviderBillID').checked) strBaseFields = strBaseFields + "ProviderBillID|"; 
        ...
        if (document.getElementById('ckCountTotal').checked) strBaseFields = strBaseFields + "CountTotal|";
         ...
         if (document.getElementById('ckDiscount').checked) strBaseFields = strBaseFields + "Discount|";
          ...
          if (document.getElementById('ckOtherTotal').checked) strBaseFields = strBaseFields + "OtherTotal|";
        ...
        if (document.getElementById('ckRemark').checked) strBaseFields = strBaseFields + "Remark|";
         if (document.getElementById('ckProjectID').checked) strBaseFields = strBaseFields + "ProjectName|";  
        ...
        /*明细信息*/ 
         if (document.getElementById('ckdSortNo').checked) strDetailFields = strDetailFields + "SortNo|";
          if (document.getElementById('ckdProductNo').checked) strDetailFields = strDetailFields + "ProductNo|";
        ...
        if (document.getElementById('ckdRequireDate').checked) strDetailFields = strDetailFields + "RequireDate|";  
                        if (document.getElementById('ckdArrivedCount').checked) strDetailFields = strDetailFields + "ArrivedCount|";
                        
                           if (document.getElementById('chkSpecification').checked) strDetailFields = strDetailFields + "Specification|";
