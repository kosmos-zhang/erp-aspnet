<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchasePlanPrint.aspx.cs" Inherits="Pages_PrinttingModel_PurchaseManager_PurchasePlanPrint" ValidateRequest="false" %>
                                        ...
                                        <tr>
                                            <td bgcolor="#FFFFFF" align="left">
                                                <table width="100%" border="0" align="left" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td   align="left">
                                                            <input type="checkbox" name="ckPlanNo" id="ckPlanNo" value="PlanNo" /><input type="text"
                                                    ...
                                                    <tr>
                                                     <td   align="left">
                                                            <input type="checkbox" name="ckPlanUserName" id="ckPlanUserName" value="PlanUserName" /><input type="text"
                                                                id="txtApplyUserName" value="计划员：" size="20"  readonly/>
                                                        </td>
                                                        <td   align="left">
                                                              <input type="checkbox" name="ckPurchaserName" id="ckPurchaserName" value="PurchaserName" /><input
                                                                type="text" id="txtFromTypeName" value="采购员：" size="20" readonly />
                                                        </td>
                                                       
                                                        <td>
                                                  
                                                                  <input type="checkbox" name="ckPlanDeptName" id="ckPlanDeptName" value="PlanDeptName" /><input
                                                                type="text" id="txtDeptName" value="采购部门：" size="20" readonly/>
                                                        </td>
                                                    </tr>
                                                     ...
                                                     <td   align="left">
                                                        ...
                                                        <td   align="left">
                                                            <input type="checkbox" name="ckPlanDate" id="ckPlanDate" value="PlanDate" /><input type="text"
                                                                id="txtApplyDate" value="计划日期：" size="20"  readonly/>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td   align="left">
                                                         <input type="checkbox" name="ckPlanMoney" id="ckPlanMoney" value="PlanMoney" /><input
                                                    ...
                                                    <tr>
                                                        <td colspan="4">
                                                            <table width="100%" border="0" cellspacing="1" bgcolor="#000000" id="listSetDetail">
                                                                <tr>
                                                                    <td bgcolor="#FFFFFF"  >
                                                                        <input type="checkbox" name="ckdSortNo" id="ckdSortNo" value="SortNo" />
                                                                        <input type="text"   id="Text8" value="序号" size="4" readonly/>
                                                                    </td>
                                                                    <td bgcolor="#FFFFFF"  >
                                                                   ...
                                                                   <td bgcolor="#FFFFFF">
                                                                    ...
                                                                    <td bgcolor="#FFFFFF">
                                                                            ...
                                                                            type="text" id="txtUnitPrice" value="单价" size="4"   readonly/>
                                                                    </td>
                                                                    <%} %>
                                                                    ...
                                                                    <%} %>
                                                                     ...
                                                                     <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ckdTotalPrice" id="ckdTotalPrice" value="TotalPrice" /><input
                                                                            type="text" id="Text3" value="计划金额" size="8" readonly/>
                                                                    </td>
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ckdPlanTakeDate" id="ckdPlanTakeDate" value="PlanTakeDate" /><input
                                                                            type="text" id="txtDPlanDate" value="计划交货日期" size="10" readonly/>
                                                                    </td>
                                                                    ...
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ckdFromSortNo" id="ckdFromSortNo"  value="FromSortNo" /><input
                                                                            type="text" id="txtDFromLineNo" value="源单序号" size="8" readonly/>
                                                                    </td>
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ckdProviderName" id="ckdProviderName" value="ProviderName"  /><input
                                                                            type="text" id="txtDApplyReasonName" value="供应商" size="6" readonly/>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <br />
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td bgcolor="#FFFFFF">
                                                                       ...
                                                                       {%>基本单位<%}else{ %>单位<%} %>" size="10" readonly/>
                                                                        ...
                                                                        <td bgcolor="#FFFFFF">
                                                                          <input type="checkbox" name="ckdsProviderName" id="ckdsProviderName" value="ProviderName" /><input
                                                                            type="text" id="Text4" value="供应商" size="6" readonly/>
                                                                    </td>
                                                                    <td bgcolor="#FFFFFF">
                                                                    ...
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ck2Used2UnitCount" id="ck2Used2UnitCount" value="UsedUnitCount" /><input
                                                                            type="text" id="txtDUsed2UnitCount" value="计划数量" size="10" readonly />
                                                                    </td>
                                                                    <%} %>
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ckdsRequireDate" id="ckdsRequireDate" value="RequireDate" /><input
                                                                            type="text" id="txtDSRequireDate" value="计划交货日期" size="12" readonly/>
                                                                    </td>
                                                                      <% if (((XBase.Common.UserInfoUtil)XBase.Common.SessionUtil.Session["UserInfo"]).IsMoreUnit.ToString() == "True")
                                                                           {%>
                                                                   ...
                                                                   <td bgcolor="#FFFFFF">
                                                                              ...
                                                                              <input type="checkbox" name="ckdUsed2Price" id="ckdUsed2Price" value="UsedPrice" /><input
                                                                            type="text" id="txtUsed2Price" value="计划采购单价" size="12" readonly/>
                                                                    </td>
                                                                    <%}
                                                                           else
                                                                           { %>
                                                                 ...
                                                                 <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ckdsUnitPrice" id="ckdsUnitPrice" value="UnitPrice" /><input
                                                                            type="text" id="Text5" value="计划采购单价" size="12" readonly/>
                                                                    </td>
                                                                    <%} %>
                                                                    
                                                                     
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ckdsTotalPrice" id="ckdsTotalPrice" value="TotalPrice" /><input
                                                                            type="text" id="Text6" value="计划采购金额" size="12" readonly/>
                                                                    </td>
                                                                       <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ckdsOrderCount" id="ckdsOrderCount" value="OrderCount" /><input
                                                                            type="text" id="Text7" value="已订购数量" size="10" readonly/>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
...
<script language="javascript" type="text/javascript">
    ...
    {
        /*加载扩展属性名称*/
        LoadExtTableName('officedba.PurchasePlan');
        /*加载打印模板设置信息*/
    ...
    function LoadPrintSettingInfo() {
        ...
        var dbBase = new Array( ['ckExtField1', 'ExtField1'],
                                ...
                                ['ckTitle', 'Title'],
                                ['ckTypeName', 'TypeName'],
                                ['ckPurchaserName', 'PurchaserName'],
                                ['ckPlanDate', 'PlanDate'],
                                ['ckFromTypeName', 'FromTypeName'],
                                ['ckPlanDeptName', 'PlanDeptName'],
                                 ['ckPlanUserName', 'PlanUserName'],
                                ['ckCountTotal', 'CountTotal'],
                                       ['ckPlanMoney', 'PlanMoney'],
        ...
        var dbDetail = new Array(['ckdSortNo', 'SortNo'],
                                 ...
                                 ['ckdPlanTakeDate', 'PlanTakeDate'],
                                 ['ckdProviderName', 'ProviderName'],
                                 ['ckFromBillNo', 'FromBillNo'],
                                 ['ckdFromSortNo', 'FromSortNo'],
                                    ['ckdProviderName', 'ProviderName']
                                 );
        /*第二明细 */
    ...
    function SavePrintSetting() {
        ...
        var toLocation='PurchasePlanPrint.aspx?ID=' + intMrpID;
        var hidBillTypeFlag = document.getElementById('hidBillTypeFlag').value;
        var hidPrintTypeFlag = document.getElementById('hidPrintTypeFlag').value;
        /*主表信息*/
        ...
        if (document.getElementById('ckTypeName').checked) strBaseFields = strBaseFields + "TypeName|";
         if (document.getElementById('ckPlanUserName').checked) strBaseFields = strBaseFields + "PlanUserName|";
          if (document.getElementById('ckPurchaserName').checked) strBaseFields = strBaseFields + "PurchaserName|";
        if (document.getElementById('ckPlanDeptName').checked) strBaseFields = strBaseFields + "PlanDeptName|";
             if (document.getElementById('ckFromTypeName').checked) strBaseFields = strBaseFields + "FromTypeName|";
             
             
           if (document.getElementById('ckPlanDate').checked) strBaseFields = strBaseFields + "PlanDate|";
        
             
        if (document.getElementById('ckCountTotal').checked) strBaseFields = strBaseFields + "CountTotal|";
                if (document.getElementById('ckPlanMoney').checked) strBaseFields = strBaseFields + "PlanMoney|";
        ...
        if (document.getElementById('ckdPlanTakeDate').checked) strDetailFields = strDetailFields + "PlanTakeDate|";
            if (document.getElementById('ckFromBillNo').checked) strDetailFields = strDetailFields + "FromBillNo|";
               if (document.getElementById('ckdFromSortNo').checked) strDetailFields = strDetailFields + "FromSortNo|";
        if (document.getElementById('ckdProviderName').checked) strDetailFields = strDetailFields + "ProviderName|";
      if(glb_IsMoreUnit=='True')
      {
   ...
   if (document.getElementById('ckdsProviderName').checked) strDetailSecondFields = strDetailSecondFields + "ProviderName|";
          ...
          if(glb_IsMoreUnit=='True')
      {
        ...
        if (document.getElementById('ck2Used2UnitCount').checked) strDetailSecondFields = strDetailSecondFields + "UsedUnitCount|";
                  if (document.getElementById('ckdUsed2Price').checked) strDetailSecondFields = strDetailSecondFields + "UsedPrice|";
        }
        else
        {
