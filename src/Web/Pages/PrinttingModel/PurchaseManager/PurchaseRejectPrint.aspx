<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseRejectPrint.aspx.cs"
    Inherits="Pages_PrinttingModel_PurchaseManager_PurchaseRejectPrint" ValidateRequest="false" %>
                                        ...
                                        <tr>
                                            <td bgcolor="#FFFFFF" align="left">
                                                <table width="100%" border="0" align="left" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <input type="checkbox" name="ck1RejectNo" id="ck1RejectNo" value="RejectNo" /><input
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <input type="checkbox" name="ck1TypeName" id="ck1TypeName" value="TypeName" /><input
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <input type="checkbox" name="ck1ReceiveMan" id="ck1ReceiveMan" value="ReceiveMan" /><input
                                                                type="text" id="Text24" value="收货人：" size="20" readonly />
                                                        </td>
                                                        <td align="left">
                                                            <input type="checkbox" name="ck1ReceiveTel" id="ck1ReceiveTel" value="ReceiveTel" /><input
                                                                type="text" id="txtApplyDate" value="收货人联系电话：" size="20" readonly />
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <input type="checkbox" name="ck1RejectDate" id="ck1RejectDate" value="RejectDate" /><input
                                                                type="text" id="Text21" value="退货时间：" size="20" readonly />
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <input type="checkbox" name="ck1isOpenbillName" id="ck1isOpenbillName" value="isOpenbillName" /><input
                                                                type="text" id="Text22" value="是否建单：" size="20" readonly />
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="ck1ProjectName" id="ck1ProjectName" value="ReceiveOverAddress" /><input
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <input type="checkbox" name="ck1TotalDyfzk" id="ck1TotalDyfzk" value="TotalDyfzk" /><input
                                                                type="text" id="Text18" value="抵应付帐款：" size="20" readonly />
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="ck1TotalYthkhj" id="ck1TotalYthkhj" value="TotalYthkhj" /><input
                                                                type="text" id="Text23" value="应退货款合计：" size="20" readonly />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td height="20" colspan="3" bgcolor="#E1F0FF" style="font-weight: bold; color: #5D5D5D;">
...
printSetObj.BillTypeFlag = document.getElementById('hidBillTypeFlag').value;
    ...
    /*跳转页面*/
    printSetObj.ToLocation ='PurchaseRejectPrint.aspx?ID=' + <%=intMrpID %>;
    /*表名称*/
    printSetObj.TableName = 'officedba.PurchaseReject';
    /*取基本信息及明细信息的字段*/
    if('<%=IsMoreUnit %>' == 'True')
    {
        printSetObj.ArrayDB = new Array(    
                                            [   
                                               ...
                                               ,'ExtField7','ExtField8','ExtField9','ExtField10','RejectNo','Title','TypeName'
                                               ,'PurchaserName','ReceiveTel','FromTypeName','DeptName','SendAddress'
                                               ,'ProviderName','MoneyTypeName','ReceiveOverAddress','isAddTaxName','TakeTypeName'
                                               ,'CarryTypeName','PayTypeName','CurrencyTypeName','Rate','RejectDate','ProjectName','ReceiveOverAddress'
                                               ,'isOpenbillName','ReceiveMan','CountTotal','TotalTax','TotalPrice','TotalFee','Discount','DiscountTotal','RealTotal'
                                               ,'TotalDyfzk','TotalYthkhj','CreatorName','CreateDate','BillStatusName','ConfirmorName','ConfirmDate','CloserName','CloseDate'
                                               ,'ModifiedUserID','ModifiedDate','Remark'
                                            ],
                                            [   
                                                'SortNo','ProductNo','ProductName','Specification','ColorName','UnitName','BackCount','UsedUnitName','UsedUnitCount','UnitPrice','TotalPrice','TaxPrice'
                                                ,'TotalTax','TaxRate','TotalFee'
                                            ]
                                        );
    }
    else
    {
        printSetObj.ArrayDB = new Array(    
                                            ...
                                            [   
                                                'SortNo','ProductNo','ProductName','Specification','ColorName','UnitName','BackCount','UnitPrice','TotalPrice','TaxPrice'
                                                ,'TotalTax','TaxRate','TotalFee'
                                            ]
                                        );
    }
