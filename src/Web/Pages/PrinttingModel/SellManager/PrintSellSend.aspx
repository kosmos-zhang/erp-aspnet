<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintSellSend.aspx.cs" Inherits="Pages_PrinttingModel_SellManager_PrintSellSend" 
                        ...
                        <tr>
                            <td bgcolor="#FFFFFF" align="center" valign="top" style="width: 90%">
                                <div id="divSet" style="display: none;" class="setDiv">
                                                ...
                                                <table width="100%" border="0" align="left" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ckSendNo" id="ckSendNo" value="SendNo" /><input type="text"
                                                                id="txtSendNo" value="单据编号：" size="20" readonly="readonly" />
                                                        </td>
                                                        <td width="20%" align="left">
                                                    ...
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ckOrderNo" id="ckOrderNo" value="OrderNo" /><input
                                                                type="text" id="txtOrderNo" value="源单编号：" size="20" readonly="readonly" />
                                                        </td>
                                                        <td width="20%" align="left">
                                                    ...
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ckReceiver" id="ckReceiver" value="Receiver" /><input
                                                                type="text" id="txtReceiver" value="收货人姓名：" size="20" readonly="readonly" />
                                                        </td>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ckSenderName" id="ckSenderName" value="SenderName" /><input
                                                                type="text" id="txtSenderName" value="发货人：" size="20" readonly="readonly" />
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="ckIntendSendDate" id="ckIntendSendDate" value="IntendSendDate" /><input type="text"
                                                                id="txtIntendSendDate" value="预计发货时间：" size="20" readonly="readonly" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ckSendAddr" id="ckSendAddr" value="SendAddr" /><input
                                                                type="text" id="txtSendAddr" value="发货地址：" size="20" readonly="readonly" />
                                                        </td>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ckReceiveAddr" id="ckReceiveAddr" value="ReceiveAddr" /><input
                                                                type="text" id="txtReceiveAddr" value="收货地址：" size="20" readonly="readonly" />
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="ckTel" id="ckTel" value="Tel" /><input type="text"
                                                                id="txtTel" value="收货人电话：" size="20" readonly="readonly" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ckModile" id="ckModile" value="Modile" /><input
                                                                type="text" id="txtModile" value="收货人移动电话：" size="20" readonly="readonly" />
                                                        </td>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ckPost" id="ckPost" value="Post" /><input type="text"
                                                                id="txtPost" value="收货人邮编：" size="20" readonly="readonly" />
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ckCanViewUserName" id="ckCanViewUserName" value="CanViewUserName" /><input
                                                                type="text" id="txtCanViewUserName" value="可查看人员：" size="20" readonly="readonly" />
                                                        </td>
                                                        <td width="20%" align="left">
                                                    ...
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ckCountTotal" id="ckCountTotal" value="CountTotal" /><input
                                                                type="text" id="txtCountTotal" value="发货数量合计：" size="20" readonly="readonly" />
                                                        </td>
                                                        <td width="20%" align="left">
                                                    ...
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ckTransporterName" id="ckTransporterName" value="TransporterName" /><input type="text"
                                                                id="txtTransporterName" value="运输商：" size="20" readonly="readonly" />
                                                        </td>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ckTransportFee" id="ckTransportFee" value="TransportFee" /><input type="text"
                                                                id="txtTransportFee" value="运费合计：" size="20" readonly="readonly" />
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" name="ckTransPayTypeName" id="ckTransPayTypeName" value="TransPayTypeName" /><input type="text"
                                                                id="txtTransPayTypeName" value="运费结算方式：" size="20" readonly="readonly" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td height="20" colspan="3" bgcolor="#E1F0FF" style="font-weight: bold; color: #5D5D5D;">
                                                                 ...
                                                                 <tr>
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ckdSpecification" id="ckdSpecification" value="Specification" /><input
                                                                            type="text" id="txtDSpecification" value="规格" size="8" readonly="readonly" />
                                                                    </td>
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ckdColorName" id="ckdColorName" value="ColorName" /><input
                                                                            type="text" id="txtDColorName" value="颜色" size="8" readonly="readonly" />
                                                                    </td>
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ckdSendDate" id="ckdSendDate" value="SendDate" /><input
                                                                            type="text" id="txtDSendDate" value="发货日期" size="8" readonly="readonly" />
                                                                    </td>
                                                                    <td bgcolor="#FFFFFF">
                                    ...
                                    <input type="hidden" id="hiddckSellSendNo" runat="server" />
                                    <!-- End 打印模板设置 -->
                                </div>
                            </td>
                        </tr>
...
<script language="javascript">
    var sellSendNo = $("#hiddckSellSendNo").val();
    ...
    {
        /*加载扩展属性名称*/
        LoadExtTableName('officedba.SellSend');
        /*加载打印模板设置信息*/
    ...
    function LoadPrintSettingInfo() {
        ...
        var dbBase = new Array( 
                                ...
                                ['ckDeptName', 'DeptName'],
                                ['ckReceiver', 'Receiver'],
                                ['ckSenderName', 'SenderName'],
                                ['ckIntendSendDate', 'IntendSendDate'],
                                ['ckSendAddr', 'SendAddr'],
                                ['ckReceiveAddr', 'ReceiveAddr'],
                                ['ckTel', 'Tel'],
                                ['ckModile', 'Modile'],
                                ['ckPost', 'Post'],
                                ...
                                ['ckTransporterName', 'TransporterName'],
                                ['ckTransportFee', 'TransportFee'],
                                ['ckTransPayTypeName', 'TransPayTypeName'],
    ...
    function SavePrintSetting() {
        ...
        var toLocation='PrintSellSend.aspx?no=' + sellSendNo;
        var hidBillTypeFlag = document.getElementById('hidBillTypeFlag').value;
        var hidPrintTypeFlag = document.getElementById('hidPrintTypeFlag').value;
        /*主表信息*/
        ...
        if (document.getElementById('ckReceiver').checked) strBaseFields = strBaseFields + "Receiver|";
        if (document.getElementById('ckSenderName').checked) strBaseFields = strBaseFields + "SenderName|";
        if (document.getElementById('ckIntendSendDate').checked) strBaseFields = strBaseFields + "IntendSendDate|";
        if (document.getElementById('ckSendAddr').checked) strBaseFields = strBaseFields + "SendAddr|";
        if (document.getElementById('ckReceiveAddr').checked) strBaseFields = strBaseFields + "ReceiveAddr|";
        if (document.getElementById('ckTel').checked) strBaseFields = strBaseFields + "Tel|";
        if (document.getElementById('ckModile').checked) strBaseFields = strBaseFields + "Modile|";
        ...
        if (document.getElementById('ckTransporterName').checked) strBaseFields = strBaseFields + "TransporterName|";
        if (document.getElementById('ckTransportFee').checked) strBaseFields = strBaseFields + "TransportFee|";
        if (document.getElementById('ckTransPayTypeName').checked) strBaseFields = strBaseFields + "TransPayTypeName|";
        for(var i=0;i<10;i++)
        {
       ...
       // if (document.getElementById('ckdSortNo').checked) strDetailFields = strDetailFields + "SortNo|";
        ...
        if (document.getElementById('ckdSendDate').checked) strDetailFields = strDetailFields + "SendDate|";
