<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SellContractPrint.aspx.cs" Inherits="Pages_PrinttingModel_SellManager_SellContractPrint" ValidateRequest="false" %>
                                                ...
                                                <table width="100%" border="0" align="left" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ckMRPNo" id="ckContractNo" value="MRPNo" /><input type="text" readonly="readonly" 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ckSubject" id="ckTheyDelegate" value="Subject" /><input type="text" readonly="readonly" 
                                                                id="Text15" value="客户方代表：" size="20" />
                                                        </td>
                                                        <td align="left">
                                                            <input type="checkbox" name="ckPricipalReal" id="ckOurDelegateName" value="PricipalReal" /><input readonly="readonly" 
                                                                type="text" id="Text16" value="我方代表：" size="20" />
                                                        </td>
                                                    </tr>
                                                    
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ckMRPNo" id="ckSignDate" value="MRPNo" /><input type="text" readonly="readonly" 
                                                                id="Text37" value="签约时间：" size="20" />
                                                        </td>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ckSubject" id="ckSignAddr" value="Subject" /><input type="text" readonly="readonly" 
                                                                id="Text38" value="签约地点：" size="20" />
                                                        </td>
                                                        <td align="left">
                                                            <input type="checkbox" name="ckPricipalReal" id="ckStartDate" value="PricipalReal" /><input readonly="readonly" 
                                                                type="text" id="Text39" value="开始日期：" size="20" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ckMRPNo" id="ckEndDate" value="MRPNo" /><input type="text" readonly="readonly" 
                                                                id="Text40" value="截止日期：" size="20" />
                                                        </td>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ckSubject" id="ckTalkProcess" value="Subject" /><input type="text" readonly="readonly" 
                                                                id="Text41" value="洽谈进展：" size="20" />
                                                        </td>
                                                        <td align="left">
                                                            <input type="checkbox" name="ckPricipalReal" id="ckstateText" value="PricipalReal" /><input readonly="readonly" 
                                                                type="text" id="Text42" value="合同状态：" size="20" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ckMRPNo" id="ckEndNote" value="MRPNo" /><input type="text" readonly="readonly" 
                                                                id="Text43" value="终止原因：" size="20" />
                                                        </td>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ckSubject" id="ckisAddTaxName" value="Subject" /><input type="text" readonly="readonly" 
                                                                id="Text44" value="是否增值税：" size="20" />
                                                        </td>
                                                        <td align="left">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ckSubject" id="ckTax" value="Subject" /><input type="text" readonly="readonly" 
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ckSubject" id="ckRealTotal" value="Subject" /><input type="text" readonly="readonly" 
                                                                id="Text23" value="折后含税金额：" size="20" />
                                                        </td>
                                                        <td align="left">
                                                            <input type="checkbox" name="ckPricipalReal" id="ckDiscountTotal" value="PricipalReal" /><input readonly="readonly" 
                                                                type="text" id="Text24" value="折扣金额合计：" size="20" />
                                                        </td>
                                                    </tr>
                                                     <tr>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ckMRPNo" id="ckCountTotal" value="MRPNo" /><input type="text" readonly="readonly" 
                                                                id="Text25" value="合同数量合计：" size="20" />
                                                        </td>
                                                        <td width="20%" align="left">
                                                                ...
                                                                <tr>                                                                   
                                                                    ...
                                                                    <% }
                                                                      ...
                                                                      {%>
                                                                        ...
                                                                        <td>
                                                                            <input type="hidden" name="ckdno2" id="ckno2" value="no2" /><input readonly="readonly" 
                                                                                type="hidden" id="no2" value="novalue" size="12" />
                                                                        </td>  
                                                                        <td>
                                                                            <input type="hidden" name="ckdno1" id="ckno1" value="no1" /><input readonly="readonly" 
                                                                                type="hidden" id="no1" value="novalue" size="12" />
                                                                        </td>      
                                                                    <%} %>
...
<script language="javascript">
    ...
    {
        /*加载扩展属性名称*/
        LoadExtTableName('officedba.SellContract');
        /*加载打印模板设置信息*/
    ...
    function SavePrintSetting() {
        ...
        var toLocation='SellContractPrint.aspx?no=' + strPlanNo;
        var hidBillTypeFlag = document.getElementById('hidBillTypeFlag').value;
        var hidPrintTypeFlag = document.getElementById('hidPrintTypeFlag').value;
        /*主表信息*/
        
        if (document.getElementById('ckContractNo').checked) strBaseFields = strBaseFields + "ContractNo|";
        ...
        if (document.getElementById('ckSignDate').checked) strBaseFields = strBaseFields + "SignDate|";
        if (document.getElementById('ckSignAddr').checked) strBaseFields = strBaseFields + "SignAddr|";
        ...
        if (document.getElementById('ckTalkProcess').checked) strBaseFields = strBaseFields + "TalkProcess|";
        if (document.getElementById('ckstateText').checked) strBaseFields = strBaseFields + "stateText|";
        
        if (document.getElementById('ckEndNote').checked) strBaseFields = strBaseFields + "EndNote|";
