<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StorageInProcessPrint1.aspx.cs"
    Inherits="Pages_PrinttingModel_StorageManager_StorageInProcessPrint1" ValidateRequest="false" %>
                                                ...
                                                <table width="100%" border="0" align="center" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            ...
                                                            <input type="text" id="txtInNo" value="入库单编号：" readonly size="10" />
                                                        </td>
                                                        <td width="20%" align="left">
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="ckFromType" value="FromType" />
                                                            <input type="text" id="txtFromType" value="源单类型：" readonly size="10" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" id="ckTaskNo" value="" />
                                                            <input type="text" id="txtTaskNo" value="生产任务单：" readonly size="10" />
                                                        </td>
                                                        <td width="20%">
                                                            <input type="checkbox" id="ckProcessType" value="" />
                                                            <input type="text" id="txtProcessType" value="加工类别：" readonly size="10" />
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" id="ckProcessDeptName" value="" />
                                                            <input type="text" id="txtProcessDeptName" value="加工单位：" readonly size="10" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" id="ckProcessorName" value="" />
                                                            <input type="text" id="txtProcessorName" value="生产负责人：" readonly size="10" />
                                                        </td>
                                                        <td width="20%" align="left">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="20%" align="left" style="display: <%=GetIsDisplayPrice() %>">
                                                            <input type="checkbox" id="ckA_TotalPrice" value="" />
                                                        ...
                                                        <td colspan="3">
                                                            <table width="100%" border="0" cellspacing="1" bgcolor="#000000" id="pageDataList1">
                                                                <tr>
                                                                    ...
                                                                    <td bgcolor="#FFFFFF" style="display: <%=GetIsDisplayPrice() %>">
                                                                        <input type="checkbox" id="ckB_TotalPrice" value="" /><input type="text" id="txtB_TotalPrice"
...
<script type="text/javascript">
    ...
    function ShowPrintSetting() {
        ...
        //LoadBillData();
        LoadExtTableName('officedba.StorageInProcess');
    ...
    if(IsDisplayPrice!="none")
    {
         ...
         dbBase = new Array(
                                ...
                                ['ckInNo', 'InNo'],//出库单编号
                                ['ckTitle', 'Title'],//主题
                                ['ckFromType', 'FromType'],//源单类型
                                ['ckTaskNo', 'TaskNo'],//源单编号
                                ['ckProcessType', 'ProcessType'],//
                                ['ckProcessDeptName', 'ProcessDeptName'],//
                                ['ckProcessorName', 'ProcessorName'],//
                                ['ckExecutorName', 'ExecutorName'],//
                                ['ckEnterDate', 'EnterDate'],//
                                ['ckInPutDeptName', 'InPutDeptName'],//
                                ['ckSummary', 'Summary'],//摘要
                                ['ckBatchNo', 'BatchNo'],//批次
                                ['ckCountTotal', 'CountTotal'],//
                                ['ckA_TotalPrice', 'A_TotalPrice'],//金额合计
        ...
        if(document.getElementById("HiddenMoreUnit").value == "true")
        {
            dbDetail = new Array(['ckSortNo', 'SortNo'],//序号
                                 ...
                                 ['ckB_TotalPrice', 'B_TotalPrice']//金额
                               );
        }
        else
        {
...
else
{
    ...
    function SavePrintSetting()    {
        ...
        var strBaseFields = "";
        var strDetailFields = "";
        var toLocation='StorageInProcessPrint1.aspx?ID=' + intMrpID;
        var hidBillTypeFlag = document.getElementById('hidBillTypeFlag').value;
        var hidPrintTypeFlag = document.getElementById('hidPrintTypeFlag').value;

        if ($('#ckInNo').attr("checked")) strBaseFields = strBaseFields + "InNo|";
        if ($('#ckTitle').attr("checked")) strBaseFields = strBaseFields + "Title|";
        if ($('#ckFromType').attr("checked")) strBaseFields = strBaseFields + "FromType|";
        if ($('#ckTaskNo').attr("checked")) strBaseFields = strBaseFields + "TaskNo|";
        if ($('#ckProcessType').attr("checked")) strBaseFields = strBaseFields + "ProcessType|";
        if ($('#ckProcessDeptName').attr("checked")) strBaseFields = strBaseFields + "ProcessDeptName|";
        ...
        if(IsDisplayPrice!="none")
        {
        if ($('#ckA_TotalPrice').attr("checked")) strBaseFields = strBaseFields + "A_TotalPrice|";
        ...
        if ($('#ckModifiedUserID').attr("checked")) strBaseFields = strBaseFields + "ModifiedUserID|";
        ...
        if ($('#ckB_TotalPrice').attr("checked")) strDetailFields = strDetailFields + "B_TotalPrice|";
