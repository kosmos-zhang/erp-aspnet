<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StorageInRedPrint1.aspx.cs"
    Inherits="Pages_PrinttingModel_StorageManager_StorageInRedPrint1" ValidateRequest="false" %>
                                                ...
                                                <table width="100%" border="0" align="center" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            ...
                                                            <input type="text" id="txtInNo" readonly="readonly" value="入库单编号：" readonly size="10" />
                                                        </td>
                                                        <td width="20%" align="left">
                                                    ...
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" id="ck1FromInNo" value="" />
                                                            <input type="text" id="txtFromInNo" value="原始入库单：" readonly size="10" />
                                                        </td>
                                                        <td width="20%">
                                                            <input type="checkbox" id="ck1FromExecutor" value="" />
                                                            <input type="text" id="txtFromExecutor" value="原始入库人：" readonly size="10" />
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" id="ck1FromEnterDate" value="" />
                                                            <input type="text" id="txtFromEnterDate" value="原始入库时间：" readonly size="10" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" id="ck1DeptName" value="" />
                                                            <input type="text" id="txtDeptName" value="原始入库部门：" readonly size="10" />
                                                        </td>
                                                        <td width="20%" align="left">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" id="ck1FromSummary" value="" />
                                                            <input type="text" id="txtFromSummary" value="原始摘要：" readonly size="10" />
                                                        </td>
                                                        <td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" id="ck2FromBillCount" value="" /><input type="text" id="txtFromBillCount"
                                                                            value="原始入库量" readonly size="10" />
                                                                    </td>
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" id="ck2ProductCount" /><input type="text" id="txtProductCount"
...
<script type="text/javascript">
    ...
    printSetObj.PrintTypeFlag = '<%=XBase.Common.ConstUtil.PRINTBILL_TYPEFLAG_INRED %>';
    /*跳转页面*/
    printSetObj.ToLocation ='StorageInRedPrint1.aspx?ID=' + BillID;
    /*表名称*/
    printSetObj.TableName = 'officedba.StorageInRed';
    /*取基本信息及明细信息的字段*/
    ...
    if(document.getElementById("HiddenMoreUnit").value == "true")
    {
        ...
        [     
            ...
            'InNo','Title','FromType','FromInNo', 'FromExecutor','FromEnterDate','DeptName',
            'ExecutorName','EnterDate','ReasonTypeName','FromSummary','Summary','BatchNo','CountTotal','A_TotalPrice',
            'CreatorName','CreateDate','ConfirmorName','ConfirmDate','CloserName','CloseDate','ModifiedUserName','ModifiedDate','BillStatus','Remark'
        ],
        [   
            'SortNo','ProductNo','ProductName','Specification','UnitID','UsedUnitName','StorageName','FromBillCount','ProductCount','UsedUnitCount','UnitPrice','B_TotalPrice'
        ]
        );
    }
    else
    {
        ...
        [   
            'SortNo','ProductNo','ProductName','Specification','UnitID','StorageName','FromBillCount','ProductCount','UnitPrice','B_TotalPrice'
        ]
        );
    }
    ...
    if(IsDisplayPrice=="none")
    {
        if(document.getElementById("HiddenMoreUnit").value == "true")
        {
            ...
            [   
                'ExtField1','ExtField2','ExtField3','ExtField4','ExtField5','ExtField6','ExtField7','ExtField8', 'ExtField9','ExtField10',
                'InNo','Title','FromType','FromInNo', 'FromExecutor','FromEnterDate','DeptName',
                'ExecutorName','EnterDate','ReasonTypeName','FromSummary','Summary','BatchNo','CountTotal',
                'CreatorName','CreateDate','ConfirmorName','ConfirmDate','CloserName','CloseDate','ModifiedUserName','ModifiedDate','BillStatus','Remark'
            ],
            [   
                'SortNo','ProductNo','ProductName','Specification','UnitID','UsedUnitName','StorageName','FromBillCount','ProductCount','UsedUnitCount'
            ]
            );
        }
        else
        {
            ...
            [   
                'SortNo','ProductNo','ProductName','Specification','UnitID','StorageName','FromBillCount','ProductCount'
            ]
            );
        }
