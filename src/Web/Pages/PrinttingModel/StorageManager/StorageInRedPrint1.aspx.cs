...
public partial class Pages_PrinttingModel_StorageManager_StorageInRedPrint1 : BasePage
{
    #region BillID
    public int BillID
    {
    ...
    protected void btnImport_Click(object sender, EventArgs e)
    {
        ...
        Response.AppendHeader("Content-Disposition", "attachment;filename=" + System.Web.HttpUtility.UrlEncode("红冲入库单") + ".xls");
