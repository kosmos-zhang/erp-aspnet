<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StorageLossPrint.aspx.cs"
    Inherits="Pages_PrinttingModel_StorageManager_StorageLossPrint"ValidateRequest="false" %>
                                                ...
                                                <table width="100%" border="0" align="center" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            ...
                                                            <input type="text" id="txtMRPNo" readonly value="库存报损单编号：" readonly size="10" />
                                                        </td>
                                                        <td width="20%" align="left">
                                                        <input type="checkbox" name="ckTitle" id="ckTitle" value="Title" />
                                                            <input type="text" id="txtTitle" value="报损单主题：" readonly size="10" />
                                                        </td>
                                                        <td >
                                                    ...
                                                    <td width="20%" align="left">
                                                        <input type="checkbox" name="ckDeptName" id="ckDeptName" value="DeptName" />
                                                            <input type="text" id="txtDeptName" value="报损部门：" readonly size="10" />
                                                        </td>
                                                        <td width="20%" align="left">
                                                        <input type="checkbox" name="ckUserTransactor" id="ckUserTransactor" value="UserTransactor" />
                                                         <input type="text" id="txtUserTransactor" value="仓库：" readonly size="10" />
                                                        </td>
                                                        
                                                        <td>
                                                        <input type="checkbox" name="ckReason" id="ckReason" value="Reason" />
                                                         <input type="text" id="Text1" value="报损原因：" readonly size="10" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="20%" align="left">
                                                        <input type="checkbox" name="ckOutDate" id="ckOutDate" value="OutDate" />
                                                            <input type="text" id="txtOutDate" value="报损日期：" readonly size="10" />
                                                        </td>
                                                        <td width="20%" align="left">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <input type="checkbox" name="ckTotalCount" id="ckTotalCount" value="TotalCount" />
                                                            <input type="text" id="txtTotalCount" value="报损数量合计：" readonly size="10" />
                                                        </td>
                                                        <td width="20%" align="left">
                                                        <input type="checkbox" name="ckTotalPrice" id="ckTotalPrice" value="TotalPrice" />
                                                            <input type="text" id="txtTotalPrice" value="报损金额合计：" readonly size="10" />
                                                        </td>
                                                        <td>
                                                        </td>
                                                    </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ckdNoteCount" id="ckdNoteCount" value="NoteCount" /><input
                                                                            type="text" id="txtDNoteCount" value="报损数量" readonly size="10" />
                                                                    </td>
                                                                    ...
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ckdOutMoney" id="ckdOutMoney" value="OutMoney" /><input
                                                                            type="text" id="txtDOutMoney" value="报损金额" readonly size="10" />
                                                                    </td>                                                                    
                                                                    <td bgcolor="#FFFFFF">
...
<script language="javascript">
    ...
    function ShowPrintSetting() {
        ...
        //LoadBillData();
        LoadExtTableName('officedba.StorageLoss');
 ...
 function ClosePrintSetting() {
    ...
    function LoadPrintSettingInfo() {
        ...
        var dbBase = new Array(
                                ...
                                ['ckOutNo', 'LossNo'],//库存报损单编号
                                ['ckTitle', 'Title'],//报损单主题
                                ['ckUserSender', 'ExecutorName'],//经办人
                                ['ckDeptName', 'DeptName'],//报损部门
                                ['ckUserTransactor', 'StorageName'],//仓库
                                ['ckReason', 'ReasonTypeName'],//报损原因                                
                                ['ckOutDate', 'LossDate'],//报损日期                                
        ...
        if(HiddenUnit=="True")
        {
              dbDetail = new Array(['ckdSortNo', 'SortNo'],//序号
                                 ...
                                 ['ckdNoteCount', 'UsedUnitCount'],//报损数量
                                 ['ckdOutPrice', 'UsedPrice'],//成本单价
                                 ['ckdOutMoney', 'B_TotalPrice'],//报损金额
        ...
        else
        {
                dbDetail = new Array(['ckdSortNo', 'SortNo'],//序号
                                 ...
                                 ['ckdNoteCount', 'ProductCount'],//报损数量
                                 ['ckdOutPrice', 'UnitPrice'],//成本单价
                                 ['ckdOutMoney', 'B_TotalPrice'],//报损金额
                                 ['ckdRemark', 'DetaiRemark']);//备注
        }
    ...
    function SavePrintSetting() {
        ...
        var strBaseFields = "";
        var strDetailFields = "";
        var toLocation='StorageLossPrint.aspx?ID=' + intMrpID;
        var hidBillTypeFlag = document.getElementById('hidBillTypeFlag').value;
        var hidPrintTypeFlag = document.getElementById('hidPrintTypeFlag').value;
        if (document.getElementById('ckOutNo').checked) strBaseFields = strBaseFields + "LossNo|";
        if (document.getElementById('ckTitle').checked) strBaseFields = strBaseFields + "Title|";
        if (document.getElementById('ckUserSender').checked) strBaseFields = strBaseFields + "ExecutorName|";
        if (document.getElementById('ckDeptName').checked) strBaseFields = strBaseFields + "DeptName|";        
        if (document.getElementById('ckUserTransactor').checked) strBaseFields = strBaseFields + "StorageName|";
        if (document.getElementById('ckOutDate').checked) strBaseFields = strBaseFields + "LossDate|";        
        ...
        if(HiddenUnit=="True")
        {
            ...
            if (document.getElementById('ckdNoteCount').checked) strDetailFields = strDetailFields + "UsedUnitCount|";
        ...
        else
        {
           ...
           // if (document.getElementById('ckdBaseCount').checked) strDetailFields = strDetailFields + "BaseCount|";
            ...
            if (document.getElementById('ckdNoteCount').checked) strDetailFields = strDetailFields + "ProductCount|";
