<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StorageOutOtherPrint.aspx.cs"
    Inherits="Pages_PrinttingModel_StorageManager_StorageOutOtherPrint" ValidateRequest="false"%>
                                                ...
                                                <table width="100%" border="0" align="center" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            ...
                                                            <input type="text" id="txtFromBillID" value="源单编号：" readonly size="10" />
                                                        </td>
                                                        <td width="20%" align="left">
                                                            <input type="checkbox" name="ckCustName" id="ckCustName" value="CustName" />
                                                            <input type="text" id="txtCustName" value="往来单位：" readonly size="10" />
                                                        </td>
                                                        <td>
                                                   ...
                                                   <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td  width="20%">
                                                         <input type="checkbox" name="ckProject" id="ckProject" value="Project" />
                                                            <input type="text" id="txtProject" value="所属项目：" readonly size="10" />
                                                        </td>
                                                        <td>
                                                        </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ckdBackCount" id="ckdBackCount" value="BackCount" /><input
                                                                            type="text" id="txtDBackCount" value="退货数量" readonly size="10" />
                                                                    </td>
                                                                    <td bgcolor="#FFFFFF">
...
<script language="javascript">
    ...
    function ShowPrintSetting() {
        ...
        LoadExtTableName('officedba.StorageOutOther');
...
function ClosePrintSetting() {
    ...
    function LoadPrintSettingInfo() {
        ...
        var dbBase = new Array(
                                ...
                                ['ckCustName', 'OtherCorpName'],//往来单位名称
                                ['ckCorpBigType', 'CorpBigTypeName'],//往来单位类型
        ...
        if(HiddenUnit=="True")
        {
            dbDetail = new Array(['ckdSortNo', 'SortNo'],//序号
                                 ...
                                 ['ckdBackCount', 'BackCount'],//退货数量
                                 ['ckdHaveOutCount', 'OutedTotal'],//已出库数量
    ...
    function SavePrintSetting() {
        ...
        var strBaseFields = "";
        var strDetailFields = "";
        var toLocation='StorageOutOtherPrint.aspx?ID=' + intMrpID;
        var hidBillTypeFlag = document.getElementById('hidBillTypeFlag').value;
        var hidPrintTypeFlag = document.getElementById('hidPrintTypeFlag').value;
        ...
        if (document.getElementById('ckCustName').checked) strBaseFields = strBaseFields + "OtherCorpName|";
        if (document.getElementById('ckCorpBigType').checked) strBaseFields = strBaseFields + "CorpBigTypeName|";
        ...
        if (document.getElementById('ckProject').checked) strBaseFields = strBaseFields + "ProjectName|";
        ...
        if (document.getElementById('ckdBackCount').checked) strDetailFields = strDetailFields + "BackCount|";
        if (document.getElementById('ckdHaveOutCount').checked) strDetailFields = strDetailFields + "OutedTotal|";
