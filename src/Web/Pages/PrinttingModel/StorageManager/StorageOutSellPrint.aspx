<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StorageOutSellPrint.aspx.cs"
    Inherits="Pages_PrinttingModel_StorageManager_StorageOutSellPrint" ValidateRequest="false" %>
                        ...
                        <tr>
                            <td bgcolor="#FFFFFF" align="center" valign="top" style="width: 90%">
                                <div id="divSet" style="display: none; width: 796px; overflow-x: auto; overflow-y: auto;
                                                ...
                                                <table width="100%" border="0" align="center" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td width="20%" align="left">
                                                            ...
                                                            <input type="text" id="txtMRPNo" readonly value="出库单编号：" size="10" />
                                                        </td>
                                                        <td width="20%" align="left">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <input type="checkbox" name="ckFromBillID" id="ckFromBillID" value="FromBillID" />
                                                            <input type="text" id="txtFromBillID" value="销售发货通知单：" readonly size="10" />
                                                        </td>
                                                        <td width="20%">
                                                        <input type="checkbox" name="ckCustName" id="ckCustName" value="CustName" />
                                                            <input type="text" id="txtCustName" value="客户名称：" readonly size="10" />
                                                        </td>
                                                        <td>
                                                        <input type="checkbox" name="ckSellDept" id="ckSellDept" value="SellDept" />
                                                         <input type="text" id="txtSellDept" value="销售部门：" readonly size="10" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="20%" align="left">
                                                        <input type="checkbox" name="ckSeller" id="ckSeller" value="Seller" />
                                                            <input type="text" id="txtSeller" value="业务员：" readonly size="10" />
                                                        </td>
                                                        <td width="20%" align="left">
                                                        <input type="checkbox" name="ckSendAddress" id="ckSendAddress" value="SendAddress" />
                                                            <input type="text" id="txtSendAddress" value="发货地址：" readonly size="10" />
                                                        </td>
                                                        <td >
                                                        <input type="checkbox" name="ckArrAddress" id="ckArrAddress" value="ArrAddress" />
                                                         <input type="text" id="txtArrAddress" value="收货地址：" readonly size="10" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="20%" align="left">
                                                        ...
                                                        <td colspan="3">
                                                            <table width="100%" border="0" cellspacing="1" bgcolor="#000000" id="pageDataList1">
                                                                <tr>
                                                                    ...
                                                                    <td bgcolor="#FFFFFF">
                                                                        <input type="checkbox" name="ckdPackage" id="ckdPackage" value="Package" /><input
                                                                            type="text" id="Package" value="包装要求" readonly size="10" />
                                                                    </td>
                                    ...
                                    <input type="hidden" id="HiddenPrice" runat="server" /><!--是否显示单价金额-->
...
<script language="javascript">
    ...
    function ShowPrintSetting() 
    {
        ...
        //LoadBillData();
        LoadExtTableName('officedba.StorageOutSell');
...
function isDisplayPrice()
{
    ...
    function LoadPrintSettingInfo() {
        ...
        var dbBase = new Array(
                                ...
                                ['ckFromBillID', 'FromBillNo'],//源单编号
                                ['ckCustName', 'CustName'],//客户名称
                                ['ckSellDept', 'SellDeptName'],//销售部门
                                ['ckSeller', 'SellerName'],//业务员
                                ['ckSendAddress', 'SendAddr'],//发货地址
                                ['ckArrAddress', 'ReceiveAddr'],//收货地址
                                ['ckUserSender', 'SenderName'],//经办人
        ...
        if(HiddenUnit=="True")
        {
            dbDetail = new Array(['ckdSortNo', 'SortNo'],//序号
                                 ...
                                 ['ckdPackage', 'Package'],//包装要求
                                 ['ckdBaseUnit', 'UnitID'],//基本单位
                                 ['ckdBaseCount', 'ProductCount'],//基本数量
                                 ['ckStorageName', 'StorageName'],//仓库
                                 ['ckdNoteCount', 'FromBillCount'],//通知数量
                                 ['ckdHaveOutCount', 'OutCount'],//已出库数量
                                 ['ckdNotOutCount', 'NotOutCount'],//未出库数量
                                 ['ckdOutCount', 'UsedUnitCount'],//出库数量
        ...
        else
        {
            dbDetail = new Array(['ckdSortNo', 'SortNo'],//序号
                                 ...
                                 ['ckdPackage', 'Package'],//包装要求
//                                 ['ckdBaseUnit', 'BaseUnit'],//基本单位
//                                 ['ckdBaseCount', 'BaseCount'],//基本数量
                                 ['ckStorageName', 'StorageName'],//仓库
                                 ['ckdNoteCount', 'FromBillCount'],//通知数量
                                 ['ckdHaveOutCount', 'OutCount'],//已出库数量
                                 ['ckdNotOutCount', 'NotOutCount'],//未出库数量
                                 ['ckdOutCount', 'ProductCount'],//出库数量
    ...
    function SavePrintSetting() {
        ...
        var strBaseFields = "";
        var strDetailFields = "";
        var toLocation='StorageOutSellPrint.aspx?ID=' + intMrpID;
        var hidBillTypeFlag = document.getElementById('hidBillTypeFlag').value;
        var hidPrintTypeFlag = document.getElementById('hidPrintTypeFlag').value;
        ...
        if (document.getElementById('ckFromBillID').checked) strBaseFields = strBaseFields + "FromBillNo|";
        if (document.getElementById('ckCustName').checked) strBaseFields = strBaseFields + "CustName|";
        if (document.getElementById('ckSellDept').checked) strBaseFields = strBaseFields + "SellDeptName|";
        if (document.getElementById('ckSeller').checked) strBaseFields = strBaseFields + "SellerName|";
        if (document.getElementById('ckSendAddress').checked) strBaseFields = strBaseFields + "SendAddr|";
        if (document.getElementById('ckArrAddress').checked) strBaseFields = strBaseFields + "ReceiveAddr|";
        if (document.getElementById('ckUserSender').checked) strBaseFields = strBaseFields + "SenderName|";
        ...
        if (document.getElementById('ckdPackage').checked) strDetailFields = strDetailFields + "Package|";
        ...
        if(HiddenUnit=="True")
        {
            ...
            if (document.getElementById('ckdOutCount').checked) strDetailFields = strDetailFields + "UsedUnitCount|";
        ...
        else
        {
           ...
           // if (document.getElementById('ckdBaseCount').checked) strDetailFields = strDetailFields + "BaseCount|";
            ...
            if (document.getElementById('ckdOutCount').checked) strDetailFields = strDetailFields + "ProductCount|";
        ...
        if (document.getElementById('ckdNoteCount').checked) strDetailFields = strDetailFields + "FromBillCount|";
        if (document.getElementById('ckdHaveOutCount').checked) strDetailFields = strDetailFields + "OutCount|";
        if (document.getElementById('ckdNotOutCount').checked) strDetailFields = strDetailFields + "NotOutCount|";
