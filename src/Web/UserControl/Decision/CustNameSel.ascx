<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustNameSel.ascx.cs" Inherits="UserControl_Decision_CustNameSel" %>
...
<input onclick="SearchCustData();" id="txtUcCustName" style="width:120px;"  type="text" class="tdinput" readonly/>
...
<table width="99%" border="0" align="center" cellpadding="0" id="Table1"  cellspacing="0" >
    ...
    <tbody>
      <tr>
        ...
        <th align="center" background="../../../images/Main/Table_bg.jpg" bgcolor="#FFFFFF"><div class="orderClick" onclick="OrderByUc('CustShort','oCustShort');return false;">拼应缩写<span id="oCustShort" class="orderTip"></span></div></th>        
