<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ProductInfoControl.ascx.cs"
    Inherits="UserControl_Decision_ProductInfoControl" %>
...
<!--提示信息弹出详情start-->
<div id="divzhezhao1" style="filter: Alpha(opacity=0); width: 93%; padding: 1px;top:10px;
    height:300px; z-index: 199; position: absolute; display: none;">
    <iframe style="border: 0; width: 100%; height: 100%; position: absolute;"></iframe>
</div>

<div id="divStorage1Product" style="border: solid 8px #93BCDD; background: #fff; padding: 10px;
    width: 93%; top:10px; z-index: 200; position: absolute; display:none ;">
    <div id="divquery">
        <table width="100%">
            <tr>
                <td>
                    <%-- <a onclick="closeProductdiv('divStorage1Product')" style="text-align: right; cursor: pointer">关闭</a>--%>
                                    ...
                                    <tr class="table-item">
                                     ...
                                     <tr class="table-item">
                                      ...
                                      <td width="10%" bgcolor="#E7E7E7" align="right">
                                        ...
                                        <td width="23%" bgcolor="#FFFFFF">
                                            <asp:DropDownList ID="sel_Material"
                                                runat="server">
                                            </asp:DropDownList>
                                        </td>
                                        <td width="10%" height="20" bgcolor="#E7E7E7" align="right">
                                        ...
                                        <td width="24%" bgcolor="#FFFFFF">
                                            <input type="text" id="txt_StartStorage" class="tdinput" size="10" maxlength="15"/>至 <input type="text" id="txt_EndStorage" class="tdinput" size="10" maxlength="15"/>
                                        </td>
                                    </tr>
...
<script language="javascript">
    ...
    function Hidebtn() {
        document.getElementById('divStorage1Product').style.display = 'block';
        ...
        AlertProductMsg();
        Fun_Search_Product();
        PCenterToDocument("divStorage1Product", false);
    }
    popTechObj.ShowListCheckSpecial = function(objInput, CheckSpecial) {
        ...
        //PCenterToDocument("divStorage1Product",true);
    }
    var ProdNo = "";
    var ProdName = "";
    var PYShort = "";
                ...
                $.each(msg.data, function(i, item) {
                    if (item.ID != null && item.ID != "") {
                        ...
                        if (popTechObj.Special != null) {
                            tempOnclick = "" + item.ID + ",'" + item.ProdNo + "','" + item.ProductName + "','" + item.StandardSell + "','" + item.UnitID + "','" + item.CodeName + "','" + item.TaxRate + "','" + item.SellTax + "','" + item.Discount + "','" + item.Specification + "','" + item.CodeTypeName + "','" + item.TypeID + "','" + item.StandardCost + "','" + item.Source + "'";
                        }
                        else {
                            tempOnclick = "" + item.ID + ",'" + item.ProdNo + "','" + item.ProductName + "','" + item.StandardSell + "','" + item.UnitID + "','" + item.CodeName + "','" + item.TaxRate + "','" + item.SellTax + "','" + item.Discount + "','" + item.Specification + "','" + item.CodeTypeName + "','" + item.TypeID + "','" + item.StandardBuy + "','" + item.TaxBuy + "','" + item.InTaxRate + "','" + item.StandardCost + "'";
                        }
    ...
    function closeProductdiv() {
        document.getElementById("divStorage1Product").style.display = "none";
        ...
        var divStorage1Product = document.getElementById("divStorage1Product");
        document.body.removeChild(ProductBigDiv);
        divStorage1Product.style.display = "none";
