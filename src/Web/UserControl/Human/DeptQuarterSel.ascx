<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DeptQuarterSel.ascx.cs" Inherits="UserControl_Human_DeptQuarterSel" %>
...
/// <param name="enableLinkage">是否启用联动效果(1:启用；0:禁用,默认：1)</param>
   ...
   treeveiwPopUp = new TreeView("treeDiv",nodes,0,0,2,1,0,1,0);
