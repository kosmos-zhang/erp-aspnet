...
$.formValidator = 
{
	...
	showMessage : function(returnObj)
	{
		...
		{		
			...
			if(!intiConfig.alertmessage)
			{
				var showmsg = $.formValidator.isEmpty(id) ? setting.onempty : setting.oncorrect;
			    $.formValidator.setTipState(elem,"onSuccess",showmsg);
			}
		}
	},
	...
	ajaxValid : function(returnObj)
	{
		...
		{	
			...
			success : function(data){
			    ...
			    {
			        $.formValidator.setTipState(elem,"onSuccess",settings[0].oncorrect);
			        setting.isvalid = true;
			    }
			    else
			    {
	...
	return this.each(function()
	{
		...
		{   
			...
			if(!$.formValidator.getInitConfig(settings[0].validatorgroup).alertmessage){
				var ls_style = onshow ? "onShow" : "onSuccess";
