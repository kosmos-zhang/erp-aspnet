...
$(document).ready(function() {
   TurnToPage(1);
    ...
    {
         action = "ReportCustArea";//客户分类对比
         currentPageIndex = pageIndex;
         requestobj = GetRequest(); 
         var CustTypeID = requestobj['XValue'];
         ...
         var EndDate = requestobj['EndDate'];
           ...
           cache:false,
           data: "pageIndex="+currentPageIndex+"&pageCount="+pageCount+"&action="+action+"&orderby="+orderBy+"&CustTypeID="+reescape(CustTypeID)+"&CustTypeManage="+reescape(CustTypeManage)+
                    "&CustTypeSell="+reescape(CustTypeSell)+"&CustTypeTime="+reescape(CustTypeTime)+"&CustType="+reescape(CustType)+"&CustClass="+reescape(CustClass)+"&RelaGrade="+reescape(RelaGrade)+"&CreditGrade="+reescape(CreditGrade)+
