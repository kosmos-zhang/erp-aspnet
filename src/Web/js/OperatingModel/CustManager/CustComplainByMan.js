...
function TurnToPage(pageIndex)
{
       ...
       var ComplainMan =$("#ComplainMan").val();//客户管理分类
       ...
       action="complainbyman";
       
       Condition= "orderby="+orderBy+"&ComplainMan="+escape(ComplainMan)+"&StartDate="+escape(StartDate)+"&EndDate="+escape(EndDate);
...
{  
    ...
    for(var i=0;i<data.list.length;i++)
    {
        ...
        "<td height='22' align='center'>" +data.list[i]["ComplainNum"]+ "</td>"+
        "</tr>"
...
{   
    ...
    window.open("CustComplainByManPrint.aspx?" + Url);
}