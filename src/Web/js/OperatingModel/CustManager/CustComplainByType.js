...
function TurnToPage(pageIndex)
{
      ...
      // var CustName =FormatStr($("#CustName").val());//客户管理分类
       ...
       action="complainbytype";
       
       Condition= "orderby="+orderBy+"&ComplainType="+escape(ComplainType)+"&StartDate="+escape(StartDate)+"&EndDate="+escape(EndDate);
...
{   
    ...
    window.open("CustComplainByTypePrint.aspx?" + Url);
}