...
function TurnToPage(pageIndex)
{
       ...
       Condition= "orderby="+orderBy+"&CustName="+escape(CustName)+"&StartDate="+escape(StartDate)+"&EndDate="+escape(EndDate);
...
{  
    ...
    for(var i=0;i<data.list.length;i++)
    {
        ...
        "<td height='22' align='center'>" +data.list[i]["ContactNo"]+ "</td>"+
        ...
        "<td height='22' align='center'>"+data.list[i]["LinkManName"]+"</td>"+
        "<td height='22' align='center'>"+data.list[i]["LinkDate"]+"</td>"+
        "</tr>"
...
{   
    ...
    window.open("CustContactListPrint.aspx?" + Url);
}