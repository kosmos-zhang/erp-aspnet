...
function TurnToPage(pageIndex)
{
       ...
       action="ContactLinker";
       
       Condition= "orderby="+orderBy+"&CustName="+escape(CustName)+"&LinkerId="+LinkerId+"&StartDate="+escape(StartDate)+"&EndDate="+escape(EndDate);
...
{   
    ...
    window.open("CustContactByLinkerPrint.aspx?" + Url);
}