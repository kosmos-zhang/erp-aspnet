...
function TurnToPage(pageIndex)
{
       ...
       var ReasonId=document.getElementById("ReasonId1").value;
       ...
       action="ContactReason";
       
       Condition= "orderby="+orderBy+"&CustName="+escape(CustName)+"&ReasonId="+ReasonId+"&StartDate="+escape(StartDate)+"&EndDate="+escape(EndDate);
...
{   
    ...
    window.open("CustContactByReasonPrint.aspx?" + Url);
}