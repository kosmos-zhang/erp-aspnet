...
$(document).ready(function() {
   TurnToPage(1);
    ...
    {
         action = "ReportCreditGrade";//客户分类对比
         ...
         var EndDate = requestobj['EndDate'];
           ...
           data: "pageIndex="+currentPageIndex+"&pageCount="+pageCount+"&action="+action+"&orderby="+orderBy+"&CustTypeID="+reescape(CustTypeID)+"&CustTypeManage="+reescape(CustTypeManage)+
                    "&CustTypeSell="+reescape(CustTypeSell)+"&CustTypeTime="+reescape(CustTypeTime)+"&CustType="+reescape(CustType)+"&CustClass="+reescape(CustClass)+"&RelaGrade="+reescape(RelaGrade)+"&Area="+reescape(Area)+
