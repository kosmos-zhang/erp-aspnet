...
function TurnToPage(pageIndex)
{
       ...
       Condition= "orderby="+orderBy+"&CustName="+escape(CustName)+"&LoveType="+escape(LoveType)+"&StartDate="+escape(StartDate)+"&EndDate="+escape(EndDate);
...
{  
    ...
    for(var i=0;i<data.list.length;i++)
    {
        ...
        "<td height='22' align='center'>" +data.list[i]["LoveNO"]+ "</td>"+
        ...
        "<td height='22' align='center'>" +data.list[i]["LoveDate"]+ "</td>"+
        "</tr>"
...
{   
    ...
    window.open("CustLoveListPrint.aspx?" + Url);
}