...
function TurnToPage()
{
   ...
   url:  '../../../Handler/OperatingModel/CustManager/CustRelaGrade.ashx',//目标地址
   cache:false,
   ...
   success: function(msg){
            ...
            $.each(msg.data,function(i,item){                
             ...
             {
                $("<tr class='newrow'></tr>").append("<td height='22' align='center'>" + item.RelaGrade + "</td>"+
...
function pageSetup()
{
    ...
    window.open("CustRelaGradePrint.aspx?" + Url);
}
