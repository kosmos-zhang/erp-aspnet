...
function TurnToPage(pageIndex)
{
       ...
       var Executant =$("#Executant").val();//客户管理分类
       ...
       Condition= "orderby="+orderBy+"&Executant="+escape(Executant)+"&StartDate="+escape(StartDate)+"&EndDate="+escape(EndDate);
...
{   
    ...
    window.open("CustServiceByManPrint.aspx?" + Url);
}