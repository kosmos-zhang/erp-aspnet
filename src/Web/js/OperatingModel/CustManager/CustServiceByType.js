...
function TurnToPage(pageIndex)
{
      ...
      // var CustName =FormatStr($("#CustName").val());//客户管理分类
       ...
       action="servicebytype";
       
       Condition= "orderby="+orderBy+"&ServeType="+escape(ServeType)+"&StartDate="+escape(StartDate)+"&EndDate="+escape(EndDate);
...
{   
    ...
    window.open("CustServiceByTypePrint.aspx?" + Url);
}