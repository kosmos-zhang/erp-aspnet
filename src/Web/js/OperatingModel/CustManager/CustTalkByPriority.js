...
function TurnToPage(pageIndex)
{
       ...
       var Priority =$("#Priority").val();//客户管理分类
       ...
       action="talkbypriority";
       
       Condition= "orderby="+orderBy+"&CustName="+escape(CustName)+"&Priority="+escape(Priority)+"&StartDate="+escape(StartDate)+"&EndDate="+escape(EndDate);
...
{   
    ...
    window.open("CustTalkByPriorityPrint.aspx?" + Url);
}