...
function TurnToPage(pageIndex)
{
       ...
       Condition= "orderby="+orderBy+"&CustName="+escape(CustName)+"&TalkType="+escape(TalkType)+"&StartDate="+escape(StartDate)+"&EndDate="+escape(EndDate);
...
{   
    ...
    window.open("CustTalkByTypePrint.aspx?" + Url);
}