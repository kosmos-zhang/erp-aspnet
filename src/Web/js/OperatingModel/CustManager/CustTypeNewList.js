    ...
    function TurnToPage(pageIndex)
    {
         ...
         var EndDate = requestobj['EndDate'];
           ...
           data: "pageIndex="+currentPageIndex+"&pageCount="+pageCount+"&action="+action+"&orderby="+orderBy+"&CustTypeID="+reescape(CustTypeID)+"&CustTypeManage="+reescape(CustTypeManage)+
                    "&CustTypeSell="+reescape(CustTypeSell)+"&CustTypeTime="+reescape(CustTypeTime)+"&CustClass="+reescape(CustClass)+"&Area="+reescape(Area)+"&RelaGrade="+reescape(RelaGrade)+"&CreditGrade="+reescape(CreditGrade)+
