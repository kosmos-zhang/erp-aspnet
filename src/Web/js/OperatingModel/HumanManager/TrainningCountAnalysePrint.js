  $(document).ready(function(){
    ...
    var SearchEmployee = requestobj['EmployeeID'];
    var StartDate = requestobj['DateBegin'];
    var StartToDate = requestobj['DateEnd'];
    var EndDate = requestobj['DateB'];
    var EndToDate = requestobj['DateE']; 
    ...
    { 
    document .getElementById ("hdPara").value="deptid="+escape (deptid)+"&EmployeeName="+escape ( EmployeeName)+"&EmployeeID="+escape ( SearchEmployee) +"&DateBegin="+escape (StartDate)+"&DateEnd="+escape ( StartToDate)+"&DateB="+escape (EndDate)+"&DateE="+escape ( EndToDate) ;  
...
//       document.getElementById("hdPara").value = "orderby="+orderBy+"&quterID="+escape(quterID)+"&QuaterAdmin="+escape (QuaterAdmin)  ;
      ...
      action ="TrainningCountAnalysePrint_Select";
       $.ajax({
       type: "POST",//用POST方式传输
                ...
                $("#pageDataList1 tbody").find("tr.newrow").remove();
                  ...
                  if(item.DeptID != null && item.DeptID != "")
                 {
                    ...
                    "<td height='22' align='center'>"+ item.EmployeeName +"</td>"+ 
                        "<td height='22' align='center'>" + item.TeacherName + "</td>"+   
