...
//    var strRul = $("#hiddSearch").val();
    window.open("PurchaseArriveQueryPrint.aspx?pageIndex="+currentPageIndex+"&pageCount="+pageCount+"&orderby="+orderBy+"&ProviderID="+escape(ProviderID)+
...
//           var EndConfirmDate = document.getElementById("txtEndConfirmDate").value;
           ...
           url:  '../../../Handler/OperatingModel/PurchaseManager/PurchaseArriveQuery.ashx',//目标地址
           cache:false,
...
//                        "<td height='22' align='center'><a href='" + GetLinkParam(ProductID) +"&ProductID=" + item.ProductID + " ')>"+item.ProductNo+"</a></td>"+
                        ...
                        "<td height='22' align='center'>"+ item.ArriveNo +"</a></td>"+
                        ...
                        "<td height='22' align='center'>"+ FormatAfterDotNumber(item.RealTotal,2) +"</a></td>").appendTo($("#pageDataList1 tbody"));
                        }
