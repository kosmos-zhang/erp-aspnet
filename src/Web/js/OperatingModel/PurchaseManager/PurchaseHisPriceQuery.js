...
//    var strRul = $("#hiddSearch").val();
    window.open("PurchaseHisPriceQueryPrint.aspx?pageIndex="+currentPageIndex+"&pageCount="+pageCount+"&orderby="+orderBy+"&ProductID="+escape(ProductID)+
...
//           var EndConfirmDate = document.getElementById("txtEndConfirmDate").value;
           ...
           url:  '../../../Handler/OperatingModel/PurchaseManager/PurchaseHisPriceQuery.ashx',//目标地址
           cache:false,
...
//                        "<td height='22' align='center'><a href='" + GetLinkParam(ProductID) +"&ProductID=" + item.ProductID + " ')>"+item.ProductNo+"</a></td>"+
                        ...
                        "<td height='22' align='center'>"+ item.ProductID +"</a></td>"+
