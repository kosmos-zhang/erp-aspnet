...
//    var strRul = $("#hiddSearch").val();
    window.open("PurchaseProviderCountPrint.aspx?pageIndex="+currentPageIndex+"&pageCount="+pageCount+"&orderby="+orderBy+"&ProviderID="+escape(ProviderID)+
...
//            var EndOrderDate = document.getElementById("txtEndOrderDate").value;
           ...
           url:  '../../../Handler/OperatingModel/PurchaseManager/PurchaseProviderCount.ashx',//目标地址
           cache:false,
...
//                        "<td height='22' align='center'><a href='" + GetLinkParam(ProductID) +"&ProductID=" + item.ProductID + " ')>"+item.ProductNo+"</a></td>"+
                        ...
                        "<td height='22' align='center'>"+ FormatAfterDotNumber(item.TotalTax,2) +"</a></td>").appendTo($("#pageDataList1 tbody"));
                        }
