...
//    var strRul = $("#hiddSearch").val();
    window.open("PurchaseRejectQueryPrint.aspx?pageIndex="+currentPageIndex+"&pageCount="+pageCount+"&orderby="+orderBy+"&ProviderID="+escape(ProviderID)+
...
//           var EndConfirmDate = document.getElementById("txtEndConfirmDate").value;
           ...
           url:  '../../../Handler/OperatingModel/PurchaseManager/PurchaseRejectQuery.ashx',//目标地址
           cache:false,
...
//                        "<td height='22' align='center'><a href='" + GetLinkParam(ProductID) +"&ProductID=" + item.ProductID + " ')>"+item.ProductNo+"</a></td>"+
                        ...
                        "<td height='22' align='center'>"+ item.RejectNo +"</a></td>"+
                        ...
                        "<td height='22' align='center'>"+ FormatAfterDotNumber(item.TotalYthkhj,2) +"</a></td>").appendTo($("#pageDataList1 tbody"));
                        }
