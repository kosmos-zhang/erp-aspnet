...
function fnGetSearch() {
    ...
    var type = $("#Type").val();          //业务员ID（对应员工表ID）
    ...
    strUrl = 'startDate=' + escape(startDate) + '&endDate=' + escape(endDate) + '&type=' + escape(type) + '&CurrencyType=' + escape(CurrencyType) + '&CurrencyTypeName=' + escape(CurrencyTypeName);
...
function TurnToPage(pageIndex) {
    ...
    $.ajax({
        type: "POST", //用POST方式传输
        url: '../../../Handler/OperatingModel/SellManager/BillTotal.ashx', //目标地址
...
function PrintSubjectsTotal() {
    ...
    window.open("PrintBillTotal.aspx?" + strRul);
}
