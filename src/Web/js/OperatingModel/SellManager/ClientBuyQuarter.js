...
{//检索
    ...
    var CustID=document.getElementById('txtUcCustID').value;
    ...
    var MyData = "pageIndex="+pageIndex+"&pageCount="+pageCount+"&action="+action+"&orderBy="+orderBy+
                     "&CustID="+escape(CustID)+"&OrderDate="+escape(OrderDate)+"&CurrencyTypeName="+escape(CurrencyTypeName)+"&CurrencyType="+MoneyType; 
    var search = "";
    ...
    $.ajax({
           ...
           url:  '../../../Handler/OperatingModel/SellManager/ClientBuyQuarter.ashx',//目标地址
           cache:false,
           data: MyData,//数据
           ...
           success: function(msg){
                    ...
                    var j =1;
                      $.each(msg.data,function(i,item){
                        ...
                        "<td height='22' align='right'>" +parseFloat(item.AllTotalPrice).toFixed(2)+ "</td>"+
...
//                           +"<td height='22' align='center'>"+msg.TotalPrice1+"</td>"
//                           +"<td height='22' align='center'>"+msg.TotalPrice2+"</td>"
//                           +"<td height='22' align='center'>"+msg.TotalPrice3+"</td>"
//                             +"<td height='22' align='center'>"+msg.TotalPrice4+"</td><td height='22' align='center'>"+msg.TotalPrice+"</td><td height='22' align='center'></td><td height='22' align='center'></td><td height='22' align='center'></td>").appendTo($("#tblDetailInfo tbody")); 
                             //页码
            ShowPageBar(
...
function PrintSpreadsheetBalanceTotal()
{
    ...
    window.open("PrintClientBuyQuarter.aspx?type=1"+searchStr);
}
function GetFloat(a)
{
   if(a!=null && a!='')
