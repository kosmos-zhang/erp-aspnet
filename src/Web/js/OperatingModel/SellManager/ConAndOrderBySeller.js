...
function fnGetSearch() {
    ...
    strUrl = 'isCon=' + escape(isCon) + '&startDate=' + escape(startDate) + '&endDate=' + escape(endDate) + '&isOrd=' + escape(isOrd) + '&Seller=' + escape(Seller) + '&CurrencyType=' + escape(CurrencyType) + '&CurrencyTypeName=' + escape(CurrencyTypeName);
...
function TurnToPage(pageIndex) {
    ...
    $.ajax({
        type: "POST", //用POST方式传输
        url: '../../../Handler/OperatingModel/SellManager/ConAndOrderBySeller.ashx', //目标地址
...
function PrintSubjectsTotal() {
    ...
    window.open("PrintConAndOrderBySeller.aspx?" + strRul);
}
