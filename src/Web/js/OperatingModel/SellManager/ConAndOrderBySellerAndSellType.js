...
function fnGetSearch() {
    ...
    var Type = $("#SellTypeUC_ddlCodeType").val();          //机会可能性
    ...
    strUrl = 'isCon=' + escape(isCon) + '&startDate=' + escape(startDate) + '&endDate=' + escape(endDate)
             + '&isOrd=' + escape(isOrd) + '&Seller=' + escape(Seller) + '&Type=' + escape(Type) + '&CurrencyType=' + escape(CurrencyType) + '&CurrencyTypeName=' + escape(CurrencyTypeName);
...
function TurnToPage(pageIndex) {
    ...
    $.ajax({
        type: "POST", //用POST方式传输
        url: '../../../Handler/OperatingModel/SellManager/ConAndOrderBySellerAndSellType.ashx', //目标地址
...
function PrintSubjectsTotal() {
    ...
    window.open("PrintConAndOrderBySellerAndSellType.aspx?" + strRul);
}
