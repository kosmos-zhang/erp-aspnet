...
function fnGetSearch() {
    ...
    strUrl = 'isCon=' + escape(isCon) + '&startDate=' + escape(startDate) + '&endDate=' + escape(endDate) + '&isOrd=' + escape(isOrd) + '&CurrencyType=' + escape(CurrencyType) + '&CurrencyTypeName=' + escape(CurrencyTypeName);
...
function TurnToPage(pageIndex) {
    ...
    $.ajax({
        type: "POST", //用POST方式传输
        url: '../../../Handler/OperatingModel/SellManager/ConAndOrderByState.ashx', //目标地址
...
function PrintSubjectsTotal() {
    ...
    window.open("PrintConAndOrderByState.aspx?" + strRul);
}
