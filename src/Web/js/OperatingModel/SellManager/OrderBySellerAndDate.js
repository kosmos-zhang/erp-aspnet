...
function fnGetSearch() {
    ...
    strUrl =  'startDate=' + escape(startDate) + '&endDate=' + escape(endDate)
              + '&Seller=' + escape(Seller) + '&CurrencyType=' + escape(CurrencyType) + '&CurrencyTypeName=' + escape(CurrencyTypeName);
...
function TurnToPage(pageIndex) {
    ...
    $.ajax({
        type: "POST", //用POST方式传输
        url: '../../../Handler/OperatingModel/SellManager/OrderBySellerAndDate.ashx', //目标地址
...
function PrintSubjectsTotal() {
    ...
    window.open("PrintOrderBySellerAndDate.aspx?" + strRul);
}
