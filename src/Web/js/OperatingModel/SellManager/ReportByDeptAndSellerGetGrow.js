...
function fnGetSearch() {
    ...
    strUrl = 'endDate=' + escape(endDate) + '&iCount=' + escape(iCount) + '&SellerId=' + escape(Seller) 
...
function TurnToPage(pageIndex) {
    ...
    $.ajax({
        type: "POST", //用POST方式传输
        url: '../../../Handler/OperatingModel/SellManager/ReportByDeptAndSellerGetGrow.ashx', //目标地址
...
function PrintSubjectsTotal() {
    ...
    window.open("PrintReportByDeptAndSellerGetGrow.aspx?" + strRul);
}
