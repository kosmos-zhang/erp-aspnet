...
function TurnToPage(pageIndex) {
    ...
    $.ajax({
        ...
        url: '../../../Handler/OperatingModel/SellManager/SellBack.ashx', //目标地址
        cache: false,
        data: strUrl,
        ...
        success: function(msg) {
            ...
            if (item.BackNo != null && item.BackNo != "") {
                var BackNo = item.BackNo;
                ...
                if (BackNo != null) {
                    if (BackNo.length > 15) {
                        BackNo = BackNo.substring(0, 15) + '...';
                    }
                }
                   $("<tr class='newrow'></tr>").append("<td height='22' align='center'>" + BackNo + "</td>" +
                    ...
                    "<td height='22' align='center'><span title=\"" + item.EmployeeName + "\">" + item.EmployeeName + "</td>" +
