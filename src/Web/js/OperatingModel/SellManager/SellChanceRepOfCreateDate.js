...
function fnGetSearch() {
    ...
    strUrl = '&CreateDate=' + escape(IntendDate) + '&CreateDate1=' + escape(IntendDate1);
...
function TurnToPage(pageIndex) {
    ...
    $.ajax({
        type: "POST", //用POST方式传输
        url: '../../../Handler/OperatingModel/SellManager/SellChanceRepOfCreateDate.ashx', //目标地址
...
function PrintSubjectsTotal() {
    ...
    window.open("PrintSellChanceRepOfCreateDate.aspx?" + strRul);
}
