...
function fnGetSearch() {
    ...
    strUrl = 'Seller=' + escape(Seller) + '&CreateDate=' + escape(FindDate) + '&CreateDate1=' + escape(FindDate1);
...
function TurnToPage(pageIndex) {
    ...
    $.ajax({
        type: "POST", //用POST方式传输
        url: '../../../Handler/OperatingModel/SellManager/SellChanceRepOfCreateDateAndSeller.ashx', //目标地址
...
function PrintSubjectsTotal() {
    ...
    window.open("PrintSellChanceRepOfCreateDateAndSeller.aspx?" + strRul);
}
