...
function fnGetSearch() {
    ...
    strUrl = 'Feasibility=' + escape(Feasibility) + '&FindDate=' + escape(FindDate) + '&FindDate1=' + escape(FindDate1) + '&State=' + escape(State);
...
function TurnToPage(pageIndex) {
    ...
    $.ajax({
        type: "POST", //用POST方式传输
        url: '../../../Handler/OperatingModel/SellManager/SellChanceRepOfStateAndFeasibility.ashx', //目标地址
...
function PrintSubjectsTotal() {
    ...
    window.open("PrintSellChanceRepOfStateAndFeasibility.aspx?" + strRul);
}
