...
{//检索
    ...
    var MyData = "pageIndex="+pageIndex+"&pageCount="+pageCount+"&action="+action+"&orderBy="+orderBy+
                     "&BeginTime="+escape(BeginTime)+"&EndTime="+escape(EndTime)+"&CurrencyType="+escape(MoneyType)+"&CurrencyTypeName="+escape(CurrencyTypeName); 
    var search = "";
    ...
    $.ajax({
           ...
           url:  '../../../Handler/OperatingModel/SellManager/SellProductReport.ashx',//目标地址
           cache:false,
           data: MyData,//数据
           ...
           success: function(msg){
                    ...
                    var j =1;
                      $.each(msg.data,function(i,item){
                        ...
                        $("<tr class='newrow'></tr>").append("<td height='22' align='center'>"+item.ProNo+"</td>"+
                        "<td height='22' align='center' style='display:none'>"+(j++)+"</td>"+                                                
                        "<td height='22' align='center'><span title=\""+item.ProductName+"\">" +item.ProductName+ "</span></td>"+
//                        "<td height='22' align='right'>"+ parseFloat(item.StandardSell).toFixed(2) +"</td>"+
//                        "<td height='22' align='right'>"+parseFloat(item.SellTax).toFixed(2) +"</td>"+
                        "<td height='22' align='right'>"+parseFloat(item.ProductCount).toFixed(2) +"</td>"+
                        "<td height='22' align='right'>"+ parseFloat(item.TaxBuy).toFixed(2) +"</td>"+
                        "<td height='22' align='right'>"+ parseFloat(item.StandardBuy).toFixed(2) +"</a></td>"+
                        ...
                        "<td height='22' align='center'>"+ item.Flag +"</a></td>"+                         
                        "<td height='22' align='center'>"+ parseFloat((item.StandardBuy/item.Tot)*100).toFixed(2)+'%'+"</td>").appendTo($("#tblDetailInfo tbody"));                      
                        
                   });
//                   if(msg.totalCount>0)
//                   {
//                     $("<tr class='newrow' ></tr>").append("<td height='22' align='center'></td><td height='22' align='center'>合计</td>"
//                           +"<td height='22' align='center'>"+msg.TotalStandardSell+"</td>"
//                           +"<td height='22' align='center'>"+msg.TotalSellTax+"</td>"
//                           +"<td height='22' align='center'>"+msg.TotalProductCount+"</td>"
//                           +"<td height='22' align='center'>"+msg.TotalTaxBuy+"</td>"
//                           +"<td height='22' align='center'>"+msg.TotalStandardBuy+"</td><td height='22' align='center'></td><td height='22' align='center'></td><td height='22' align='center'></td><td height='22' align='center'></td><td height='22' align='center'></td><td height='22' align='center'></td><td height='22' align='center'></td>").appendTo($("#tblDetailInfo tbody")); 
//                    }
                             //页码
            ShowPageBar(
...
function PrintSpreadsheetBalanceTotal()
{
    ...
    window.open("PrintSellProductReport.aspx?type=1"+searchStr);
}
function GetFloat(a)
{
   if(a!=null && a!='')
