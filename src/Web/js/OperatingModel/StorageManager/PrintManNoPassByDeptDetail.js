...
{//检索
    ...
    var MyData = "pageIndex="+pageIndex+"&pageCount="+pageCount+"&ProductID="+ProductID+"&BeginDate="+BeginDate+"&orderby="+orderBy+"&EndDate="+EndDate+"&DeptID="+DeptID;             
                 
   
    $.ajax({
           type: "POST",//用POST方式传输
           dataType:"json",//数据格式:JSON
           url:  '../../../Handler/OperatingModel/StorageManager/PrintManNoPassByDeptDetail.ashx',//目标地址
           cache:false,
            data: MyData,//数据
           ...
           success: function(msg){
                    ...
                    if(parseFloat(item.NoPassCount)>0){
