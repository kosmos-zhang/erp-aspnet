...
{//检索
    ...
    var MyData = "pageIndex="+pageIndex+"&pageCount="+pageCount+"&ProductID="+ProductID+"&BeginDate="+BeginDate+"&orderby="+orderBy+"&EndDate="+EndDate+"&ProviderID="+ProviderID;             
                 
   
    $.ajax({
           type: "POST",//用POST方式传输
           dataType:"json",//数据格式:JSON
           url:  '../../../Handler/OperatingModel/StorageManager/PrintNoPassByProviderDetail.ashx',//目标地址
           cache:false,
            data: MyData,//数据
           ...
           success: function(msg){
                    ...
                    if(parseFloat(item.ProductCount)>0){
                        $("<tr class='newrow'></tr>").append("<td height='22' align='center'>"+item.ArriveNo+"</td>"+
                        ...
                        "<td height='22' align='center'>"+  item.NotPassNum +"</td>").appendTo($("#pageDataList1 tbody"));}
                   });
                    //页码
