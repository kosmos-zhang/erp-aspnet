...
{//检索
    ...
    var MyData = "pageIndex="+pageIndex+"&XValue="+escape(XValue)+"&Method="+Method+"&pageCount="+pageCount+"&ProductID="+ProductID+"&BeginDate="+BeginDate+"&orderby="+orderBy+"&EndDate="+EndDate+"&ProviderID="+ProviderID;             
                 
   
    $.ajax({
           type: "POST",//用POST方式传输
           dataType:"json",//数据格式:JSON
           url:  '../../../Handler/OperatingModel/StorageManager/PrintNoPassPurTendencyDetail.ashx',//目标地址
           cache:false,
            data: MyData,//数据
