...
function DoSearch(currPage)
{
 ...
 /*-----------------------------------------DoSearch结束----------------------------------------------*/
    ...
    function TurnToPage0(pageIndex)
    {
           ...
           url:  '../../../Handler/OperatingModel/StorageManager/ProductInOutInfoInStock.ashx',//目标地址
           data:UrlParam,
           cache:false,
                    ...
                    if (msg.data.length != 0)
                    {
                        ...
                        $.each(msg.data,function(i,item){
                            if(item.ProdNo != null && item.ProdNo != "")
                            {
                                ...
                                "<td height='22' align='center'>"+NumRound(item.Tax_TotalPrice,2)+"</td>").appendTo($("#pageDataList1 tbody"));
...
function fnPrint() {
    ...
    window.open("PrintProductInOutInfoInStock.aspx?order="+order+"&" + strRul);
}
