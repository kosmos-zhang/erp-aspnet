...
function DoSearch(currPage)
{
 ...
 /*-----------------------------------------DoSearch结束----------------------------------------------*/
    ...
    function TurnToPage0(pageIndex)
    {
           ...
           url:  '../../../Handler/OperatingModel/StorageManager/StockProductSellDetail.ashx',//目标地址
           data:UrlParam,
           cache:false,
           ...
           success: function(msg){
                    ...
                    if (msg.data.length != 0)
                    {
                        ...
                        $.each(msg.data,function(i,item){
                            if(item.OutNo != null && item.OutNo != "")
                            {
                                $("<tr class='newrow'></tr>").append("<td height='22' align='center'>"+ item.OutNo +"</a></td>"+
                                ...
                                "<td height='22' align='center'>"+NumRound(item.UnitPrice,2)+"</td>").appendTo($("#pageDataList1 tbody"));
...
function fnPrint() {
    ...
    window.open("PrintStockProductSellDetail.aspx?order="+order+"&" + strRul);
}
