           ...
           {    
                   ...
                   $.each(msg.data,function(i,item){
                        ...
                        $("<tr class='newrow'></tr>").append(
                            ...
                            "<td align=\"center\" ><a href=\"../../office/StorageManager/StorageBorrowAdd.aspx?ModuleID="+document.getElementById("MoudleID").value+"&action=EDIT&id="+item.ID+"&BorrowRealNo="+item.BorrowNo+"\">"+item.BorrowNo+"</a></td>"+
