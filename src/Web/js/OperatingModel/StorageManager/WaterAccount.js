...
//   }
 ...
 /*-----------------------------------------DoSearch结束----------------------------------------------*/
    ...
    function TurnToPage(pageIndex)
    {
           ...
           url:  '../../../Handler/OperatingModel/StorageManager/WaterAccount.ashx',//目标地址
           cache:false,
           data:UrlParam,
                    ...
                    if (msg.data.length != 0)
                    {
                        ...
                        $.each(msg.data,function(i,item){
                            if(item.BillNo != null && item.BillNo != "")
                            {
                                ...
                                "<td height='22' align='center' title=\""+item.ProductCount+"\">"+NumRound(item.ProductCount,point)+"</td>"+
