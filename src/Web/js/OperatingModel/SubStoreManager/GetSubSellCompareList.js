...
{//检索
    ...
    var MyData = "pageIndex="+pageIndex+"&pageCount="+pageCount+"&DeptID="+DeptID+"&BeginDate="+BeginDate+"&orderby="+orderBy+"&EndDate="+EndDate;             
                 
   
    $.ajax({
           type: "POST",//用POST方式传输
           dataType:"json",//数据格式:JSON
           url:  '../../../Handler/OperatingModel/SubStoreManager/GetSubSellCompareList.ashx',//目标地址
           cache:false,
            data: MyData,//数据
           ...
           success: function(msg){
                    ...
                    $.each(msg.data,function(i,item){
                        ...
                        "<td height='22' align='center'>"+FormatData(item.TotalPrice) +"</a></td>").appendTo($("#pageDataList1 tbody"));}
                   });
                    //页码
