...
function TurnToPage(pageIndex) {
   ...
   var flag=$("#hf_flag").val();
    ...
    $.ajax({
        type: "POST", //用POST方式传输
        url: '../../../Handler/OperatingModel/SubStoreManager/ProductSellDetail.ashx', //目标地址
            ...
            if (msg != null) {
                if (msg.data.length != 0) {
                   ...
                   if(item.DeptName != null && item.DeptName != ""){
                    var Fee=parseFloat(item.SellTotalFee);var temp='';if(flag!='0')temp="<td height='22' align='center'>" + item.DeptName + "</td>";
                        ...
                        + "<td height='22' align='center'>" + item.OrderDate+ "</td>"
                           + "<td height='22' align='center'>" + item.OrderNo + "</td>"
                              + "<td height='22' align='center'>" + item.flag + "</td>"
...
function PrintSubjectsTotal() {
   if(ordering=="a")
    ...
    window.open("PrintOfficeProductSellDetail.aspx?orderby="+orderBy+"&ordering="+ordering+"&" + strRul);
