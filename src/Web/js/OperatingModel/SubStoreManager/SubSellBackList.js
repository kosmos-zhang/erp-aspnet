...
function TurnToPage(pageIndex)
{
    ...
    var URLParams = "pageIndex="+pageIndex+"&pageCount="+currentpageCount+"&action="+action+
                    "&EFIndex="+"&EFDesc="+"&orderby="+orderBytt+"&"+document.getElementById("SearchCondition").value;
    ...
    success: function(msg){
            ...
            $.each(msg.data,function(i,item){
                ...
                "<td height='22' align='center' id=\"backno"+j+"\" title=\""+item.BackNo+"\"><a href='#' onclick=fnToEdit('"+item.ID+"')>"+ GetStandardString(item.BackNo,15) +"</td>"+
                ...
                "<td height='22' align='center' id='BusiStatusName"+j+"' class=\""+ item.BusiStatusName +"\"><a href='#' onclick=fnToEdit('"+item.ID+"')>"+item.BusiStatusName+"</a></td>").appendTo($("#pageDataList1 tbody"));
           });
            //页码
