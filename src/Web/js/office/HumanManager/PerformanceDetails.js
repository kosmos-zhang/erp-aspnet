...
if (  document.getElementById("hidSearchCondition").value==="")
{
...
{ 
    ...
    //要素名称
       ...
       // alert (document.getElementById("txtDeptID").value.Trim());
    //启用状态
...
function TurnToPage(pageIndex)
{
    ...
    $.ajax({
        ...
        success: function(msg)
        {
            ...
            $.each(msg.data
                ,function(i,item)
                {
                    ...
                    + "<td height='22' align='center'>" + item.Summaryer + "</td>" //考核任务主题
        ...
        complete:function(){
            ...
            SetTableRowColor("pageDataList1","#E7E7E7","#FFFFFF","#cfc","cfc");
        }
    });
}
/*
