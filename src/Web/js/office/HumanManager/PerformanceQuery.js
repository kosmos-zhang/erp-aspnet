...
{ 
    ...
    search += "&EmployeeID=" + document.getElementById("txtSearchEmployee").value.Trim();
    //启用状态
    search += "&PerTypeID=" + document.getElementById("SelPerType").value.Trim();
     search += "&TaskFlag=" + document.getElementById("selSearchTaskFlag").value.Trim();
       ...
       search += "&AdviceType=" + document.getElementById("SelAdviceType").value.Trim();
...
var orderBy = "EvaluateDate_d";//排序字段
        ...
        success: function(msg)
        {
            ...
            $.each(msg.data
                ,function(i,item)
                {
                    ...
                    $("<tr class='newrow'></tr>").append("<td height='22' align='center'><a href='PerformanceQuery_Edit.aspx?ModuleID=2011809&signDate="+ item.ModifiedUserID.substring(0,10) +" &TemplateNo="+item .CompleteDate+"&EmployeeId="+item .ModifiedDate+"&TaskNo=" + item.TaskNo + "' >" + item.Remark + "</a></td>" 
                    + "<td height='22' align='center'>" + item.Title + "</td>" //考核任务主题
                           ...
                           + "<td height='22' align='center'>" + item.Status +"</td>"
                            + "<td height='22' align='center'>" + item.Creator +"</td>"
                             + "<td height='22' align='center'>" + item.StartDate +"</td>"
                              + "<td height='22' align='center'>" + item.EditFlag +"</td>"
                               + "<td height='22' align='center'>" + item.EndDate +"</td>"
                              + "<td height='22' align='center'>" + item.Summaryer +"</td>"
                                + "<td height='22' align='center'>" + item.SummaryDate.substring(0,10) +"</td>"
                                 + "<td height='22' align='center'>" + item.ModifiedUserID.substring(0,10) +"</td>").appendTo($("#tblDetailInfo tbody")
                          //启用状态
                    );
            });
            //页码
