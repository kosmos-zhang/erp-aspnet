...
function ddds()
{
      // DoModify(document .getElementById ("hidElemID").value,document .getElementById ("hidEmployeId").value);
       DoGetemployeeInfo(document .getElementById ("hidElemID").value.Trim(),document .getElementById ("hidEmployeId").value.Trim(),document .getElementById ("hidTemplateNo").value.Trim());
        var sign=document .getElementById ("hidSign").value.Trim();
        if (sign=="1" )
         {
...
function CheckBaseInfo()
{
    ...
    var KillScore=document.getElementById("inpKillScore").value.Trim();
    var AddScore=document.getElementById("inpAddScore").value.Trim();
    if (""==KillScore )
    {   
       isErrorFlag = true;
       fieldText += "累计扣分|";
...
function GetBaseInfoParams()
{
       ...
       var EmployeeID=document.getElementById("hidEmployeId").value.Trim();
       var TemplateNo=document.getElementById("hidTemplateNo").value.Trim();
       var SignNote=document.getElementById("inpSignNote").value.Trim();
...
function DoBack()
{
 self.location="PerformanceQuery.aspx?ModuleID=2011807"; 
}
