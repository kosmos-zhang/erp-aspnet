        ...
        success: function(msg)
        {
            ...
            $.each(msg.data
                ,function(i,item)
                {
                    ...
                    $("<tr class='newrow'></tr>").append( "<td height='22' align='center'>" + item.DeptName + "</td>" //考核任务主题
                        + "<td height='22' align='center'>" + item.Title + "</td>"
                         + "<td height='22' align='center'>" + item.TaskFlag + "</td>"
                          + "<td height='22' align='center'>" + item.TaskNum+ "</td>"
                            + "<td height='22' align='center'>" + item.LevelType+ "</td>"
                           + "<td height='22' align='center'>" + item.AdviceType +"</td>"
                            + "<td height='22' align='center'>" + item.CountPerson +"</td>").appendTo($("#tblDetailInfo tbody")
                          //启用状态
                    );
            });
            //页码
