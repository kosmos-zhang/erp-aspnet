...
function  getTrueScore ()
{
var totalScore=document .getElementById ("inpTotalScore").innerHTML;
...
if (addScore =="" ||addScore ==null )
{
addScore =0;
}

document .getElementById ("inpSrs").value=parseInt (totalScore ,10)-parseInt (killScore ,10)+parseInt (addScore ,10)
...
function ddds()
{
       DoModify(document .getElementById ("hidElemID").value,document .getElementById ("hidEmployeId").value);
 ...
 function DoModify(taskNo,EmployeId)
{
...
function CheckBaseInfo()
{
    ...
    var KillScore=document.getElementById("inpKillScore").value;
    var AddScore=document.getElementById("inpAddScore").value;
        var AdviceType=document.getElementById("sleAdviceType").value;
    var LevelType=document.getElementById("sleLevelType").value;
    if (AdviceType=="0" )
    {
       isErrorFlag = true;
       fieldText += "建议事项|";
...
function GetBaseInfoParams()
{
       ...
       var AdviceType=document.getElementById("sleAdviceType").value;
       var LevelType=document.getElementById("sleLevelType").value;
       var SummaryNote=document.getElementById("inpSummaryNote").value;//总评
       var AdviceNote=document.getElementById("inpsan").value;//建议说明
       var SumarryRemark=document.getElementById("inpSumarryRemark").value;
       var TotalScore=document.getElementById("inpTotalScore").innerHTML;
       var RewardNote=document.getElementById("inpRewardNote").value;
   //   alert (document.getElementById("hidEmployeId").value+"3");
   var  param = "TaskNo=" + TaskNo;
         param += "&EmployeeID=" + EmployeeID;
         param += "&TemplateNo=" + TemplateNo;
         param += "&KillScore=" + KillScore;
         param += "&AddScore=" + AddScore;
         param += "&AdviceType=" + AdviceType;
         param += "&LevelType=" + LevelType;
         param += "&SummaryNote=" + SummaryNote;
         param += "&SumarryRemark=" + SumarryRemark;
         param += "&RewardNote=" + RewardNote;
         param += "&AdviceNote=" + AdviceNote;
	...
	function DoSave()
{
    ...
    $.ajax({ 
        type: "POST",
        url: "../../../Handler/Office/HumanManager/PerformanceSummary.ashx?action=GatherSummaryInfo&" + postParams,
            ...
            { 
                //设置编辑模式
                 ...
                 document.getElementById("inpTaskNo").style.display="block";
                  ...
                  {
                  //self.location='PerformanceSummarySearch.aspx';         
                  document .getElementById ("btnGather").style.display="none";
...
function DoBack()
{
 self.location="PerformanceSummarySearch.aspx?ModuleID=2011809"; 
}
