...
document.getElementById("selSearchTaskNum").style.display="none";
document.getElementById("selSearchTaskNum").options.length=0;
        ...
        success: function(msg)
        {
            ...
            $.each(msg.data
                ,function(i,item)
                {
                    ...
                    $("<tr class='newrow'></tr>").append("<td height='22' align='center'>"
                        + "<input id='chkSelect' name='chkSelect' value='" + item.TaskNo + "'  type='checkbox'/>" + "</td>" //选择框
                        ...
                        + "<td height='22' align='center'>" + item.TaskNum + "</td>"
                         + "<td height='22' align='center'>" + item.TaskDate + "</td>"
	 ...
	 function DoDelete()
{
 ...
 function DoRun()
{
 self.location='PerformanceTask.aspx?ModuleID=2011802'; 
}
 function DoOut()
{
 self.location="PerformanceTask_Edit.aspx?ModuleID=2011802"+document .getElementById ("hidSearchCondition").value.Trim(); 
}