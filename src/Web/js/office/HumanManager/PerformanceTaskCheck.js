...
function TurnToPage(pageIndex)
{
    ...
    //设置动作种类
    var action="SearchSurmmaryCheckInfo";
        ...
        success: function(msg)
        {
            ...
            $.each(msg.data
                ,function(i,item)
                {
                    ...
                    $("<tr class='newrow'></tr>").append( "<td height='22' align='center'><a href='PerformanceTaskCheck_Edit.aspx?ModuleID=2011807&signDate="+ item.ModifiedUserID.substring(0,10) +" &TemplateNo="+item .CompleteDate+"&EmployeeId="+item .ModifiedDate+"&TaskNo=" + item.TaskNo + "' >" + item.Remark + "</a></td>"//考核任务编号
