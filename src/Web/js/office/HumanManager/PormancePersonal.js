...
function CheckBaseInfo()
{
    ...
    var isErrorFlag = false;
          ...
          aim_codeRule = document.getElementById("AimNum_ddlCodeRule").value;
        //  alert (aim_codeRule);
       // alert (aim_codeRule);
        //手工输入的时候
        if (document.getElementById("hidEditFlag").value=="UPDATE")
        {
        ...
        if ("" == aim_codeRule)
        {
            ...
            //人员编号
           if (""== document.getElementById("AimNum_txtCode").value)
           {
                isErrorFlag = true;
                fieldText += "自我鉴定编号|";
                msgText += "请输入自我鉴定编号|";
           ...
           if ( isnumberorLetters( document.getElementById("AimNum_txtCode").value))
           {
            isErrorFlag = true;
            fieldText += "自我鉴定编号|";
             msgText += "自我鉴定编号只能包含字母或数字！|";
           }
            var num=document.getElementById("AimNum_txtCode").value;
           if (checkstr(num,50))
           {
             isErrorFlag = true;
            fieldText += "自我鉴定编号|";
        ...
        {
            if (isnumberorLetters( document.getElementById("AimNum_ddlCodeRule").value))
          {
            isErrorFlag = true;
            fieldText += "自我鉴定编号编号|";
             msgText += "自我鉴定编号只能包含字母或数字！|";
    ...
    //考核任务主题必须输入
    if (document.getElementById("inptTitle").value == "")
    {
        isErrorFlag = true;
        fieldText += "自我鉴定主题|";
        msgText += "请输入自我鉴定主题|";  
    ...
    {
   var  temp1=document.getElementById("txtStartDate").value;
   ...
   // alert (ss.length);
    ...
    }else
    {
     ...
     var  temp2=document.getElementById("txtEndDate").value;
...
function GetBaseInfoParams()
{
    ...
    //类型ID
    param += "&Title=" + document.getElementById("inptTitle").value;
    //考核类型名称
    param += "&StartDate=" + document.getElementById("txtStartDate").value;
    //启用状态
    param += "&EndDate=" + document.getElementById("txtEndDate").value;
    
    var taskFlag=document.getElementById("selTaskFlag").value;
    var taskNum=document.getElementById("selTaskNum").value;
         var TaskDate=document.getElementById("selTaskYear").value; 
             param += "&TaskDate=" +TaskDate ;
      param += "&TaskFlag=" +taskFlag ;
        param += "&TaskNum=" +taskNum ;
        param += "&Remark=" +document.getElementById("txtRemark").value;
        
        
          param += "&Advices=" +document.getElementById("txtAdvices").value;
            param += "&Problems=" +document.getElementById("txtProblems").value;
              param += "&Defects=" +document.getElementById("txtDefects").value;
                param += "&AfterWork=" +document.getElementById("txtAfterWork").value;
                  param += "&Complete=" +document.getElementById("txtComplete").value;
                    param += "&WorkContent=" +document.getElementById("txtWorkContent").value;
       ...
       // alert (aim_codeRule);
        //手工输入的时候
          ...
          {
            //人员编号
             param += "&TaskNo=" + document.getElementById("AimNum_txtCode").value;
           }
          else
         {
            //编码规则ID
             param += "&CodeRuleID=" + document.getElementById("AimNum_ddlCodeRule").value;
          }
        }else
        {
         param += "&TaskNo=" + document.getElementById("hidElemID").value;
        }
...
{ 
    var search = "";
    //要素名称
    search += "TaskNo=" + document.getElementById("txtSearchTask").value;
    //启用状态
    search += "&Title=" + document.getElementById("inptSearchTitle").value;
     search += "&TaskFlag=" + document.getElementById("selSearchTaskFlag").value;
       search += "&TaskNum=" + document.getElementById("selSearchTaskNum").value;
        search += "&TaskDate=" + document.getElementById("selSearchTaskYear").value;
            ...
            $.each(msg.data, function(i,item){
                //要素名称
                         ...
                         document.getElementById ("inptTitle").value=item.Title;
                          document.getElementById ("txtStartDate").value=item.StartDate.substring(0,9);
                          document.getElementById ("txtEndDate").value=item.EndDate.substring(0,9);
                      document.getElementById ("txtRemark").value=item.Remark;
                      
                      document.getElementById ("txtWorkContent").value=item.WorkContent;
...
if (document.getElementById("hidElemID").value=="")
{
 ...
 function DoRun()
{
 ...
 function DoBack()
{
 self.location='PerformancePersonal_Edit.aspx?ModuleID=2011803'; 
}
