         ...
         var leftMoney=0;
            if (row>1)
            {
                ...
                var i = row - 1;
                        ...
                        var NowMinMoney = document.getElementById("txtMinMoney_" + row).value.Trim();
                        var NowMaxMoney = document.getElementById("txtMaxMoney_" + row).value.Trim();
                        var NowPersonTaxPercent = document.getElementById("txtPersonTaxPercent_" + row).value.Trim();
                        var NowPersonMinusMoney = document.getElementById("txtPersonMinusMoney_" + row).value.Trim();

                        var s1 = tofloat(PreMaxMoney, 2) * tofloat((NowPersonTaxPercent - PrePersonTaxPercent), 2) / 100;
                        sum = parseFloat(s1) + parseFloat(PrePersonMinusMoney);
//                          if (leftMoney ==0)
//                          {
