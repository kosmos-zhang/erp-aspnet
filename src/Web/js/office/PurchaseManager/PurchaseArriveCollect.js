...
//    var strRul = $("#hiddSearch").val();
    window.open("PurchaseArriveCollectPrint.aspx?pageIndex="+currentPageIndex+"&pageCount="+pageCount+"&orderby="+orderBy+"&ProviderID="+escape(ProviderID)+"&ProductID="+escape(ProductID)+"&StartConfirmDate="+escape(StartConfirmDate)+"&EndConfirmDate="+escape(EndConfirmDate)+"");
...
//           var EndConfirmDate = document.getElementById("txtEndConfirmDate").value;
           ...
           url:  '../../../Handler/office/PurchaseManager/PurchaseArriveCollect.ashx',//目标地址
           cache:false,
...
//                        "<td height='22' align='center'><a href='" + GetLinkParam(ProductID) +"&ProductID=" + item.ProductID + " ')>"+item.ProductNo+"</a></td>"+
                        ...
                        "<td height='22' align='center'>"+ item.TotalFee +"</a></td>"+
                        "<td height='22' align='center'>"+ item.TotalPrice +"</a></td>"+
                        "<td height='22' align='center'>"+ item.BackCount +"</a></td>"+
                        "<td height='22' align='center'>"+ item.BackTotalFee  +"</a></td>"+
                        "<td height='22' align='center'>"+ item.BackTotalPrice +"</a></td>").appendTo($("#pageDataList1 tbody"));
                        }
...
//    currentPageIndex = pageIndex;
    var Isliebiao = 1;
    var URLParams = "&Isliebiao="+escape(Isliebiao)+"&ProviderID="+escape(ProviderID)+"&ProductID="+escape(ProductID)+"&StartConfirmDate="+escape(StartConfirmDate)+"&EndConfirmDate="+escape(EndConfirmDate)+""; 
    //设置检索条件
