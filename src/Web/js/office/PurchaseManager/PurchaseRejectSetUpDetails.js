$(document).ready(function(){
    ...
    {  
        var search ="billStatus="+escape(document.getElementById("HidbillStatus").value)+"&FromType="+document.getElementById("HidFromType").value+"&shState="
        +document.getElementById("HidshState").value+"&typeTime="+document.getElementById("HidTypeTime").value+"&BeginDate="
        +document.getElementById("HidBeginDate").value+"&EndDate="+document.getElementById("HidEndDate").value+"&TimeStr="+escape(document.getElementById("HidTimeStr").value);
            $.ajax({
           type: "POST",//用POST方式传输
           dataType:"json",//数据格式:JSON
           url:  '../../../Handler/Office/PurchaseManager/PurchaseRejectSetUpDetails.ashx',//目标地址
           ...
           success: function(msg){
                ...
                {  //var date=item.OperateDate;
                        $("<tr class='newrow'></tr>").append("<td height='22' align='center'>"+item.RejectNo
                         +"</td>"+
                        ...
                        "<td height='22' align='center'>" + (parseFloat(item.TotalYthkhj)).toFixed($("#hidPoint").val()) + "</td>" + 
                        "<td height='22' align='center'>"+item.BillStatusName+"</td>"+
                        "<td height='22' align='center'>"+item.FlowStatusName+"</td>").appendTo($("#pageDataList1 tbody"));                        
                        }
                   });
                     //页码
