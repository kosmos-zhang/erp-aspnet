$(document).ready(function(){
    ...
    function TurnToPage(pageIndex)
    {
        ...
        +document.getElementById("HidshState").value+"&typeID="+document.getElementById("HidtypeID").value+"&BeginDate="+document.getElementById("HidBeginDate").value+"&EndDate="+document.getElementById("HidEndDate").value;
            $.ajax({
           type: "POST",//用POST方式传输
           dataType:"json",//数据格式:JSON
           url:  '../../../Handler/Office/PurchaseManager/PurchaseRejectTypeDetails.ashx',//目标地址
