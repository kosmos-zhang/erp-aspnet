...
function TurnToPage(pageIndex) {
    ...
    $.ajax({
        ...
        url: '../../../Handler/Office/SellManager/SellChannelSttlList.ashx', //目标地址
        cache: false,
        data: strUrl,
        ...
        success: function(msg) {
            ...
            $.each(msg.data, function(i, item) {
                if (item.ID != null && item.ID != "") {
                    ...
                    $("<tr class='newrow'></tr>").append("<td height='22' align='center'>" + "<input id='chk" + i + "'  onclick = 'fnUnSelect(this)'  Title='" + item.SttlNo + "' value='" + item.ID + "'   type='checkbox'/>" + "</td>" +
                    "<td height='22' align='center'><a href='#' title=\"" + item.SttlNo + "\" onclick=SelectDept('" + item.ID + "','" + item.RefText + "')>" + SttlNo + "</a></td>" +
                    ...
                    "<td height='22' align='center'>" + item.SellerName + "</td>" +
                    "<td height='22' align='center'>" + item.SttlDate + "</td>" +
                    "<td height='22' align='center'>" + FormatAfterDotNumber(item.SttlTotal, precisionLength) + "</td>" +
...
function getSearchParams1() {
    ...
    var strUrl = 'orderNo=' + escape(OfferNo) + '&Title=' + escape(Title) + '&CustName=' + escape(CustName)
                ...
                + '&OfferDate1=' + escape(OfferDate1) + '&FromBillNo=' + escape(FromBillNo)
                + '&FromBillID=' + escape(FromBillID) + '&BillStatus=' + escape(BillStatus)
...
//新建
function fnNew() {
    window.location.href = 'SellChannelSttlAdd.aspx?' + getSearchParams() + '&islist=1&ModuleID=2031901';
}
...
//查看明细
function SelectDept(retval, isRef) {

    window.location.href = 'SellChannelSttlMod.aspx?' + getSearchParams() + '&id=' + escape(retval) + "&islist=1&ModuleID=2031901&isRef=" + isRef;
}
