$(document).ready(function(){
    ...
    function TurnToPage(pageIndex)
    {
        ...
        +document.getElementById("hidendTime").value+"&flag="+document.getElementById("HidFlag").value+"&moduleFlag="+document.getElementById("HidModuleFlag").value;
            $.ajax({
           type: "POST",//用POST方式传输
           dataType:"json",//数据格式:JSON
           url:  '../../../Handler/Office/SellManager/SellOrderActiveMoneyDetails.ashx',//目标地址
           ...
           success: function(msg){
                ...
                {  //var date=item.OperateDate;
                        ...
                        "<td height='22' align='center'>"+item.OrderDate1+"</td>"+
                        "<td height='22' align='center'>"+item.RealTotal+"</td>"+
                        "<td height='22' align='center'>"+item.BlendingAmount+"</td>"+
