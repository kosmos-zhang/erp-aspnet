$(document).ready(function(){
    ...
    function TurnToPage(pageIndex)
    {
        ...
        +document.getElementById("hidendTime").value+"&productid="+document.getElementById("HidProductType").value+"&timeType="+document.getElementById("HidTimeType").value;
            $.ajax({
           type: "POST",//用POST方式传输
           dataType:"json",//数据格式:JSON
           url:  '../../../Handler/Office/SellManager/SellOrderProductDetails.ashx',//目标地址
           ...
           success: function(msg){
                ...
                {  //var date=item.OperateDate;
                        $("<tr class='newrow'></tr>").append("<td height='22' align='center'>"+item.OrderNo
                         +"</td>"+
                        ...
                        "<td height='22' align='center'>" +  (parseFloat(item.Discount)).toFixed($("#hidPoint").val()) + "</td>" +
                        "<td height='22' align='center'>"+item.orderDateCn+"</td>").appendTo($("#pageDataList1 tbody"));                        
                        }
                   });
                     //页码
...
//            document.getElementById("ShowPageCount").style.display = "none";
        }
        else
        {
            document.getElementById('divpage').style.display = "block";
//            document.getElementById('ShowPageCount').style.display = "block";
        }
    }
