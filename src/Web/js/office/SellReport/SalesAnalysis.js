...
function getReportImage(t)
{
        ...
        var url="../../../Handler/Office/SellReport/SalesAnalysis.ashx";
        if(t==3)
        {
...
function GoPage(pageIndex)
{
    ...
    switch(type)
    {
        case "1":
            ...
            $("#divCenterData").attr("style","display:none");
            break;
        case "2":
        case "3":
        ...
        {    
                   ...
                   $("#tblSubProductSendPrice tbody").find("tr.newrow").remove();
                    $.each(msg.data,function(i,item){
                            ...
                            totalNum=parseFloat( parseFloat(totalNum)+ parseFloat(item.SellNumTotal));
                           ...
                           {
                                case"byWeek":
                                    tdStr="<td align=\"center\" title=\""+item.CreateWeek+"\" >第 "+item.CreateWeek+" 周</td><td style=\"display:none\"></td><td style=\"display:none\"></td>";
                                    break;
                                case "byMonth":
                                    tdStr="<td style=\"display:none\"></td><td align=\"center\" title=\""+item.CreateMonth+"\" >"+item.CreateMonth+" 月</td><td style=\"display:none\"></td>";                        break;
                               case "byYear":
                                    tdStr="<td style=\"display:none\"></td><td style=\"display:none\"></td><td align=\"center\" title=\""+item.CreateYear+"\" >"+item.CreateYear+" 年</td>";                        break;
                           }
