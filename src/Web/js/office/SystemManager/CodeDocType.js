...
{
    //拼写请求URL参数
    var postParams = "Action=LoadData";
    $.ajax({ 
        type: "POST",
        url: "../../../Handler/Office/SystemManager/CodeDocType.ashx?"+postParams,
        dataType:'string',
        data: '',
        cache:false,
...
//    document.getElementById("curAction").innerHTML = "修改文档分类";
...
//    document.getElementById("curAction").innerHTML = "新建文档分类";
